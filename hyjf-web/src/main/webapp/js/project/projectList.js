	...
	function() {
		...
		function getProjectListPage() {
			...
			doRequest(
					...
					webPath+ "/project/getProjectList.do?projectType="+$("#projectType").val(),
		...
		function projectPageSuccessCallback(data) {
			...
			if(projectList.length==0){
				...
				for (var i = 0; i < projectList.length; i++) {
					...
					+ '<li>'
					+ '	<div class="new-title">'
					+ '		<a href="'+webPath+'/project/getProjectDetail.do?borrowNid='+project.borrowNid+'" class="id">'+(project.borrowType =='融通宝' ?project.borrowAssetNumber : project.borrowNid)+'</a>'
					...
					if(project.status=="10"){
						if(project.borrowType=="尊享汇"&&project.bookingStatus=="0"&&project.bookingBeginTime!=0&&project.bookingEndTime!=0){
							...
							+ '	<div class="con5">'
							+ '		<div class="num">'
							+ '	    	<a href="'+webPath+'/project/getProjectDetail.do?borrowNid='+project.borrowNid+'" class="new-list-btn wait">等待预约</a>'
							+ '		</div>'
							...
							+ '	<div class="con5">'
							+ '		<div class="num">'
							+ '	    	<a href="'+webPath+'/project/getProjectDetail.do?borrowNid='+project.borrowNid+'" class="new-list-btn avalible">我要预约</a>'
							+ '		</div>'
							+ '		<div class="con-title time" data-time="'+project.time+'" data-nid ="'+project.borrowNid+'"></div>'
							+ '	</div>';
							...
							+ '	<div class="con5">'
							+ '		<div class="num">'
							+ '	    	<a href="'+webPath+'/project/getProjectDetail.do?borrowNid='+project.borrowNid+'" class="new-list-btn wait">预约完成</a>'
							+ '		</div>'
							+ '		<div class="con-title time" data-time="'+project.time+'" data-nid ="'+project.borrowNid+'"></div>'
							+ '	</div>';
						}else{
							...
							+ '	<div class="con5">'
							+ '		<div class="num">'
							+ '	    	<a href="'+webPath+'/project/getProjectDetail.do?borrowNid='+project.borrowNid+'" class="new-list-btn wait">等待投标</a>'
							+ '		</div>'
							+ '		<div class="con-title time" data-time="'+project.time+'" data-nid ="'+project.borrowNid+'"></div>'
							+ '	</div>';
						}
						...
						+ '	<div class="con5">'
						+ ' 	<div class="num">'
						+ '      	<a href="'+webPath+'/project/getProjectDetail.do?borrowNid='+project.borrowNid+'" class="new-list-btn avalible">立即投资</a>'
						+ '   	</div>'
						+ '	</div>'
						...
						+ '<div class="con5">'
						+ '		<div class="num">'
						+ '    		<a href="'+webPath+'/project/getProjectDetail.do?borrowNid='+project.borrowNid+'" class="new-list-btn done">复审中</a>'
						+ '		</div>'
						+ '</div>'
						...
						+ '<div class="con5">'
						+ '		<div class="num">'
						+ '    		<a href="'+webPath+'/project/getProjectDetail.do?borrowNid='+project.borrowNid+'" class="new-list-btn done">还款中</a>'
						+ '		</div>'
						+ '</div>'
					}
					projectListStr = projectListStr
