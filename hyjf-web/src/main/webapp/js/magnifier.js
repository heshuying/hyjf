;(function(){ 
	...
	MagnifierF.prototype = {
		init: function(id){
			...
			this.bigImg = this.magImg.getAttribute('big');
		...
		setEleFn: function(){   
			...
			if(_is.bigImg){
				_html1 = '<img style="width:100%;height:100%;" src="' + _is.bigImg + '">';
			}else{
				_html1 = '<img style="width:100%;height:100%;" src="' + _is.mImgSrc + '_big.jpg">';
			}
		...
		specFn: function(){
			...
			function TabFn(event){   
				...
				if (target.nodeName != "UL") { 
					...
					_is.bigImg = _oSpImg.getAttribute('big'); 
				}
