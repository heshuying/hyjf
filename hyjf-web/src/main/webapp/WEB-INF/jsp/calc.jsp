...
<html>
 	...
 	<section class="main-content">
			<div class="container">
				...
				<form id="hjkForm" class="cal">
					<article class="content content-1 content-2">
						<div class="cal-title">
							收益计算器
						</div>
						<div class="new-form new-jisuanqi">
							<div class="new-form-item item-1 mr20">
								<label for="investMoney" class="jisuanqi-adjust-label">出借金额</label>
								<input type="text" name="investmoney" maxlength="9" class="new-form-input" id="investMoney" placeholder="请输入出借金额" autocomplete="off" oninput="if(value.length>9)value=value.slice(0,9)">
								<span class="unit">元</span>
							</div>
							<div class="new-form-item item-1">
								<label for="Tel">历史年回报率</label>
								<input type="text" name="tel" maxlength="11" class="new-form-input" id="percent" placeholder="请输入历史年回报率" autocomplete="off">
								<span class="unit">%</span>
							</div>
							<div class="new-form-item item-1 mr20">
								<label class="jisuanqi-adjust-label">还款方式</label>
								<h4 class="new-form-input iconfont icon-ananzuiconv265 selectType">按月计息，到期还本付息</h4>
	...
	<script src="${cdn}/dist/js/lib/messages_cn.js"></script>
	<script src="${cdn}/dist/js/cal/customform.js"></script>
	<script src="${cdn}/dist/js/cal/cal.js"></script>
	</body>
</html>