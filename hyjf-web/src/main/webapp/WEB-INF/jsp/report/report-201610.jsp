...
<body class="">
    <div id="fullpage">
        <div class="section top" style="background-image: url(${ctx}/img/report/201610/top.jpg?v=20171123);">
        ...
        <div class="section section1 yejizonglan repeat">
            <div class="inner">
                ...
                <dl class="data1">
                    <dt>累计交易额（元）</dt>
                    <dd id="s1data1">9,333,687,764</dd>
                </dl>
                <dl class="data2">
                    <dt>平台注册人数（人）</dt>
                    <dd id="s1data2">197,416</dd>
                </dl>
                <dl class="data3">
                    <dt>累计赚取收益（元）</dt>
                    <dd id="s1data3">316,323,433</dd>
                </dl>
                <dl class="data4">
                    <dt>风险保证金（元）</dt>
                    <dd id="s1data4">47,105,653 </dd>
                </dl>
            </div>
        </div>
        <div class="section section2 dangyueyeji repeat">
            <div class="inner">
                ...
                <div class="dangyueyeji_right">
                    <p>本月成交<span class="data" id="s2data1">14756</span>笔</p>
                    <p>成交金额共计<span class="data" id="s2data2">4.32</span>亿元</p>
                    <p>同比增长<span class="data"><span id="s2data3">18.40</span>%</span></p>
                </div>
                <div class="clearfix"></div>
                <div id="echarts2_2" style="width:520px;height: 220px;margin-top: 50px;float: left;"></div>
                <div class="dangyueyeji_right">
                    <p>本月为用户赚取收益<span class="data" id="s2data4">1306.03</span>万元</p>
                    <p>同比增长<span class="data"><span id="s2data5">19.29</span>%</span></p>
                    <p>本月平均历史回报率<span class="data"><span id="s2data6">10.50</span>%</span></p>
                </div>
            </div>
        </div>
        ...
        <div class="section section3 qudaofenxi repeat">
            <div class="inner">
                ...
                <div class="qudaofenxi_style2_left">
                    <div class="item-title"><img src="${ctx}/img/report/txt_android.png" alt=""></div>
                    <div class="item"><div class="icon phone"></div>本月成交<span id="s4data1">2973</span>笔，占比<span id="s4data2">20.15</span>%</div>
                    <div class="item-title"><img src="${ctx}/img/report/txt_ios.png" alt=""></div>
                    <div class="item"><div class="icon ios"></div>本月成交<span id="s4data3">1745</span>笔，占比<span id="s4data4">11.83</span>%</div>
                    <div class="item-title"><img src="${ctx}/img/report/txt_pc.png" alt=""></div>
                    <div class="item"><div class="icon desktop"></div>本月成交<span id="s4data5">10038</span>笔，占比<span id="s4data6">68.03</span>%</div>
                </div>
        ...
        <div class="section section5 dangyuezhizui repeat">
            <div class="inner">
                ...
                <div class="dangyuezhizui-left-style2">
                    ...
                    <div class="item-box">
                        <div class="item"><div class="name">l*</div><div class="value top3">776.00万</div></div>
                        <div class="item"><div class="name">李*</div><div class="value top3">328.17万</div></div>
                        <div class="item"><div class="name">d*</div><div class="value top3">273.90万</div></div>
                        <div class="item"><div class="name">l*</div><div class="value">220.92万</div></div>
                        <div class="item"><div class="name">z*</div><div class="value">206.07万</div></div>
                        <div class="item"><div class="name">崔*</div><div class="value">186.11万</div></div>
                        <div class="item"><div class="name">李*</div><div class="value">177.41万</div></div>
                        <div class="item"><div class="name">h*</div><div class="value">154.23万</div></div>
                        <div class="item"><div class="name">李*</div><div class="value">153.09万</div></div>
                        <div class="item"><div class="name">腾*</div><div class="value">150.00万</div></div>
                    </div>
                </div>
                <div class="dangyuezhizui-right-style2">
                    <div class="item">
                        ...
                        <p class="item-value">
                            <span class="val1"><span id="s6data1">776</span> 万元</span>
                    ...
                    <div class="item">
                        ...
                        <p class="item-value">
                            <span class="val1"><span id="s6data2">26.96</span> 万元</span>
                            <span class="val2">z*</span>
                            <span class="val3">55岁</span>
                            <span class="val4">山东潍坊</span>
                        </p>
                    </div>
                    <div class="item">
                        ...
                        <p class="item-value">
                            <span class="val1"><span id="s6data3">187</span>次</span>
        ...
        <div class="section section6 kehufuwu repeat">
            <div class="inner">
                ...
                <div class="inner-bg">
                    <div class="item1"><span id="s8data1"> 1601</span> <span class="field">个</span></div>
                    <div class="item2"><span id="s8data2">604</span> <span class="field">人</span></div>
                    <div class="item3"><span id="s8data3">62</span> <span class="field">人</span></div>
                    <div class="item4"><span id="s8data4">1228</span> <span class="field">个</span></div>
                </div>
            ...
            <div class="inner">
                ...
                <div class="inner-bg" style="width: 880px;margin-left: auto;margin-right: auto;">
                    <div class="item item1">
                        ...
                        <div class="join">参与人次   3584人</div>
                    </div>
                    <div class="item item3" style="margin-top:0;margin-left: 187px;">
                        <div class="image"><img src="${ctx}/img/report/201610/201610_active2.jpg" alt=""></div>
                        <div class="con">万万没想到，<br>iPhone 7还能这样赢！</div>
                        <div class="date">2016年10月21日起</div>
                        <div class="join">截至2016年10月31日共344人参与活动</div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script type="text/javascript">
        ...
        var data_6_1 = {
            ...
            data:{
                sex:[
                    {value:4600, name:'女',total:254021985},
                    {value:3188, name:'男',total:178236593}
                ],
                age:[
                    {value:1187, name:'18-29岁'},
                    {value:1274, name:'30-39岁'},
                    {value:1707, name:'40-49岁'},
                    {value:1517, name:'50-59岁'},
                    {value:2103, name:'60岁以上'}
                ]
            },
        ...
        var yonghufenxi_data_3 = {
            ...
            //subtitle:"101501.22",
            data:[
                {value:2747, name:'1万以下'},
                {value:3016, name:'1-5万'},
                {value:930, name:'5-10万'},
                {value:979, name:'10-50万'},
                {value:116, name:'50万以上'}
            ],
    ...
    var data_6_5 = {
        title:'\r10大投资人\n金额之和占比',
        subtitle:"6.07%",//十大投资人占比
        data:[
            {value:26259013, name:'10大投资人金额'},
            {value:405999565, name:'其他投资人金额'}
        ]
    }
    ...
    $(document).ready(function() {
        ...
        $('#fullpage').fullpage({
            ...
            onLeave :function(index, nextIndex, direction){
                ...
                if(idx == 1){
                    var s1data1 = new CountUp("s1data1", 0, 9333687764, 0, 1.5, countUpOptions); //累计交易额(元)
                    var s1data2 = new CountUp("s1data2", 0, 197416, 0, 1.5, countUpOptions);//平台注册人数(人)
                    var s1data3 = new CountUp("s1data3", 0, 316323433, 0, 1.5, countUpOptions);//累计赚取收益(元)
                    var s1data4 = new CountUp("s1data4", 0, 47105653, 0, 1.5, countUpOptions);//风险保证金(元)
                    s1data1.start();
                    s1data2.start();
                    s1data3.start();
                    s1data4.start();
                }else if(idx == 2){
                    var s2data1 = new CountUp("s2data1", 0, 14756, 0, 1.5, countUpOptions);
                    var s2data2 = new CountUp("s2data2", 0, 4.32, 2, 1.5, countUpOptions);
                    var s2data3 = new CountUp("s2data3", 0, 18.40, 2, 1.5, countUpOptions);
                    var s2data4 = new CountUp("s2data4", 0, 1306.03, 2, 1.5, countUpOptions);
                    var s2data5 = new CountUp("s2data5", 0, 19.29, 2, 1.5, countUpOptions);
                    var s2data6 = new CountUp("s2data6", 0, 10.50, 2, 1.5, countUpOptions);
                    s2data1.start();
                    s2data2.start();
                    s2data3.start();
                    s2data4.start();
                    ...
                    var s4data1 = new CountUp("s4data1", 0, 2973, 0, 1.5, countUpOptions);//债转成交金额(元)
                    var s4data2 = new CountUp("s4data2", 0, 20.15, 2, 1.5, countUpOptions);//成功转让笔数 (笔)
                    var s4data3 = new CountUp("s4data3", 0, 1745, 0, 1.5, countUpOptions);//参与转让人数(人) 发起
                    var s4data4 = new CountUp("s4data4", 0, 11.83, 2, 1.5, countUpOptions);//参与转让人数(人) 承接
                    var s4data5 = new CountUp("s4data5", 0, 10038, 0, 1.5, countUpOptions);//参与转让人数(人) 承接
                    var s4data6 = new CountUp("s4data6", 0, 68.03, 2, 1.5, countUpOptions);//参与转让人数(人) 承接
                    s4data1.start();
                    s4data2.start();
                    s4data3.start();
                    s4data4.start();
                    ...
                    var s6data1 = new CountUp("s6data1", 0, 776, 2, 1.5, countUpOptions);//当月投资金额最高(万元)
                    var s6data2 = new CountUp("s6data2", 0, 26.96, 2, 1.5, countUpOptions);//当月投资次数最多(次)
                    var s6data3 = new CountUp("s6data3", 0, 187, 0, 1.5, countUpOptions);//当月历史回报最高(万元)
                    s6data1.start();
                    s6data2.start();
                    s6data3.start();
                    dangyuezhizui_1.setOption(dangyuezhizui_1_option);
                }else if(idx == 6){
                    var s8data1 = new CountUp("s8data1", 0,  1601, 0, 1.5, countUpOptions);//400电话数量(个)
                    var s8data2 = new CountUp("s8data2", 0, 604, 0, 1.5, countUpOptions);//qq客服接待人数(人)
                    var s8data3 = new CountUp("s8data3", 0, 62, 0, 1.5, countUpOptions);//微信客服接待人数(人)
                    var s8data4 = new CountUp("s8data4", 0, 1228, 0, 1.5, countUpOptions);//解决问题个数(个)
                    s8data1.start();
                    s8data2.start();
                    s8data3.start();
                    s8data4.start();
