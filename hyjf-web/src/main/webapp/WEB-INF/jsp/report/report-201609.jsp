...
<head>
    ...
    <title>2016年第三季度报告 - 汇盈金服官网</title>
...
<body class="">
    <div id="fullpage">
        <div class="section top" style="background-image: url(${ctx}/img/report/201609/top.jpg?v=20171123);">
        ...
        <div class="section section1 yejizonglan repeat">
            <div class="inner">
                ...
                <dl class="data1">
                    <dt>累计交易额（元）</dt>
                    <dd id="s1data1">8,945,279,358</dd>
                </dl>
                <dl class="data2">
                    <dt>平台注册人数（人）</dt>
                    <dd id="s1data2">194582</dd>
                </dl>
                <dl class="data3">
                    <dt>累计赚取收益（元）</dt>
                    <dd id="s1data3">303,449,407</dd>
                </dl>
                <dl class="data4">
                    <dt>风险保证金（元）</dt>
                    <dd id="s1data4">45,645,433</dd>
                </dl>
            </div>
        </div>
        <div class="section section2 dangyueyeji repeat">
            <div class="inner">
                ...
                <div class="data-box" style="width: 900px;text-align: center;margin-top: 40px;">
                	<p>2016年第三季度平台累计成交 <span class="data" id="s2data5">47821</span> 笔，平均历史回报率<span class="data" id="s2data6">10.34</span>% </p>
                    <p>本季度成交金额共计<span class="data" id="s2data1">15.07</span>亿元，同比增长 <span class="data" id="s2data2">51.23</span>% </p>
                    <p>本季度为用户赚取收益 <span class="data" id="s2data3">4475</span> 万元，同比增长  <span class="data" id="s2data4">48.84</span>%</p>
                </div>
            </div>
        </div>
        ...
        <div class="section section3 qudaofenxi repeat">
            <div class="inner">
                ...
                <div class="qudaofenxi_style2_left">
                    ...
                    <div class="item"><div class="icon phone"></div>本季度成交<span id="s4data1">13966</span>笔，占比<span id="s4data2">29.20</span>%</div>
                    <div class="item-title"><img src="${ctx}/img/report/txt_weixin.png" alt=""></div>
                    <div class="item"><div class="icon wechat"></div>本季度成交<span id="s4data3">788</span>笔，占比<span id="s4data4">1.65</span>%</div>
                    <div class="item-title"><img src="${ctx}/img/report/txt_pc.png" alt=""></div>
                    <div class="item"><div class="icon desktop"></div>本季度成交<span id="s4data5">33067</span>笔，占比<span id="s4data6">69.15</span>%</div>
                </div>
        ...
        <div class="section section5 dangyuezhizui repeat">
            <div class="inner">
                ...
                <div class="dangyuezhizui-left-style2">
                    ...
                    <div class="item-box">
                        <div class="item"><div class="name">l*</div><div class="value top3">1360.00万</div></div>
                        <div class="item"><div class="name">李*</div><div class="value top3">1216.78万</div></div>
                        <div class="item"><div class="name">h*</div><div class="value top3">1200.00万</div></div>
                        <div class="item"><div class="name">l*</div><div class="value">1148.98万</div></div>
                        <div class="item"><div class="name">z*</div><div class="value">1116.52万</div></div>
                        <div class="item"><div class="name">李*</div><div class="value">1084.46万</div></div>
                        <div class="item"><div class="name">y*</div><div class="value">785.29万</div></div>
                        <div class="item"><div class="name">王*</div><div class="value">756.70万</div></div>
                        <div class="item"><div class="name">y*</div><div class="value">708.61万</div></div>
                        <div class="item"><div class="name">澄*</div><div class="value">656.34万</div></div>
                    </div>
                </div>
                <div class="dangyuezhizui-right-style2">
                    <div class="item">
                        ...
                        <p class="item-value">
                            <span class="val1"><span id="s6data1">1360.00</span> 万元</span>
                    ...
                    <div class="item">
                        ...
                        <p class="item-value">
                            <span class="val1"><span id="s6data2">26.90</span> 万元</span>
                            <span class="val2">达*</span>
                            <span class="val3">69岁</span>
                            <span class="val4">北京</span>
                        </p>
                    </div>
                    <div class="item">
                        ...
                        <p class="item-value">
                            <span class="val1"><span id="s6data3">572</span>次</span>
        ...
        <div class="section section6 kehufuwu repeat">
            <div class="inner">
                ...
                <div class="inner-bg">
                    <div class="item1"><span id="s8data1">17556</span> <span class="field">个</span></div>
                    <div class="item2"><span id="s8data2">1814</span> <span class="field">人</span></div>
                    <div class="item3"><span id="s8data3">251</span> <span class="field">人</span></div>
                    <div class="item4"><span id="s8data4">3684</span> <span class="field">个</span></div>
                </div>
                
            </div>
        </div>
        <div class="section section7 tiyanyouhua repeat">
            <div class="inner">
                <div class="title"><span class="line"></span>体验优化</div>
                <div class="inner-bg">
                    <div class="item item1">
                        <p class="date">2016年7月6日</p>
                        <p class="des">PC充值手续费对账上线</p>
                    </div>
                    <div class="item item2">
                        <p class="date">2016年7月15日</p>
                        <p class="des">PC\APP收益计算器上线</p>
                    </div>
                    <div class="item item3">
                        <p class="date">2016年8月10日</p>
                        <p class="des">网站增加信息披露</p>
                    </div>
                    <div class="item item4">
                        <p class="date">2016年8月10日</p>
                        <p class="des">APP\PC代金券上线</p>
                    </div>
                    <div class="item item5">
                        <p class="date">2016年7月9日</p>
                        <p class="des">APP债权转让功能上线</p>
                    </div>
                    <div class="item item6">
                        <p class="date">2016年9月20日</p>
                        <p class="des">微信优惠券功能上线</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="section section8 jingcaihuodong repeat">
            <div class="inner">
                ...
                <div class="inner-bg" style="width: 880px;margin-left: auto;margin-right: auto;">
                    <div class="item item1">
                        ...
                        <div class="con">投资夺宝 一箭双雕！</div>
                        <div class="date">2016年8月11日至2016年9月10日 </div>
                        <div class="join">9703人参与活动   3800人次参与夺宝</div>
                    </div>
                    <div class="item item3" style="margin-top:0;margin-left: 187px;">
                        <div class="image"><img src="${ctx}/img/report/201609/201609_active2.jpg" alt=""></div>
                        <div class="con">新手有礼<br>注册立领68元现金红包！</div>
                        <div class="date">2016年9月19日起 </div>
                        <div class="join">截至2016年9月30日共1811人参与活动</div>
                    </div>
                </div>
            </div>
        </div>
        <div class="section section9 huiyinggongyi repeat">
            <div class="inner">
                <div class="title"><span class="line"></span>汇盈公益</div>
                <div class="inner-bg">
                    <div class="item img-2pcs item1">
                        <div class="num">1</div>
    ...
    <div class="right-nav">
        <ul>
            ...
            <li class="section7" data-idx="7" authors="section7"><span>体验<br/>优化</span></li>
            <li class="section8" data-idx="8" authors="section8"><span>精彩<br/>活动</span></li>
            <li class="section9" data-idx="9" authors="section9"><span>汇盈<br/>公益</span></li>
    ...
    <script type="text/javascript">
        ...
        var data_6_1 = {
            ...
            data:{
                ...
                age:[
                    {value:3186, name:'18-29岁'},
                    {value:3244, name:'30-39岁'},
                    {value:3711, name:'40-49岁'},
                    {value:3406, name:'50-59岁'},
                    {value:4675, name:'60岁以上'}
                ]
            },
        ...
        var yonghufenxi_data_3 = {
            ...
            //subtitle:"101501.22",
            data:[
                {value:6954, name:'1万元以下'},
                {value:6249, name:'1-5万元'},
                {value:1911, name:'5-10万元'},
                {value:2571, name:'10-50万元'},
                {value:547, name:'50万元以上'}
            ],
    ...
    var data_6_5 = {
        title:'\r10大投资人\n金额之和占比',
        subtitle:"6.66%",//十大投资人占比
        data:[
            {value:100337190, name:'10大投资人金额'},
            {value:1406602493, name:'其他投资人金额'}
        ]
    }
    ...
    $(document).ready(function() {
        ...
        $('#fullpage').fullpage({
            ...
            onLeave :function(index, nextIndex, direction){
                ...
                if(idx == 1){
                    var s1data1 = new CountUp("s1data1", 0, 8945279358, 0, 1.5, countUpOptions); //累计交易额(元)
                    var s1data2 = new CountUp("s1data2", 0, 194582, 0, 1.5, countUpOptions);//平台注册人数(人)
                    var s1data3 = new CountUp("s1data3", 0, 303449407, 0, 1.5, countUpOptions);//累计赚取收益(元)
                    var s1data4 = new CountUp("s1data4", 0, 45645433, 0, 1.5, countUpOptions);//风险保证金(元)
                    s1data1.start();
                    s1data2.start();
                    s1data3.start();
                    s1data4.start();
                }else if(idx == 2){
                    var s2data1 = new CountUp("s2data1", 0, 15.07, 2, 1.5, countUpOptions);
                    var s2data2 = new CountUp("s2data2", 0, 51.23, 2, 1.5, countUpOptions);
                    var s2data3 = new CountUp("s2data3", 0, 4475, 0, 1.5, countUpOptions);
                    var s2data4 = new CountUp("s2data4", 0, 48.84, 2, 1.5, countUpOptions);
                    var s2data5 = new CountUp("s2data5", 0, 47821, 0, 1.5, countUpOptions);
                    var s2data6 = new CountUp("s2data6", 0, 10.34, 2, 1.5, countUpOptions);
                    s2data1.start();
                    s2data2.start();
                    s2data3.start();
                    s2data4.start();
                    ...
                    var s4data1 = new CountUp("s4data1", 0, 13966, 0, 1.5, countUpOptions);//债转成交金额(元)
                    var s4data2 = new CountUp("s4data2", 0, 29.20, 2, 1.5, countUpOptions);//成功转让笔数 (笔)
                    var s4data3 = new CountUp("s4data3", 0, 788, 0, 1.5, countUpOptions);//参与转让人数(人) 发起
                    var s4data4 = new CountUp("s4data4", 0, 1.65, 2, 1.5, countUpOptions);//参与转让人数(人) 承接
                    var s4data5 = new CountUp("s4data5", 0, 33067, 0, 1.5, countUpOptions);//参与转让人数(人) 承接
                    var s4data6 = new CountUp("s4data6", 0, 69.15, 2, 1.5, countUpOptions);//参与转让人数(人) 承接
                    s4data1.start();
                    s4data2.start();
                    s4data3.start();
                    s4data4.start();
                    ...
                    var s6data1 = new CountUp("s6data1", 0, 1360.00, 2, 1.5, countUpOptions);//当月投资金额最高(万元)
                    var s6data2 = new CountUp("s6data2", 0, 26.90, 2, 1.5, countUpOptions);//当月投资次数最多(次)
                    var s6data3 = new CountUp("s6data3", 0, 572, 0, 1.5, countUpOptions);//当月历史回报最高(万元)
                    s6data1.start();
                    s6data2.start();
                    s6data3.start();
                    dangyuezhizui_1.setOption(dangyuezhizui_1_option);
                }else if(idx == 6){
                    var s8data1 = new CountUp("s8data1", 0, 17556, 0, 1.5, countUpOptions);//400电话数量(个)
                    var s8data2 = new CountUp("s8data2", 0, 1814, 0, 1.5, countUpOptions);//qq客服接待人数(人)
                    var s8data3 = new CountUp("s8data3", 0, 251, 0, 1.5, countUpOptions);//微信客服接待人数(人)
                    var s8data4 = new CountUp("s8data4", 0, 3684, 0, 1.5, countUpOptions);//解决问题个数(个)
                    s8data1.start();
                    s8data2.start();
                    s8data3.start();
                    s8data4.start();
