...
<body class="">
    <div id="fullpage">
        <div class="section top" style="background-image: url(${ctx}/img/report/201704/top.jpg?v=20171123);">
        ...
        <div class="section section1 yejizonglan repeat">
            <div class="inner">
                ...
                <dl class="data1">
                    <dt>累计交易额（元）</dt>
                    <dd id="s1data1">12641157348</dd>
                </dl>
                <dl class="data2">
                    <dt>平台注册人数（人）</dt>
                    <dd id="s1data2">229224</dd>
                </dl>
                <dl class="data3">
                    <dt>累计赚取收益（元）</dt>
                    <dd id="s1data3">422784072</dd>
                </dl>
                <dl class="data4">
                    <dt>风险保证金（元）</dt>
                    <dd id="s1data4">63904200 </dd>
                </dl>
            </div>
        </div>
        <div class="section section2 dangyueyeji repeat">
            <div class="inner">
                ...
                <div class="dangyueyeji_right">
                    <p>本月成交<span class="data" id="s2data1">19699</span>笔</p>
                    <p>成交金额共计<span class="data" id="s2data2">6.30</span>亿元</p>
                    <p>同比增长<span class="data"><span id="s2data3">64.92</span>%</span></p>
                </div>
                <div class="clearfix"></div>
                <div id="echarts2_2" style="width:520px;height: 220px;margin-top: 50px;float: left;"></div>
                <div class="dangyueyeji_right">
                    <p>本月为用户赚取收益<span class="data" id="s2data4">2102.97</span>万元</p>
                    <p>同比增长<span class="data"><span id="s2data5">71.41</span>%</span></p>
                    <p>本月平均历史回报率<span class="data"><span id="s2data6">9.89</span>%</span></p>
                </div>
            </div>
        </div>
        ...
        <div class="section section3 qudaofenxi repeat">
            <div class="inner">
                ...
                <div class="qudaofenxi_style2_left">
                    ...
                    <div class="item"><div class="icon phone"></div>本月成交<span id="s4data1">8457</span>笔，占比<span id="s4data2">42.93</span>%</div>
                    <div class="item-title"><img src="${ctx}/img/report/txt_weixin.png" alt=""></div>
                    <div class="item"><div class="icon wechat"></div>本月成交<span id="s4data3">763</span>笔，占比<span id="s4data4">3.87</span>%</div>
                    <div class="item-title"><img src="${ctx}/img/report/txt_pc.png" alt=""></div>
                    <div class="item"><div class="icon desktop"></div>本月成交<span id="s4data5">10479</span>笔，占比<span id="s4data6">53.19</span>%</div>
                </div>
        ...
        <div class="section section5 dangyuezhizui repeat">
            <div class="inner">
                ...
                <div class="dangyuezhizui-left-style2">
                    ...
                    <div class="item-box">
                        <div class="item"><div class="name">李*</div><div class="value top3">504.31万</div></div>
                        <div class="item"><div class="name">程*</div><div class="value top3">426.36万</div></div>
                        <div class="item"><div class="name">l*</div><div class="value top3">347.60万</div></div>
                        <div class="item"><div class="name">李*</div><div class="value">325.03万</div></div>
                        <div class="item"><div class="name">h*</div><div class="value">266.10万</div></div>
                        <div class="item"><div class="name">l*</div><div class="value">256.00万</div></div>
                        <div class="item"><div class="name">h*</div><div class="value">245.60万</div></div>
                        <div class="item"><div class="name">王*</div><div class="value">217.41万</div></div>
                        <div class="item"><div class="name">达*</div><div class="value">205.17万</div></div>
                        <div class="item"><div class="name">x*</div><div class="value">201.43万</div></div>
                    </div>
                </div>
                <div class="dangyuezhizui-right-style2">
                    <div class="item">
                        ...
                        <p class="item-value">
                            <span class="val1"><span id="s6data1">504.31</span> 万元</span>
                    ...
                    <div class="item">
                        ...
                        <p class="item-value">
                            <span class="val1"><span id="s6data2">10.49</span> 万元</span>
                            <span class="val2">李*</span>
                            <span class="val3">55岁</span>
                            <span class="val4">青岛市</span>
                        </p>
                    ...
                    <div class="item">
                        ...
                        <p class="item-value">
                            <span class="val1"><span id="s6data3">246</span>次</span>
            ...
            <div class="inner">
                ...
                <div class="inner-bg" style="width: 880px;margin-left: auto;margin-right: auto;">
                    <div class="item item1">
                        <div class="image"><img src="${ctx}/img/report/201704/201704_active1.jpg?version=1" alt=""></div>
                        <div class="con">新手福利<br/>注册即领188元新手红包！</div>
                        <div class="date">2017年4月6日至2017年4月18日</div>
                        <div class="join"></div>
                    </div>
    ...
    <script type="text/javascript">
        ...
        var data_6_1 = {
            ...
            data:{
                sex:[
                    {value:6583, name:'女',total:363171500},
                    {value:4537, name:'男',total:257314700}
                ],
                age:[
                    {value:1528, name:'18-29岁'},
                    {value:2209, name:'30-39岁'},
                    {value:2522, name:'40-49岁'},
                    {value:2213, name:'50-59岁'},
                    {value:2648, name:'60岁以上'}
                ]
            },
        ...
        var yonghufenxi_data_3 = {
            ...
            //subtitle:"101501.22",
            data:[
                {value:3415, name:'1万以下'},
                {value:5192, name:'1-5万'},
                {value:1185, name:'5-10万'},
                {value:1193, name:'10-50万'},
    ...
    var data_6_5 = {
        title:'\r10大投资人\n金额之和占比',
        subtitle:"4.83%",//十大投资人占比
        data:[
            {value:29950160, name:'10大投资人金额'},
            {value:590536040, name:'其他投资人金额'}
        ]
    }
    ...
    $(document).ready(function() {
        ...
        $('#fullpage').fullpage({
            anchors:['top','section1','section2','section3','section4','section5','section6','over'],
            onLeave :function(index, nextIndex, direction){
                var idx = nextIndex-1;
                var anchors = $("#fullpage").children(".section").eq(idx).data("anchor");
                if(idx == 1){
                    var s1data1 = new CountUp("s1data1", 0, 12641157348, 0, 1.5, countUpOptions); //累计交易额(元)
                    var s1data2 = new CountUp("s1data2", 0, 229224, 0, 1.5, countUpOptions);//平台注册人数(人)
                    var s1data3 = new CountUp("s1data3", 0, 422784072, 0, 1.5, countUpOptions);//累计赚取收益(元)
                    var s1data4 = new CountUp("s1data4", 0, 63904200, 0, 1.5, countUpOptions);//风险保证金(元)
                    s1data1.start();
                    s1data2.start();
                    s1data3.start();
                    s1data4.start();
                }else if(idx == 2){
                    var s2data1 = new CountUp("s2data1", 0, 19699, 0, 1.5, countUpOptions);
                    var s2data2 = new CountUp("s2data2", 0, 6.30, 2, 1.5, countUpOptions);
                    var s2data3 = new CountUp("s2data3", 0, 64.92, 2, 1.5, countUpOptions);
                    var s2data4 = new CountUp("s2data4", 0, 2102.97, 2, 1.5, countUpOptions);
                    var s2data5 = new CountUp("s2data5", 0, 71.41, 2, 1.5, countUpOptions);
                    var s2data6 = new CountUp("s2data6", 0, 9.89, 2, 1.5, countUpOptions);
                    s2data1.start();
                    s2data2.start();
                    s2data3.start();
                    s2data4.start();
                    ...
                    var s4data1 = new CountUp("s4data1", 0, 8457, 0, 1.5, countUpOptions);
                    var s4data2 = new CountUp("s4data2", 0, 42.93, 2, 1.5, countUpOptions);
                    var s4data3 = new CountUp("s4data3", 0, 763, 0, 1.5, countUpOptions);
                    var s4data4 = new CountUp("s4data4", 0, 3.87, 2, 1.5, countUpOptions);
                    var s4data5 = new CountUp("s4data5", 0, 10479, 0, 1.5, countUpOptions);
                    var s4data6 = new CountUp("s4data6", 0, 53.19, 2, 1.5, countUpOptions);
                    s4data1.start();
                    s4data2.start();
                    s4data3.start();
                    s4data4.start();
                    ...
                    var s6data1 = new CountUp("s6data1", 0, 504.31, 2, 1.5, countUpOptions);//当月投资金额最高(万元)
                    var s6data2 = new CountUp("s6data2", 0, 10.49, 2, 1.5, countUpOptions);//当月历史回报最高(万元)
                    var s6data3 = new CountUp("s6data3", 0, 246, 0, 1.5, countUpOptions);//当月投资次数最多(次)
                    s6data1.start();
                    s6data2.start();
                    s6data3.start();
