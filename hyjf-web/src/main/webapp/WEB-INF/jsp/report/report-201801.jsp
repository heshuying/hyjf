...
<body class="">
    <div id="fullpage">
        <div class="section top" style="background-image: url(${ctx}/img/report/201801/top.jpg)">
        ...
        <div class="section section1 yejizonglan repeat">
            <div class="inner">
                ...
                <dl class="data1">
                    <dt>累计交易额（元）</dt>
                    <dd id="s1data1">19787515957.96</dd>
                </dl>
                <dl class="data2">
                    <dt>平台注册人数（人）</dt>
                    <dd id="s1data2">374918</dd>
                </dl>
                <dl class="data3">
                    <dt>累计赚取收益（元）</dt>
                    <dd id="s1data3">672047874.05</dd>
                </dl>
            </div>
        </div>
        <div class="section section2 dangyueyeji repeat">
            <div class="inner">
                ...
                <div class="dangyueyeji_right">
                    <p>本月成交<span class="data" id="s2data1">27119</span>笔</p>
                    <p>成交金额共计<span class="data" id="s2data2">6.50</span>亿元</p>
                    <p>同比增长<span class="data"><span id="s2data3">15.86</span>%</span></p>
                </div>
                <div class="clearfix"></div>
                <div id="echarts2_2" style="width:520px;height: 220px;margin-top: 50px;float: left;"></div>
                <div class="dangyueyeji_right">
                    <p>本月为用户赚取收益<span class="data" id="s2data4">2167.89</span>万元</p>
                    <p>同比增长<span class="data"><span id="s2data5">80.15</span>%</span></p>
                    <p>本月平均历史回报率<span class="data"><span id="s2data6">8.557</span>%</span></p>
                </div>
            </div>
        </div>
        ...
        <div class="section section3 qudaofenxi repeat">
            <div class="inner">
                ...
                <div class="qudaofenxi_style2_left">
                    ...
                    <div class="item"><div class="icon phone"></div>本月成交<span id="s4data1">17148</span>笔，占比<span id="s4data2">63.23</span>%</div>
                    <div class="item-title"><img src="${ctx}/img/report/txt_weixin.png" alt=""></div>
                    <div class="item"><div class="icon wechat"></div>本月成交<span id="s4data3">1208</span>笔，占比<span id="s4data4">4.45</span>%</div>
                    <div class="item-title"><img src="${ctx}/img/report/txt_pc.png" alt=""></div>
                    <div class="item"><div class="icon desktop"></div>本月成交<span id="s4data5">8763</span>笔，占比<span id="s4data6">32.32</span>%</div>
                </div>
        ...
        <div class="section section5 dangyuezhizui repeat">
            <div class="inner">
                ...
                <div class="dangyuezhizui-left-style2">
                    ...
                    <div class="item-box">
                        <div class="item"><div class="name">l*</div><div class="value top3">547.00万</div></div>
                        <div class="item"><div class="name">满*</div><div class="value top3">447.79万</div></div>
                        <div class="item"><div class="name">h*</div><div class="value top3">276.58万</div></div>
                        <div class="item"><div class="name">H*</div><div class="value">250.72万</div></div>
                        <div class="item"><div class="name">程*</div><div class="value">243.26万</div></div>
                        <div class="item"><div class="name">h*</div><div class="value">226.90万</div></div>
                        <div class="item"><div class="name">l*</div><div class="value">203.69万</div></div>
                        <div class="item"><div class="name">l*</div><div class="value">184.28万</div></div>
                        <div class="item"><div class="name">h*</div><div class="value">174.02万</div></div>
                        <div class="item"><div class="name">达*</div><div class="value">172.01万</div></div>
                    </div>
                </div>
                <div class="dangyuezhizui-right-style2">
                    <div class="item">
                        ...
                        <p class="item-value">
                            <span class="val1"><span id="s6data1">547</span>万元</span>
                    ...
                    <div class="item">
                        ...
                        <p class="item-value">
                            <span class="val1"><span id="s6data2">13.36</span>万元</span>
                    ...
                    <div class="item">
                        ...
                        <p class="item-value">
                            <span class="val1"><span id="s6data3">110</span>次</span>
            ...
            <div class="inner">
                ...
                <div class="inner-bg" style="width: 880px;margin-left: 200px;margin-right: auto;margin-top:130px">
                    <div class="item item1" style="width:780px;">
                        <div class="image"><img src="${ctx}/img/report/201801/active.png" alt=""></div>
                        <div class="con" style="height:90px;">元旦福利大放送<br/>日日签到，坐等收钱！</div>
                        <div class="date" style="margin-top:50px;">2018年1月1日至2018年1月31日</div>
                        <div class="join"></div>
                    </div>
                </div>
            </div>
            ...
            tooltip : {
                ...
                //formatter: "{b} : {c} ({d}%)"
                	formatter : function(obj) {
						if (obj.data.value == "8763") { //hack 数字bug 
							obj.percent = "32.32";
						}
    ...
    <script type="text/javascript">
        ...
        var data_6_1 = {
            ...
            data:{
                ...
                age:[
                    {value:2039, name:'18-29岁'},
                    {value:2837, name:'30-39岁'},
                    {value:3687, name:'40-49岁'},
                    {value:2889, name:'50-59岁'},
                    {value:3357, name:'60岁以上'}
                ]
            },
        ...
        var yonghufenxi_data_3 = {
            ...
            //subtitle:"101501.22",
            data:[
                {value:5207, name:'1万以下'},
                {value:6066, name:'1-5万'},
                {value:1780, name:'5-10万'},
                {value:1620, name:'10-50万'},
                {value:136, name:'50万以上'}
            ],
                ...
                },
                {
                    ...
                    label:{
                        normal:{
                            //formatter: "{b}\n{d}%"
                            	formatter: function(obj){
                                    if(obj.data.value=="2889"){
                                    	obj.percent = "19.50";
                                    }
                                    if(obj.data.value=="3687"){
                                    	obj.percent = "24.90";
                                    }
                                    return obj.data.name +"\n"+obj.percent+"%";
                                }
    ...
    var data_6_5 = {
        title:'\r10大投资人\n金额之和占比',
        subtitle:"4.19%",//十大投资人占比
        data:[
            {value:27262500, name:'10大投资人金额'},
            {value:622811112, name:'其他投资人金额'}
        ]
    }
    ...
    $(document).ready(function() {
        ...
        $('#fullpage').fullpage({
            ...
            onLeave :function(index, nextIndex, direction){
                ...
                if(idx == 1){
                    var s1data1 = new CountUp("s1data1", 0, 19787515957.96, 2, 1.5, countUpOptions); //累计交易额(元)
                    var s1data2 = new CountUp("s1data2", 0, 374918, 0, 1.5, countUpOptions);//平台注册人数(人)
                    var s1data3 = new CountUp("s1data3", 0, 672047874.05, 2, 1.5, countUpOptions);//累计赚取收益(元)
                    s1data1.start();
                    s1data2.start();
                    s1data3.start();
                }else if(idx == 2){
                    var s2data1 = new CountUp("s2data1", 0, 27119, 0, 1.5, countUpOptions);
                    var s2data2 = new CountUp("s2data2", 0, 6.50, 2, 1.5, countUpOptions);
                    var s2data3 = new CountUp("s2data3", 0, 15.86, 2, 1.5, countUpOptions);
                    var s2data4 = new CountUp("s2data4", 0, 2167.89, 2, 1.5, countUpOptions);
                    var s2data5 = new CountUp("s2data5", 0, 80.15, 2, 1.5, countUpOptions);
                    var s2data6 = new CountUp("s2data6", 0, 8.557, 3, 1.5, countUpOptions);
                    s2data1.start();
                    s2data2.start();
                    s2data3.start();
                    s2data4.start();
                    ...
                    var s4data1 = new CountUp("s4data1", 0, 17148, 0, 1.5, countUpOptions);
                    var s4data2 = new CountUp("s4data2", 0, 63.23, 2, 1.5, countUpOptions);
                    var s4data3 = new CountUp("s4data3", 0, 1208, 0, 1.5, countUpOptions);
                    var s4data4 = new CountUp("s4data4", 0, 4.45, 2, 1.5, countUpOptions);
                    var s4data5 = new CountUp("s4data5", 0, 8763, 0, 1.5, countUpOptions);
                    var s4data6 = new CountUp("s4data6", 0, 32.32, 2, 1.5, countUpOptions);
                    s4data1.start();
                    s4data2.start();
                    s4data3.start();
                    s4data4.start();
                    ...
                    var s6data1 = new CountUp("s6data1", 0, 547, 0, 1.5, countUpOptions);//当月投资金额最高(万元)
                    var s6data2 = new CountUp("s6data2", 0, 13.36, 2, 1.5, countUpOptions);//当月投资次数最多(次)
                    var s6data3 = new CountUp("s6data3", 0, 110, 0, 1.5, countUpOptions);//当月历史回报最高(万元)
                    s6data1.start();
                    s6data2.start();
                    s6data3.start();
