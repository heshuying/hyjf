...
<body class="">
    <div id="fullpage">
        <div class="section top" style="background-image: url(${ctx}/img/report/201701/top.jpg?v=20171123);">
        ...
        <div class="section section1 yejizonglan repeat">
            <div class="inner">
                ...
                <dl class="data1">
                    <dt>累计交易额（元）</dt>
                    <dd id="s1data1">10937548268</dd>
                </dl>
                <dl class="data2">
                    <dt>平台注册人数（人）</dt>
                    <dd id="s1data2">206828</dd>
                </dl>
                <dl class="data3">
                    <dt>累计赚取收益（元）</dt>
                    <dd id="s1data3">363174316.13</dd>
                </dl>
                <dl class="data4">
                    <dt>风险保证金（元）</dt>
                    <dd id="s1data4">53654555</dd>
                </dl>
            </div>
        </div>
        <div class="section section2 dangyueyeji repeat">
            <div class="inner">
                ...
                <div class="dangyueyeji_right">
                    <p>本月成交<span class="data" id="s2data1">13162</span>笔</p>
                    <p>成交金额共计<span class="data" id="s2data2">5.61</span>亿元</p>
                    <p>同比增长<span class="data"><span id="s2data3">42.38</span>%</span></p>
                </div>
                <div class="clearfix"></div>
                <div id="echarts2_2" style="width:520px;height: 220px;margin-top: 50px;float: left;"></div>
                <div class="dangyueyeji_right">
                    <p>本月为用户赚取收益<span class="data" id="s2data4">1203.33</span>万元</p>
                    <p>同比增长<span class="data"><span id="s2data5">6.45</span>%</span></p>
                    <p>本月平均历史回报率<span class="data"><span id="s2data6">9.73</span>%</span></p>
                </div>
            </div>
        </div>
        ...
        <div class="section section3 qudaofenxi repeat">
            <div class="inner">
                ...
                <div class="qudaofenxi_style2_left">
                    ...
                    <div class="item"><div class="icon phone"></div>本月成交<span id="s4data1">5408</span>笔，占比<span id="s4data2">39.56</span>%</div>
                    <div class="item-title"><img src="${ctx}/img/report/txt_weixin.png" alt=""></div>
                    <div class="item"><div class="icon wechat"></div>本月成交<span id="s4data3">584</span>笔，占比<span id="s4data4">4.27</span>%</div>
                    <div class="item-title"><img src="${ctx}/img/report/txt_pc.png" alt=""></div>
                    <div class="item"><div class="icon desktop"></div>本月成交<span id="s4data5">7680</span>笔，占比<span id="s4data6">56.17</span>%</div>
                </div>
        ...
        <div class="section section5 dangyuezhizui repeat">
            <div class="inner">
                ...
                <div class="dangyuezhizui-left-style2">
                    ...
                    <div class="item-box">
                        <div class="item"><div class="name">达*</div><div class="value top3">595.73万</div></div>
                        <div class="item"><div class="name">l*</div><div class="value top3">570.00万</div></div>
                        <div class="item"><div class="name">t*</div><div class="value top3">562.38万</div></div>
                        <div class="item"><div class="name">s*</div><div class="value">450.54万</div></div>
                        <div class="item"><div class="name">z*</div><div class="value">442.00万</div></div>
                        <div class="item"><div class="name">h*</div><div class="value">410.00万</div></div>
                        <div class="item"><div class="name">b*</div><div class="value">407.33万</div></div>
                        <div class="item"><div class="name">l*</div><div class="value">402.58万</div></div>
                        <div class="item"><div class="name">李*</div><div class="value">397.38万</div></div>
                        <div class="item"><div class="name">李*</div><div class="value">370.12万</div></div>
                    </div>
                </div>
                <div class="dangyuezhizui-right-style2">
                    <div class="item">
                        ...
                        <p class="item-value">
                            <span class="val1"><span id="s6data1">595.73</span> 万元</span>
                    ...
                    <div class="item">
                        ...
                        <p class="item-value">
                            <span class="val1"><span id="s6data2">18.66</span> 万元</span>
                    ...
                    <div class="item">
                        ...
                        <p class="item-value">
                            <span class="val1"><span id="s6data3">254</span>次</span>
            ...
            <div class="inner">
                ...
                <div class="inner-bg" style="width: 880px;margin-left: auto;margin-right: auto;">
                    <div class="item item1" style="width:780px;">
                        ...
                        <div class="con" style="height:90px;">汇盈金服3周年盛典<br/>百亿时刻，邀您共同见证！</div>
                        <div class="date">平台成交额达100亿起至105亿止</div>
                        <div class="join" style='font-size: 14px;line-height: 20px;'>满心满亿好幸运  用户h***9的投资使平台交易额跨过100亿大关 <br/>
助力百亿超给力  共1942位用户成功收获助力百亿大礼 <br/>
百亿狂欢极速秒  1月14日30元代金券被抢的平均用时为0.44秒/张
                        </div>
                    </div>
                    <div class="item item3" style="margin-top:0;margin-left: 187px;">
                        ...
                        <div class="con" style="padding-top: 30px;height: 80px;">金鸡报晓  贺岁纳福</div>
    ...
    <script type="text/javascript">
        ...
        var data_6_1 = {
            ...
            data:{
                sex:[
                    {value:4601, name:'女',total:336701400},
                    {value:3049, name:'男',total:217424100}
                ],
                age:[
                    {value:1054, name:'18-29岁'},
                    {value:1233, name:'30-39岁'},
                    {value:1802, name:'40-49岁'},
                    {value:1537, name:'50-59岁'},
                    {value:2024, name:'60岁以上'}
                ]
            },
        ...
        var yonghufenxi_data_3 = {
            ...
            //subtitle:"101501.22",
            data:[
                {value:2166, name:'1万以下'},
                {value:3046, name:'1-5万'},
                {value:1063, name:'5-10万'},
                {value:1208, name:'10-50万'},
                {value:167, name:'50万以上'}
            ],
    ...
    var data_6_5 = {
        title:'\r10大投资人\n金额之和占比',
        subtitle:"8.32%",//十大投资人占比
        data:[
            {value:46080600, name:'10大投资人金额'},
            {value:508044900, name:'其他投资人金额'}
        ]
    }
    ...
    $(document).ready(function() {
        ...
        $('#fullpage').fullpage({
            ...
            onLeave :function(index, nextIndex, direction){
                ...
                if(idx == 1){
                    var s1data1 = new CountUp("s1data1", 0, 10937548268, 0, 1.5, countUpOptions); //累计交易额(元)
                    var s1data2 = new CountUp("s1data2", 0, 206828, 0, 1.5, countUpOptions);//平台注册人数(人)
                    var s1data3 = new CountUp("s1data3", 0, 363174316.13, 2, 1.5, countUpOptions);//累计赚取收益(元)
                    var s1data4 = new CountUp("s1data4", 0, 53654555, 0, 1.5, countUpOptions);//风险保证金(元)
                    s1data1.start();
                    s1data2.start();
                    s1data3.start();
                    s1data4.start();
                }else if(idx == 2){
                    var s2data1 = new CountUp("s2data1", 0, 13162, 0, 1.5, countUpOptions);
                    var s2data2 = new CountUp("s2data2", 0, 5.61, 2, 1.5, countUpOptions);
                    var s2data3 = new CountUp("s2data3", 0, 42.38, 2, 1.5, countUpOptions);
                    var s2data4 = new CountUp("s2data4", 0, 1203.33, 2, 1.5, countUpOptions);
                    var s2data5 = new CountUp("s2data5", 0, 6.45, 2, 1.5, countUpOptions);
                    var s2data6 = new CountUp("s2data6", 0, 9.73, 2, 1.5, countUpOptions);
                    s2data1.start();
                    s2data2.start();
                    s2data3.start();
                    s2data4.start();
                    ...
                    var s4data1 = new CountUp("s4data1", 0, 5408, 0, 1.5, countUpOptions);
                    var s4data2 = new CountUp("s4data2", 0, 39.56, 2, 1.5, countUpOptions);
                    var s4data3 = new CountUp("s4data3", 0, 584, 0, 1.5, countUpOptions);
                    var s4data4 = new CountUp("s4data4", 0, 4.27, 2, 1.5, countUpOptions);
                    var s4data5 = new CountUp("s4data5", 0, 7680, 0, 1.5, countUpOptions);
                    var s4data6 = new CountUp("s4data6", 0, 56.17, 2, 1.5, countUpOptions);
                    s4data1.start();
                    s4data2.start();
                    s4data3.start();
                    s4data4.start();
                    ...
                    var s6data1 = new CountUp("s6data1", 0, 595.73, 2, 1.5, countUpOptions);//当月投资金额最高(万元)
                    var s6data2 = new CountUp("s6data2", 0, 18.66, 2, 1.5, countUpOptions);//当月投资次数最多(次)
                    var s6data3 = new CountUp("s6data3", 0, 254, 0, 1.5, countUpOptions);//当月历史回报最高(万元)
                    s6data1.start();
                    s6data2.start();
                    s6data3.start();
