...
<body class="201705">
    <div id="fullpage">
        <div class="section top" style="background-image: url(${ctx}/img/report/201705/top.jpg?v=20171123);">
        ...
        <div class="section section1 yejizonglan repeat">
            <div class="inner">
                ...
                <dl class="data1">
                    <dt>累计交易额（元）</dt>
                    <dd id="s1data1">13267741316</dd>
                </dl>
                <dl class="data2">
                    <dt>平台注册人数（人）</dt>
                    <dd id="s1data2">263146</dd>
                </dl>
                <dl class="data3">
                    <dt>累计赚取收益（元）</dt>
                    <dd id="s1data3">444387010</dd>
                </dl>
                <dl class="data4">
                    <dt>风险保证金（元）</dt>
                    <dd id="s1data4">68720100</dd>
                </dl>
            </div>
        </div>
        <div class="section section2 dangyueyeji repeat">
            <div class="inner">
                ...
                <div class="dangyueyeji_right">
                    <p>本月成交<span class="data" id="s2data1">26219</span>笔</p>
                    <p>成交金额共计<span class="data" id="s2data2">6.74</span>亿元</p>
                    <p>同比增长<span class="data"><span id="s2data3">61.24</span>%</span></p>
                </div>
                <div class="clearfix"></div>
                <div id="echarts2_2" style="width:520px;height: 220px;margin-top: 50px;float: left;"></div>
                <div class="dangyueyeji_right">
                    <p>本月为用户赚取收益<span class="data" id="s2data4">2306.62</span>万元</p>
                    <p>同比增长<span class="data"><span id="s2data5">70.94</span>%</span></p>
                    <p>本月平均历史回报率<span class="data"><span id="s2data6">9.82</span>%</span></p>
                </div>
            </div>
        </div>
        ...
        <div class="section section3 qudaofenxi repeat">
            <div class="inner">
                ...
                <div class="qudaofenxi_style2_left">
                    ...
                    <div class="item"><div class="icon phone"></div>本月成交<span id="s4data1">1349</span>笔，占比<span id="s4data2">46.45</span>%</div>
                    <div class="item-title"><img src="${ctx}/img/report/txt_weixin.png" alt=""></div>
                    <div class="item"><div class="icon wechat"></div>本月成交<span id="s4data3">1260</span>笔，占比<span id="s4data4">4.80</span>%</div>
                    <div class="item-title"><img src="${ctx}/img/report/txt_pc.png" alt=""></div>
                    <div class="item"><div class="icon desktop"></div>本月成交<span id="s4data5">12781</span>笔，占比<span id="s4data6">48.75</span>%</div>
                </div>
        ...
        <div class="section section5 dangyuezhizui repeat">
            <div class="inner">
                ...
                <div class="dangyuezhizui-left-style2">
                    ...
                    <div class="item-box">
                        <div class="item"><div class="name">l*</div><div class="value top3">642.00万</div></div>
                        <div class="item"><div class="name">H*</div><div class="value top3">446.70万</div></div>
                        <div class="item"><div class="name">l*</div><div class="value top3"> 433.66万</div></div>
                        <div class="item"><div class="name">h*</div><div class="value">429.56万</div></div>
                        <div class="item"><div class="name">h*</div><div class="value">400.08万</div></div>
                        <div class="item"><div class="name">1*</div><div class="value">351.63万</div></div>
                        <div class="item"><div class="name">李*</div><div class="value">276.99万</div></div>
                        <div class="item"><div class="name">h*</div><div class="value">256.80万</div></div>
                        <div class="item"><div class="name">s*</div><div class="value">237.28万</div></div>
                        <div class="item"><div class="name">澄*</div><div class="value">234.39万</div></div>
                    </div>
                </div>
                <div class="dangyuezhizui-right-style2">
                    <div class="item">
                        ...
                        <p class="item-value">
                            <span class="val1"><span id="s6data1">642.00</span> 万元</span>
                    ...
                    <div class="item">
                        ...
                        <p class="item-value">
                            <span class="val1"><span id="s6data2">35.05</span> 万元</span>
                            <span class="val2">l*</span>
                            <span class="val3">49岁</span>
                            <span class="val4">青岛市</span>
                        </p>
                    ...
                    <div class="item">
                        ...
                        <p class="item-value">
                            <span class="val1"><span id="s6data3">197</span>次</span>
        ...
        <div class="section section6 jingcaihuodong repeat">
            <div class="inner">
                ...
                <div class="inner-bg" style="width: 880px;margin-left: auto;margin-right: auto;">
                    <div class="item item3" style="margin-top:150px;margin-left: 150px;">
    ...
    <script type="text/javascript">
        ...
        var data_6_1 = {
            ...
            data:{
                sex:[
                    {value:7753, name:'女',total:401499000},
                    {value:5761, name:'男',total:262496500}
                ],
                age:[
                    {value:2004, name:'18-29岁'},
                    {value:2733, name:'30-39岁'},
                    {value:3123, name:'40-49岁'},
                    {value:2423, name:'50-59岁'},
                    {value:3231, name:'60岁以上'}
                ]
            },
        ...
        var yonghufenxi_data_3 = {
            ...
            //subtitle:"101501.22",
            data:[
                {value:4400, name:'1万以下'},
                {value:5810, name:'1-5万'},
                {value:1580, name:'5-10万'},
                {value:1572, name:'10-50万'},
                {value:152, name:'50万以上'}
            ],
    ...
    var data_6_5 = {
        title:'\r10大投资人\n金额之和占比',
        subtitle:"5.59%",//十大投资人占比
        data:[
            {value:37090900, name:'10大投资人金额'},
            {value:626904800, name:'其他投资人金额'}
        ]
    }
    ...
    $(document).ready(function() {
        ...
        $('#fullpage').fullpage({
            ...
            onLeave :function(index, nextIndex, direction){
                ...
                if(idx == 1){
                    var s1data1 = new CountUp("s1data1", 0, 13267741316, 0, 1.5, countUpOptions); //累计交易额(元)
                    var s1data2 = new CountUp("s1data2", 0, 263146, 0, 1.5, countUpOptions);//平台注册人数(人)
                    var s1data3 = new CountUp("s1data3", 0, 444387010, 0, 1.5, countUpOptions);//累计赚取收益(元)
                    var s1data4 = new CountUp("s1data4", 0, 68720100, 0, 1.5, countUpOptions);//风险保证金(元)
                    s1data1.start();
                    s1data2.start();
                    s1data3.start();
                    s1data4.start();
                }else if(idx == 2){
                    var s2data1 = new CountUp("s2data1", 0, 26219, 0, 1.5, countUpOptions);
                    var s2data2 = new CountUp("s2data2", 0, 6.74, 2, 1.5, countUpOptions);
                    var s2data3 = new CountUp("s2data3", 0, 61.24, 2, 1.5, countUpOptions);
                    var s2data4 = new CountUp("s2data4", 0, 2306.62, 2, 1.5, countUpOptions);
                    var s2data5 = new CountUp("s2data5", 0, 70.94, 2, 1.5, countUpOptions);
                    var s2data6 = new CountUp("s2data6", 0, 9.82, 2, 1.5, countUpOptions);
                    s2data1.start();
                    s2data2.start();
                    s2data3.start();
                    s2data4.start();
                    ...
                    var s4data1 = new CountUp("s4data1", 0, 12178, 0, 1.5, countUpOptions);
                    var s4data2 = new CountUp("s4data2", 0, 46.45, 2, 1.5, countUpOptions);
                    var s4data3 = new CountUp("s4data3", 0, 1260, 0, 1.5, countUpOptions);
                    var s4data4 = new CountUp("s4data4", 0, 4.80, 2, 1.5, countUpOptions);
                    var s4data5 = new CountUp("s4data5", 0, 12781, 0, 1.5, countUpOptions);
                    var s4data6 = new CountUp("s4data6", 0, 48.75, 2, 1.5, countUpOptions);
                    s4data1.start();
                    s4data2.start();
                    s4data3.start();
                    s4data4.start();
                    ...
                    var s6data1 = new CountUp("s6data1", 0, 642.00, 2, 1.5, countUpOptions);//当月投资金额最高(万元)
                    var s6data2 = new CountUp("s6data2", 0, 35.05, 2, 1.5, countUpOptions);//当月历史回报最高(万元)
                    var s6data3 = new CountUp("s6data3", 0, 197, 0, 1.5, countUpOptions);//当月投资次数最多(次)
                    s6data1.start();
                    s6data2.start();
                    s6data3.start();
