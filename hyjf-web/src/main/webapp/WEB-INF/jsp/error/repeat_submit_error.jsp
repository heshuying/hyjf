        ...
        <div class="container result">
            <div class="result-content">
            	<div class="result-top">
            		<img src="${cdn}/dist/images/result/exce@2x.png" alt="" width="223px"/>
            	</div>
            	<div class="register-mid">
            		<p>
            		对不起，您的表单已经提交，或者过期，请稍后再试...<br>
					Sorry,Your form has been submitted, or has expired. Please try again later...
					</p>
            	</div>
