		...
		<div id="result" class=" panel panel-default ">
			<table class="table">
				...
				<tbody id="resultBody">
					<tr>
						<td>CmdId</td>
						<td id="CmdId">${bean.cmdId }</td>
					</tr>
					<tr>
						<td>RespCode</td>
						<td id="RespCode">${bean.respCode }</td>
					</tr>
					<tr>
						<td>RespDesc</td>
						<td id="RespDesc"><script>document.write(decodeURI("${bean.respDesc}"));</script></td>
					</tr>
					<tr>
						<td>ChkValue</td>
						<td id="ChkValue" style="word-break: break-all;word-wrap: break-word;">${bean.chkValue }</td>
					</tr>
					<tr>
						<td>resultBody</td>
