...
<body>
        ...
        <div class="container-1200">
            ...
            <div class="touzi-con htj htj-detail">
                ...
                <div class="item">
                    ...
                    <div class="tit">到账日期：${planinfo.repayTime }</div>
                </div>
    ...
    <div class="project-tabbing htj-detail-tabbing" style="padding-top:30px;">
        <div class="container-1200">
            <div class="htj-detail-summary ytc">  <!-- sgz:申购中,sdz:锁定中,ytc:已退出 -->
                <div class="title">资产统计</div>
                <div class="clearfix"></div>
                <div class="content"><span>回款金额：<span class="highlight">${repayAccountYes }</span>元</span><span>实际收益：<span class="highlight">${factIntrest }</span>元</span></div>
            </div>
