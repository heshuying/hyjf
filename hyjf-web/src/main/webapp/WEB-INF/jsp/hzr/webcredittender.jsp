    ...
    <div class="new-detail-con">
        <div class="new-detail-inner">
            ...
            <div class="new-detail-hd">
                ...
                <div class="hd2">
                    <form action="${ctx}/credit/websubmitcredittenderassign.do" id="detialForm" method="post">
                        ...
                        <div class="hd2-item con1">
                            ...
                            <span class="total"><fmt:formatNumber value="${creditResult.data.creditTender.creditAssignCapital}" pattern="#,##0.00"/> <span class="total-font">元</span></span>
                        ...
                        <div class="hd2-item con2">
                            ...
                            <a href="${ctx}/recharge/rechargePage.do" class="recharge">充值</a>
                            </c:if>
                            <!-- 用户未登录 -->
                            <c:if test="${creditResult.data.userId==null || creditResult.data.userId=='' || creditResult.data.userId==0}">
                            <span class="title">可用余额</span>
                        ...
                        <div class="hd2-item con4">
                             <div class="appoint-term">
                             	...
                             	<div class="terms-box">
	                              	<a href="#"onclick="openNew('${ctx}/agreement/transferOfCreditorRight.do')" class="highlight">《债权转让协议》</a>              	
	                              	<a href="#"onclick="openNew('${ctx}/agreement/confirmationOfInvestmentRisk.do')" class="highlight">《投资风险确认书》</a>
                             	</div>
                             </div>
                       	 </div>
                ...
                <div class="hd3 zhuanrang">
                    <div class="infor">原借款项目：<a href="${ctx}/project/getProjectDetail.do?borrowNid=${creditResult.data.borrow.borrowNid}" class="highlight">${creditResult.data.borrow.borrowNid}</a></div>
...
<script type="text/javascript">
	...
	function repayPage(page, limit, param){
		if(page!=null && page!="" && page!=0){
			jQuery.ajax({
				type: "POST",
				async: "async",
				url: "${ctx}/credit/webcreditrepaypage.do",
				contentType:"application/x-www-form-urlencoded;charset=utf-8",
				dataType: "json",
				data: {
	...
	function tenderPage(page, limit, param){
		if(page!=null && page!="" && page!=0){
			jQuery.ajax({
				type: "POST",
				url: "${ctx}/credit/webcredittenderpage.do",
				contentType:"application/x-www-form-urlencoded;charset=utf-8",
				dataType: "json",
				data: {
					"creditNid":jQuery("#creditNid").val(),
