            ...
            <!-- start 内容区域 -->   
                <div class="invest-success">
                    <div class="top-attr">
                        ...
                        <p class="top-title">抱歉，承接失败，请重试</p>
                    </div>
                    
                    <div class="bom-attr">
                    	<a href="${ctx}/bank/user/trade/initTradeList.do" class="open">查看交易明细</a>
                        <c:if test="${projectType eq 4}">
                        	<a href="${ctx}/bank/web/borrow/newBorrowList.do" class="open">继续承接</a>
						</c:if>
						<c:if test="${projectType ne 4}">
							<a href="${ctx}/bank/web/borrow/initBorrowList.do" class="open">继续承接</a>
						</c:if>
