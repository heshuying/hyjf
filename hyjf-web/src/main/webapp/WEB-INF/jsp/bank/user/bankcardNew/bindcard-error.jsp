	    	...
	    	<div class="container result">
	    		...
	    		<div class="acount-recharge">
	    			<div class="bind-success">
	    				<img src="${ctx }/dist/images/account/bind-error-icon@2x.png" alt="" style="height: 100px;margin-top: 60px;"/>
	    				<p style="margin-top: 30px;">绑定失败</p>
	    				<div>
	    					<a href="${ctx }/bank/web/bindCard/bindCardNew.do" class="bind-success-btn2">返回</a>
	    				</div>
	    			</div>
