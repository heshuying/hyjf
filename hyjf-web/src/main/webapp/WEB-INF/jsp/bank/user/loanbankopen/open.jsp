		...
		<div class="container result">
			<div class="account-set-up-2">
				...
				<div class="set-content">
					<form action="${ctx}/bank/web/user/loanbankopen/open.do" method="post" id="bankOpenForm">
						<label>
						...
						<div class="kh-item">
							<input type="submit" value="借款人开户" class="kaihu-btn" />
						</div>
						<a class="otherRole" href="/bank/web/user/bankopen/init.do">我是出借人 ></a>
					</form>
				</div>
				<!-- end 内容区域 -->
			</div>
