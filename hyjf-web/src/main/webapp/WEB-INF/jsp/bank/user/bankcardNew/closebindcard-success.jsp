	    	...
	    	<div class="container result">
	    		...
	    		<div class="acount-recharge">
	    			<div class="bind-success">
	    				<img src="${ctx }/dist/images/account/closebind-success-icon@2x.png" alt="" style="height: 138px;margin-top: 60px;"/>
	    				<p>解绑成功</p>
	    				<div>
							<c:if test="${from == null}">
	    					...
	    					<a href="${ctx }/bank/web/bindCard/bindCardNew.do" class="bind-success-btn2">去绑卡</a>
	    				</div>
	    			</div>
