	    	...
	    	<div class="container result">
	    		...
	    		<div class="acount-recharge">
	    			<div class="bind-success">
	    				<img src="${ctx }/dist/images/account/bind-success-icon@2x.png" alt="" style="height: 138px;margin-top: 60px;"/>
	    				<p>绑定成功</p>
	    				<div>
	    					<a href="${ctx}/bank/web/bindCard/myCardInit.do" class="bind-success-btn1">完成</a>
	    					<a href="${ctx }/bank/web/user/recharge/rechargePage.do" class="bind-success-btn2">去充值</a>
	    				</div>
	    			</div>
