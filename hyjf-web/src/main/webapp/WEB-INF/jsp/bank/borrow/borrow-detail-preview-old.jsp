	...
	<article class="main-content product">
        <div class="container">
            ...
            <div class="product-intr">
                <div class="title">
                    <span>${projectDeatil.borrowAssetNumber}</span>
                ...
                <div class="flow-content">
		            <c:choose>
						...
						<c:when test="${projectDeatil.type eq 13 && projectDeatil.isNew == 1}">
							...
							<div class="line done"></div>
							<div class="item done">
								<div class="icon icon-hk"></div>
								回款
							</div>
						</c:when>
						<c:when test="${projectDeatil.type ne 13}">
							<img alt="项目流程图" src="${cdn}/dist/images/product/product_old_flow.png">
						</c:when>
					</c:choose>
				</div>
            </section>
