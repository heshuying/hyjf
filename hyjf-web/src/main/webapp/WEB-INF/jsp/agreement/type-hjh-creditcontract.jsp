            ...
            <section class="about-detial creditcontract content">
                <div class="main-title">
                    ...
                    <c:if test="${creditResult.data.borrow.borrowNid != null && creditResult.data.borrow.borrowNid != '' }">
                    	 <a class="download-txt" href="${ctx}/createAgreementPDF/creditHJHTransferAgreementPDF.do?bidNid=${borrowNid}&creditNid=${creditNid}&creditTenderNid=${creditTenderNid}&assignNid=${assignNid}" target="blank">下载协议</a>
                    </c:if>
                </div>
                <div class="detial-list">
                    ...
                    <table border="1" class="table-info">
                      ...
                      <tr>
                        <td>预计还款日</td>
                        <td>
                        自  ${createTime}月起，每月${addip}   日（24:00前）
                         </td>
                      </tr>
                       <tr>
                        <td>借款期限</td>
