            ...
            <section class="about-detial content">
                ...
                <div class="main-tab jion-us">
                	<div class="event">
                    	...
                    	<p>信息安全测评认证信息：</p>
                    	<img src="${ctx}/dist/images/aboutUs/record-info.jpg" alt="" />
                    </div>
			    </div>
            </section>
        </div>
            ...
            <section class="about-detial content">
                <div class="main-tab jion-us" style="line-height: 2;">
                	...
                	<div style="text-align: center;margin-top: 20px;">
                		<img src="${ctx}/dist/images/aboutUs/record-info-2.jpg" alt="" />
                	</div>
					...
					<div style="text-align: center;margin-top: 50px;">
                		<img src="${ctx}/dist/images/aboutUs/record-info-3.jpg" alt="" />
                	</div>
					...
					<div style="text-align: center;margin-top: 50px;">
                		<img src="${ctx}/dist/images/aboutUs/record-info-4.jpg" alt="" />
                	</div>
                	<div style="padding-bottom: 70px;margin-top: 45px;">
                		汇盈金服会综合多方情况统一调配催收资源，妥善执行催收工作，避免形成不良资产。对于通过常规催收流程仍然不能实现有效回款的情况，我们将采取诉讼等法律方式。
                	</div>
			    </div>
			    <div class="detial-btn"> 
			    	<a href= "/aboutus/searchFXReportList.do" itemid="lt">返回列表<i class="iconfont icon-xiayibu63"></i></a>
			    </div>
            </section>
        </div>
   </article>
