...
<body>
        ...
        <div class="container">
            <section class="content" style="padding-bottom: 28px;">
                ...
                <div class="main-tab jion-us">
					<div class="about-government">
						...
						<img src="../dist/images/aboutUs/government-1.jpg" alt="" />
					</div>
                </div>
            </section>
            <section class="content" style="margin-top:25px;padding-top:1px;padding-bottom:60px">
            	<div class="about-government">
					...
					<img src="../dist/images/aboutUs/government-2.jpg" alt="" />
				</div>
            </section>
            <section class="content" style="margin-top:25px;padding-top:1px;padding-bottom:60px">
            	<div class="about-government">
	...
	<script src="../dist/js/lib/echarts.min.js"></script>
	<script src="../dist/js/lib/baguetteBox.min.js"></script>
	<script src="../dist/js/about/about.js"></script>
