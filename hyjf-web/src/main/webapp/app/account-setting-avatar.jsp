...
<body>
            	...
            	<div class="acc-set-avatar">
            		<div class="acc-set-avatar-1">
            			<div class="acc-set-avatar-1-img inline-block">
            				<img src="${ctx }/dist/images/acc-set/upload-default-avatar@2x.png" width="134" height="134"/>
            				<p>当前头像</p>
            			</div>
            			<div class="acc-set-avatar-1-upload inline-block">
            				...
            				<label class="avatar-select-pic acc-set-btn" for="inputImage1">
            					<img src="http://img.hyjf.com/dist/images/acc-set/acc-set-avatar-default.png"/>
            					选择图片文件
	...
	<script src="../dist/js/lib/cropper.min.js"></script>
