        ...
        <div class="container">
            ...
            <div class="product-intr">
                ...
                <div class="list">
                    ...
                    <div class="list-item">项目编号：HDF12314512</div>
            ...
            <form class="product-form" action="post" id="productForm">
                ...
                <div class="field sub">
                    ...
                    <input type="hidden" name="coupon" value="" data-type="0" data-count="4" data-id="1" data-txt="请选择优惠券" id="couponInput">
                </div>
                <div class="field sub">
                    <div class="key dark">历史回报：</div>
                    <div class="val fl-r" id="gains">0.00 元</div>
                </div>
                <div class="field">
