	    			...
	    			<form id="rechargeForm">
		    			<ul>
		    				...
		    				<li class="type">
		    					...
		    					<div class="info"><a data-val=1 class="check onlinebank">快捷充值<span></span></a><a class="offline" data-val=2>线下充值<span></span></a></div>
		    				...
		    				<li class="card">
		    					...
		    					<div class="info">
		    						<div>622&nbsp;****&nbsp;****&nbsp;****&nbsp;0652</div>
		    						<div class="quota">限额： 单笔10万元 单日10万元</div>
		    						<a href="#">解绑>></a>
		    				...
		    				<li class="recharge">
		    					...
		    					<div class="info acount-input"><input type="text" onkeyup="value=value.replace(/[^\d]/g,'')" placeholder="请输入金额" autocomplete="off" name="money"/><em>元</em></div>
		    				</li>
		    				<li class="offline">
