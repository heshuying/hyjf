...
<body>
		    			...
		    			<ul>
		    				...
		    				<li class="bound-card">
		    					...
		    					<div class="info acount-input">
		    						<input name="card" type="text" onkeyup="value=value.replace(/[^\d]/g,'')" placeholder="请输入银行卡号" autocomplete="off" oninput="if(value.length>19)value=value.slice(0,19)"><em>元</em>
		    					</div>
		    				</li>
		    			</ul>
		    			<a class="sub">申请提现</a>
	...
	<script src="../dist/js/lib/jquery.validate.js" type="text/javascript" charset="utf-8"></script>
	<script src="../dist/js/lib/jquery.metadata.js" type="text/javascript" charset="utf-8"></script>
