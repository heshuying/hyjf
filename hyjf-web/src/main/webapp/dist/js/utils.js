...
var saEvents = {
	...
	// *  神策 服务费授权
	// * */
    // submitFeeAuth: function(){
    //     sa.track('submit_fee_auth',{
    //         auth_time: moment().format('YYYY-MM-DD HH:mm:ss.SSS'),
    //         auth_name: '服务费授权'
    //     })
    // },
    // /*
    ...
    // *  神策 智投授权
    // * */
    // submitPlanAuth: function(){
    //     sa.track('submit_plan_auth',{
    //         auth_time: moment().format('YYYY-MM-DD HH:mm:ss.SSS'),
    //         auth_name: '智投授权'
    //     })
    // },
    /*
    *  神策出借人/借款人授权
    * @param authName String 授权名
    * */
    submitPlanAuth: function(authName){
        sa.track('submit_plan_auth',{
            entrance: document.referrer,
            is_choose: true,
            auth_time: moment().format('YYYY-MM-DD HH:mm:ss.SSS'),
            auth_name: authName || '出借人授权'
        })
    },
    /*
    *
    ...
    * */
    submitAccount: function(){
        sa.track('submit_account',{
            entrance: document.referrer,
            open_time: moment().format('YYYY-MM-DD HH:mm:ss.SSS')
        });
    },
