    ...
    var validator=$("#registerForm").validate({
		submitHandler: function(form) {
	    	...
	    	$.ajax({
	    		...
	    		type:'post',
	    		data:{"userType":userType,"tokenCheck":tokenCheck,"tokenGrant":tokenGrant,"utm_id":utm_id,"utm_source":utm_source,"newRegPsw":newRegPsw,"newRegPhoneNum":newRegPhoneNum,
	    		...
	    		success:function(data){
	    			if(data.status){
						...
						*/
                        ...
                        setTimeout(function(){
                        	if(data.userType=="2"){
                        		location.href=location.href = webPath + "/user/regist/businessUsersRegisterSuccess.do?userid=" + data.userid+"&activity68="+ data.activity68+"&couponSendCount="+ data.couponSendCount;
                        	}else{
