package com.hyjf.web.tender.paginator;
    ...
    public String getWebPaginator() {
        ...
        if (isHasPrePage()) {// 如果是首页
            if(StringUtils.isNotEmpty(functionName)){
                sb.append("<div class=\"prev\"><a href=\"javascript:void(0)\" onclick=\""+functionName+"("+(page - 1)+","+limit+","+funcParam+")"+"\" data-page=\"" + (page - 1) + "\">&lt;</a></div>");
            }else{
                sb.append("<div class=\"prev\"><a href=\"javascript:void(0)\" data-page=\"" + (page - 1) + "\">&lt;</a></div>");
            }
        } else {
        ...
        if (begin > first) {
            ...
            for (i = first; i < first + slider && i < begin; i++) {
                if(StringUtils.isNotEmpty(functionName)){
                    sb.append("<a class=\"item\" href=\"javascript:void(0)\" onclick=\""+functionName+"("+i+","+limit+","+funcParam+")"+"\" data-page=\"" + i + "\">" + i + "</a>");
                }else{
        ...
        for (int i = begin; i <= end; i++) {
            if (i == page) {
                ...
                if(StringUtils.isNotEmpty(functionName)){
                    sb.append("<a class=\"item\" href=\"javascript:void(0)\" onclick=\""+functionName+"("+i+","+limit+","+funcParam+")"+"\" data-page=\"" + (i + 1 - first) + "\">" + (i + 1 - first) + "</a>");
                }else{
                    sb.append("<a class=\"item\" href=\"javascript:void(0)\" data-page=\"" + (i + 1 - first) + "\">" + (i + 1 - first) + "</a>");
                }
            }
        }
        ...
        for(int i=1;i<=totalPages;i++){
            if(page==i){
                sb.append("<a class=\"item active\">" + page + "</a>");
            }else{
                if(StringUtils.isNotEmpty(functionName)){
                    sb.append("<a class=\"item\" href=\"javascript:void(0)\" onclick=\""+functionName+"("+i+","+limit+","+funcParam+")"+"\" data-page=\"" + i + "\">" + i + "</a>");
                }else{
        ...
        */
        if(isHasNextPage()){
            if(StringUtils.isNotEmpty(functionName)){
                sb.append("<div class=\"next\"><a href=\"javascript:void(0)\" onclick=\""+functionName+"("+(page + 1)+","+limit+","+funcParam+")"+"\" data-page=\"" + (page + 1) + "\">&gt;</a></div>");
            }else{
                sb.append("<div class=\"next\"><a href=\"javascript:void(0)\" data-page=\"" + (page + 1) + "\">&gt;</a></div>");
            }
        }else{
