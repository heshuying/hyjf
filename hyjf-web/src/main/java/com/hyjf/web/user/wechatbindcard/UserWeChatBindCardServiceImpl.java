...
import com.hyjf.web.user.bindcard.UserBindCardServiceImpl;

@Service
public class UserWeChatBindCardServiceImpl extends BaseServiceImpl implements UserWeChatBindCardService{
