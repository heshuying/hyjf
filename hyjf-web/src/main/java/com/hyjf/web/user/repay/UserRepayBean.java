...
public class UserRepayBean implements Serializable {
    ...
    /** 用户还款详情 */
    private List<UserRepayDetailBean> userRepayDetailList;

    public UserRepayBean() {
        super();
    }
    ...
    public List<UserRepayDetailBean> getUserRepayDetailList() {
        return userRepayDetailList;
    }

    public void setUserRepayDetailList(List<UserRepayDetailBean> userRepayDetailList) {
