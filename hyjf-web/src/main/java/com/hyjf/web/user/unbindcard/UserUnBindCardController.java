 ...
 */
@Controller
@RequestMapping(value = UserUnBindCardDefine.REQUEST_MAPPING)
public class UserUnBindCardController extends BaseController {

	@Autowired
	private UserUnBindCardService userUnBindCardService;
	@Autowired
	 ...
	 * @return
	 */
	@RequestMapping(UserUnBindCardDefine.RETURN_MAPPING)
	public void unBindCardReturn(HttpServletRequest request, @ModelAttribute ChinapnrBean bean) {
		...
		LogUtil.startLog(UserUnBindCardController.class.toString(), UserUnBindCardDefine.REQUEST_MAPPING);
		...
		LogUtil.endLog(UserUnBindCardController.class.toString(), UserUnBindCardDefine.REQUEST_MAPPING);
	}
}