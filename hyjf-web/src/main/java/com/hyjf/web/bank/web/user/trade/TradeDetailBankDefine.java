...
public class TradeDetailBankDefine extends BaseDefine {

	/** 用户交易明细 @RequestMapping值 */
	public static final String REQUEST_MAPPING = "/bank/user/trade";
	...
	/** 交易明细页面地址 @Path值 */
    public static final String TRADE_LIST_PTAH = "bank/user/trade/tradeList";
    

	/** 类名 */
	public static final String THIS_CLASS = TradeDetailBankController.class.getName();
