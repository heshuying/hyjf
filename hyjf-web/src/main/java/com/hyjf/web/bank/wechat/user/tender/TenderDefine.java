...
public class TenderDefine extends BaseDefine {
	...
	public static final String CONTROLLER_NAME = "WeChatTenderController";
	/** @RequestMapping值 */
	public static final String REQUEST_MAPPING = "/bank/wechat/user/tender";
	/** @RequestMapping值 */
	public static final String INVEST_ACTION = "/invest";
	/** @RequestMapping值 */
	public static final String APPOINT_CONTRACT_ACTION = "/contract";
	/** @RequestMapping值 */
	public static final String GET_BORROW_ACCOUNT_WAIT_ACTION ="/getBorrowAccountWait";
	/** @RequestMapping值 */
