...
public class BankOpenDefineOld extends BaseDefine {
	
	public static final String CONTROLLER_NAME = "WeChatBankOpenOldController";
	/** @RequestMapping值 */
	public static final String REQUEST_MAPPING = "/bank/wechat/user/bankopenold";
	/** @RequestMapping值 */
