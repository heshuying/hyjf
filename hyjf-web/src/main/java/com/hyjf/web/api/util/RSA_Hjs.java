...
public class RSA_Hjs {
    ...
    public static String decrypt(String str, String charset) throws Exception {
        ...
        String key = PropUtils.getSystem(PUBLICKEY_HJS).trim();

        //公钥解密
        String str1 = new String(RSA_Hjs.decryptByPublicKey(Base64.decodeBase64(str), key),"utf-8");
        return str1;
    ...
    public static String encode(String str) throws Exception {
            ...
            String key = PropUtils.getSystem(PRIVATEKEY_HJS).trim();
          //私钥加密
            String s = Base64.encodeBase64String(RSA_Hjs.encryptByPrivateKey(str.getBytes(), key));
            return s;
