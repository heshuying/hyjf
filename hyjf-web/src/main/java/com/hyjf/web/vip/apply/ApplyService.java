...
public interface ApplyService extends BaseService {
	...
	JSONObject updateUserVip(Integer userId,BigDecimal transAmt,HttpServletRequest request,String ordId,String usrCustId,String merCustId) throws Exception;
