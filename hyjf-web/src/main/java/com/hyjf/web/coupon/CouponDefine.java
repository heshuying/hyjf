...
public class CouponDefine extends BaseDefine {
    ...
    /** 获取用户优惠券列表初始化頁面 @RequestMapping值*/
    public static final String GET_USERCOUPON = "/getUserCoupons";
    /** 获取用户优惠券列表数据 @RequestMapping值*/
    public static final String GET_USERCOUPON_LIST = "/getUserCouponList";
    ...
    /** 优惠券详情的路径 */
    public static final String COUPON_LIST_PATH = "coupon/couponlist";
    /** 优惠券详情的路径 */
