...
@Service("ApiUserBindService")
public class ApiUserBindServiceImpl extends ApiBaseServiceImpl implements ApiUserBindService {
     ...
     */
    @Override
    public Integer getUserIdByBind(String bindUniqueId, int bindPlatformId) {
        //检索条件
