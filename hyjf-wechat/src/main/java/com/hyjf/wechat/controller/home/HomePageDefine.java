...
public class HomePageDefine extends BaseDefine {
	...
	public static final String INDEX_DATA_ACTION = "/getIndexData";
	/** 首页接口  @RequestMapping值 */
	public static final String GET_HOME_PROJECT_LIST_ACTION = "/getHomeProjectList";
	
	/** 首页项目列表(不带计划)  @RequestMapping值 */
	public static final String INDEX_DATA_ACTION_NOPLAN = "/getIndexDataNoPlan";
