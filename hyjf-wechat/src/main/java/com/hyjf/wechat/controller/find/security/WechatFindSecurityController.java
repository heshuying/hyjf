package com.hyjf.wechat.controller.find.security;
 ...
 */
@Controller
@RequestMapping(value = WechatFindSecurityDefine.REQUEST_MAPPING)
public class WechatFindSecurityController {
    @Autowired
     ...
     */
    @ResponseBody
    @RequestMapping(value = WechatFindSecurityDefine.SECURITY)
