...
public class PaymentAuthPagePlusController extends BaseController {
	...
	public ModelAndView userAuthInves(HttpServletRequest request,
		...
		String retUrl = PropUtils.getSystem(CustomConstants.HYJF_WEB_URL)+ request.getContextPath()
				...
				+ PaymentAuthPagePlusDefine.RETURL_SYN_ACTION + ".page?authType="+AuthBean.AUTH_TYPE_PAYMENT_AUTH+"&sign="+sign;
		// 异步调用路
	...
	public ModelAndView userAuthInvesReturn(HttpServletRequest request,
...
//        bean=retBean;
	...
	public BankCallResult userAuthInvesBgreturn(HttpServletRequest request,
			HttpServletResponse response, @ModelAttribute BankCallBean bean) {
