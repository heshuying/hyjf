...
public class WxConfigUtil {
	 ...
	 * @return
	 */
	public static Map<String, Object> getSignature(String url, String appId, String secret, Integer userId) {
		// 生成签名的随机串
		...
		if (accessTocken == null || StringUtils.isBlank(accessTocken.getToken())) {
			throw new RuntimeException("微信接口调用失败, accessTocken is null...");
		}
