...
package com.hyjf.wechat.controller.vip.apply;
...
public class ApplyDefine extends BaseDefine {
    ...
    /** 用户登录请求 */
    public static final String LOGIN_REQUEST_MAPPING = "://jumpLogin/?";
    /** 用户开户请求 */
    public static final String OPEN_ACCOUNT_REQUEST_MAPPING = "/user/openaccount/open.do";
    /** 用户充值请求 */
    public static final String RECHARGE_REQUEST_MAPPING = "://jumpRecharge/?";
    /** vip申请请求 跳转汇付url */
