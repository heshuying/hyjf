...
public enum ResultEnum {
    ...
    ERROR_045("99","用户绑卡失败"),
    ERROR_046("046","密码错误次数已达上限，请明日再试"),
    BORROE_ERROR_100("100", "标的信息不存在"),//标的信息错误码
    ...
    USER_ERROR_218("218", "开户成功，设置交易密码失败！"),
    USER_ERROR_219("219", "授权期限过短或额度过低，<br>请重新授权！"),
    USER_ERROR_1001("1001", "用户已评测"),
    USER_ERROR_1002("1002", "用户还未评测"),
    USER_ERROR_1003("1003", "用户未绑定银行卡"),
    USER_ERROR_1012("1012", "用户评测已过期"),
    USER_ERROR_1013("719", "您当前的风险测评类型为XXXX根据监管要求，XXXX用户单笔最高出借限额XXXX万。"),
    USER_ERROR_1014("716", "您当前的风险测评类型为XXXX，达到XXXX及以上才可进行出借"),
    USER_ERROR_1015("717", "如果您继续出借，当前累计出借本金将超过您的风险等级XXXX对应的限额。"),
    ...
    USER_WITHDRAW_009("1012", "未进行服务费授权");
