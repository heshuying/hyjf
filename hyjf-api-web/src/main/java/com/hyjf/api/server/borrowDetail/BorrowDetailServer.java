...
@RestController
@RequestMapping(value = BorrowDetailDefine.REQUEST_MAPPING)
public class BorrowDetailServer extends BaseController{
     ...
     * @return
     */
    @RequestMapping(value = BorrowDetailDefine.BORROW_DETAIL_ACTION)
    public ResultApiBean<BorrowDetailCustomize> getProjectDetail(@RequestBody BorrowDetailRequestBean bean
    ) {
        // 验证
        // 共通验证
        ...
        // 验签
        CheckUtil.check(this.verifyRequestSign(bean, BorrowDetailDefine.BORROW_DETAIL_ACTION),
                MsgEnum.ERR_SIGN);
