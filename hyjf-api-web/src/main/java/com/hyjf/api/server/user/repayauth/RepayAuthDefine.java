...
public class RepayAuthDefine extends BaseDefine {
   
    
    public static final String PROJECT_NAME="/hyjf-api-web";
    
    /** 当前controller名称 */
    public static final String THIS_CLASS = RepayAuthServer.class.getName();
    
    
    //-------------------------------------------------------------------------------------------------
    public static final String CONTROLLER_NAME = "RepayAuthServer";
    /** @RequestMapping值 */
    public static final String REQUEST_MAPPING = "/server/repayAuth";
