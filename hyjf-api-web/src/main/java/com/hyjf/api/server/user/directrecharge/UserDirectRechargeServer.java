 ...
 */
@Controller
@RequestMapping(UserDirectRechargeDefine.REQUEST_MAPPING)
public class UserDirectRechargeServer extends BaseController {

    Logger _log = LoggerFactory.getLogger(UserDirectRechargeServer.class);
     ...
     */
    @ResponseBody
    @RequestMapping(UserDirectRechargeDefine.RECHARGE_ACTION)
    public ModelAndView recharge(@RequestBody UserDirectRechargeRequestBean userRechargeRequestBean, HttpServletRequest request, HttpServletResponse response) {
        LogUtil.startLog(UserDirectRechargeDefine.THIS_CLASS, UserDirectRechargeDefine.RECHARGE_ACTION);
        ...
        try {
            ...
            if (!this.verifyRequestSign(userRechargeRequestBean, UserDirectRechargeDefine.REQUEST_MAPPING+UserDirectRechargeDefine.RECHARGE_ACTION)) {
                _log.info("----验签失败----");
            ...
            String retUrl = PropUtils.getSystem(CustomConstants.HYJF_WEB_URL) + request.getContextPath()
                    + UserDirectRechargeDefine.REQUEST_MAPPING + UserDirectRechargeDefine.RETURL_SYN_ACTION + ".do?acqRes="
            ...
            String bgRetUrl = PropUtils.getSystem(CustomConstants.HYJF_WEB_URL) + request.getContextPath()
                    + UserDirectRechargeDefine.REQUEST_MAPPING + UserDirectRechargeDefine.RETURL_ASY_ACTION + ".do?acqRes="
