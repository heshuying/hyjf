...
@Controller
@RequestMapping(value = AemsTrusteePayDefine.REQUEST_MAPPING)
public class AemsTrusteePayServer extends BaseController {
    
    Logger logger = LoggerFactory.getLogger(AemsTrusteePayServer.class);
    ...
    **/
    @RequestMapping(method = RequestMethod.POST,value = AemsTrusteePayDefine.TRUSTEE_PAY_ACTION)
    public ModelAndView trusteePay(HttpServletRequest request, @RequestBody AemsTrusteePayRequestBean payRequestBean){
        ModelAndView modelAndView = new ModelAndView(AemsTrusteePayDefine.PATH_TRUSTEE_PAY_ERROR);
        ...
        // 验签 借款人受托支付申请
       if (!this.AEMSVerifyRequestSign(payRequestBean, AemsTrusteePayDefine.REQUEST_MAPPING+AemsTrusteePayDefine.TRUSTEE_PAY_ACTION)) {
        ...
        // 检查标的状态 // 待授权状态才可以
        if(!borrow.getStatus().equals(AemsTrusteePayDefine.BORROW_STATUS_WITE_AUTHORIZATION)){
        ...
        String retUrl = PropUtils.getSystem(CustomConstants.HYJF_WEB_URL) + request.getContextPath()
                + AemsTrusteePayDefine.REQUEST_MAPPING + AemsTrusteePayDefine.SYN_ACTION + ".do?acqRes="
        ...
        String bgRetUrl = PropUtils.getSystem(CustomConstants.HYJF_WEB_URL) + request.getContextPath()
                + AemsTrusteePayDefine.REQUEST_MAPPING + AemsTrusteePayDefine.ASY_ACTION + ".do?acqRes="
    ...
    // 同步回调
    @RequestMapping(AemsTrusteePayDefine.SYN_ACTION)
    ...
    // 异步回调
    @ResponseBody
    @RequestMapping(value = AemsTrusteePayDefine.ASY_ACTION,method = RequestMethod.POST)
    ...
    // 标的号  电子账户号
    @ResponseBody
    @RequestMapping(value = AemsTrusteePayDefine.TRUSTEEPAYQUERY_ACTION , method = RequestMethod.POST)
    public JSONObject trusteePayQuery(HttpServletRequest request, @RequestBody AemsTrusteePayRequestBean payRequestBean , HttpServletResponse response) {
        ...
        // 验签
        if (!this.AEMSVerifyRequestSign(payRequestBean, AemsTrusteePayDefine.REQUEST_MAPPING+AemsTrusteePayDefine.TRUSTEEPAYQUERY_ACTION)) {
