 ...
 */
@Controller
@RequestMapping(value = AemsSynBalanceDefine.REQUEST_MAPPING)
public class AemsSynBalanceServer extends BaseController {
    
	Logger logger = LoggerFactory.getLogger(AemsSynBalanceServer.class);
     ...
     */
    @ResponseBody
    @RequestMapping(method = RequestMethod.POST,value = AemsSynBalanceDefine.SYNBALANCE_ACTION)
    public AemsSynBalanceResultBean synBalance(@RequestBody AemsSynBalanceRequestBean synBalanceRequestBean, HttpServletRequest request, HttpServletResponse response) {
        LogUtil.startLog(this.getClass().getName(), AemsSynBalanceDefine.SYNBALANCE_ACTION);
        ...
        //验证请求参数
        if (Validator.isNull(synBalanceRequestBean.getAccountId())
                ||Validator.isNull(synBalanceRequestBean.getInstCode())
                ||Validator.isNull(synBalanceRequestBean.getTimestamp())
                ||Validator.isNull(synBalanceRequestBean.getChannel())
                ||Validator.isNull(synBalanceRequestBean.getChkValue())
                ) {
        ...
        //验签
        if(!this.AEMSVerifyRequestSign(synBalanceRequestBean, AemsSynBalanceDefine.REQUEST_MAPPING+AemsSynBalanceDefine.SYNBALANCE_ACTION)){
        ...
        if(user == null){
            ...
            LogUtil.endLog(this.getClass().getName(), AemsSynBalanceDefine.SYNBALANCE_ACTION);
            return resultBean;
        }
        //用户可用余额
