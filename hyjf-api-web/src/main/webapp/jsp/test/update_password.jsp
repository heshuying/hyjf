...
<body>
	<h1 class="text-center col-sm-12" style="margin-bottom:30px;">修改银行交易密码</h1>
	<br/><br/><br/>
	<a href="set_password.jsp">设置交易密码</a>
	
	<form id="form1" action="${ctx}/server/user/transpassword/resetPassword.do" method="post" enctype="application/json">
