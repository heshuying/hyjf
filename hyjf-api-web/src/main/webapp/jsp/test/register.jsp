...
<body>
	<h1 class="text-center col-sm-12" style="margin-bottom:30px;">用户注册</h1>
	<br/><br/><br/>
	
	<form id="form1" action="${ctx}/server/user/register/register.do" method="post" enctype="application/json">
		...
		<div id="result" class=" panel panel-default ">
			<table class="table">
				...
				<tbody id="resultBody">
					...
					<tr>
						<td>机构编号</td>
						<td id="retMsg"><input id="instCode" name="instCode" value=""/></td>
					</tr>
					<tr>
