...
<body>
	<h1 class="text-center col-sm-12" style="margin-bottom:30px;">自动投资授权</h1>
	<br/><br/><br/>
	
	<form id="form1" action="${ctx}/server/userTenderAuth/tenderAuthTest.do" method="post" enctype="application/json">
