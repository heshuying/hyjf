...
<body>
	<h1 class="text-center col-sm-12" style="margin-bottom:30px;">画面提现</h1>
	<br/><br/><br/>
	
	<form id="form1" action="${ctx}/server/user/withdraw/withdraw.do" method="post" enctype="application/json">
		...
		<div id="result" class=" panel panel-default ">
			<table class="table">
				...
				<tbody id="resultBody">
					...
					<tr>
						<td>提现金额</td>
						<td id="retMsg"><input id="account" name="account" value=""/></td>
					</tr>
					<tr>
						<td>提现银行卡</td>
					...
					<tr>
						<td>payAllianceCode</td>
						<td id="retMsg"><input id="payAllianceCode" name="payAllianceCode" value=""/></td>
					</tr>
					<tr>
						<td>同步回调路径</td>
