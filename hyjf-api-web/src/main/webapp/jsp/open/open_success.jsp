...
<body class="response zz-outcome">
	<div class="container specialFont response">
		<div class="outcome">
			<div class="outcome-icon"><i class="icon iconfont icon-duihao success"></i></div>
			<h5>开户成功</h5>
			<p style="font-size:10px" class="color898989"></p>
		</div>
		<div class="process">
			<div class="process_line btn_bg_color"><a href="" class="colorWhite rdf-jumpMine">完成</a></div>
		</div>
	</div>
