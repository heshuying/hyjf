 ...
 */
public class HjhCreditTenderCustomize implements Serializable {
	/**
	 * serialVersionUID:
	 */
	...
	private String creditNid;//债转编号
	private String assignOrderId;//承接订单号
	private String assignOrderDate;//承接日期
	private String userId;// 借款人ID
	private String borrowUserName;// 承接用户名
	...
	private String assignServiceFee;//还款服务费
