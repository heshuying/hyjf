...
public class BorrowCustomize implements Serializable {
	...
	public Integer getBorrowEndTime() {
		return borrowEndTime;
	}

	public void setBorrowEndTime(Integer borrowEndTime) {
