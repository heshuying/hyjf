...
public class BorrowExceptionDeleteBean implements Serializable {
	/**
	 * serialVersionUID:
	 */
	...
	/**
	 * @param borrow_account_yes
	 *            the borrow_account_yes to set
	 */
	...
	/**
	 * @param borrow_account_wait
	 *            the borrow_account_wait to set
	 */
	...
	/**
	 * @param borrow_account_scale
	 *            the borrow_account_scale to set
	 */
	...
	/**
	 * @param borrow_style_name
	 *            the borrow_style_name to set
	 */
	...
	/**
	 * @param borrow_full_time
	 *            the borrow_full_time to set
	 */
	...
	/**
	 * @param recover_last_time
	 *            the recover_last_time to set
	 */
	...
	public Integer getOperater_type() {
		return operater_type;
	}

	public void setOperater_type(Integer operater_type) {
