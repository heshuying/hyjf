 ...
 * @version V1.0  
 */
public class BorrowExceptionDeleteSrchBean implements Serializable {
	...
	/** 操作类型 */
	private String operater_typeSrch;
	...
	public String getOperater_typeSrch() {
		return operater_typeSrch;
	}

	public void setOperater_typeSrch(String operater_typeSrch) {
		this.operater_typeSrch = operater_typeSrch;
	}
