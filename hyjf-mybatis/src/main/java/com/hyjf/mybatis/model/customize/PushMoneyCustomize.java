 ...
 * @param <decimal>
 */
public class PushMoneyCustomize<decimal> extends TenderCommission {

    /**
     * serialVersionUID:TODO 变量
     */

    private static final long serialVersionUID = -7155791421947452149L;
    ...
    private decimal expectApr;//预期年化收益率
	...
	public decimal getExpectApr() {
		return expectApr;
	}

	public void setExpectApr(decimal expectApr) {
