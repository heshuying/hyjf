 ...
 *           Modified by :
 */
public class SrchBalanceInfoDefine extends BaseDefine {
	
    /** @RequestMapping值 */
    public static final String REQUEST_MAPPING = "/balance";
    /** 按照用户名/手机号查询转让信息 */
    public static final String GET_CONTENT_INFO_MAPPING = "/srchBalanceInfo";
