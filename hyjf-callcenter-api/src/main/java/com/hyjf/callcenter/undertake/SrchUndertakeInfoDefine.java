 ...
 *           Modified by :
 */
public class SrchUndertakeInfoDefine extends BaseDefine {
	
    /** @RequestMapping值 */
    public static final String REQUEST_MAPPING = "/undertake";
    /** 按照用户名/手机号查询转让信息 */
    public static final String GET_CONTENT_INFO_MAPPING = "/srchUndertakeInfo";
    /** 呼叫中心接口用签验密钥(暂时) */
