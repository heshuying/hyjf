 ...
 */
@Service
public class BankRechargeExceptionServiceImpl extends BaseServiceImpl implements BankRechargeExceptionService {
	// 充值状态:失败
	...
	public List<AccountRecharge> selectBankRechargeList() {
		...
		// 当前时间
		cra.andCreateTimeGreaterThanOrEqualTo(GetDate.getNowTime10() - 24*60*60);// 一天之前
		// modify by liubin 江西银行充值掉单异常处理修正 start
		cra.andCreateTimeLessThanOrEqualTo(GetDate.getNowTime10() - 30*60);// 30分钟之前的充值订单TODO
	...
	public void updateRecharge(AccountRecharge accountRecharge) {
		...
		// 用户的电子账户
		String accountId = accountRecharge.getAccountId() == null ? bankOpenAccount.getAccount() : accountRecharge.getAccountId();
