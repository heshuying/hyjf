...
/**
 * @Description 合规数据上报 CERT 交易流水信息推送上报（延时队列）
 * @Author pcc
 * @Date 2018/11/26 17:57
 */
public class CertTransactMessageHadnle implements ChannelAwareMessageListener {

    Logger logger = LoggerFactory.getLogger(CertTransactMessageHadnle.class);
    ...
    public void onMessage(Message message, Channel channel) throws Exception {
        ...
        try {
            ...
            // 上送数据
            CertReportEntity entity = new CertReportEntity(thisMessName, CertCallConstant.CERT_INF_TYPE_TRANSACT, msgBody, data);
            try {
                // 掉单用
