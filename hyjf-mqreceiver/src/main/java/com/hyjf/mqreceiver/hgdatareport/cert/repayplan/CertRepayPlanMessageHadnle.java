 ...
 */
public class CertRepayPlanMessageHadnle implements ChannelAwareMessageListener {

    Logger logger = LoggerFactory.getLogger(CertRepayPlanMessageHadnle.class);
    ...
    public void onMessage(Message message, Channel channel) throws Exception {
        ...
        try {
            ...
            // 上送数据
            CertReportEntity entity = new CertReportEntity(thisMessName, CertCallConstant.CERT_INF_TYPE_REPAY_PLAN, borrowNid, listRepay);
            try {
                // 掉单用
