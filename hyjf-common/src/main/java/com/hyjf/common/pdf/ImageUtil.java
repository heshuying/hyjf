...
public class ImageUtil {
    ...
    public static void main(String[] args) {
        ...
        String output = "E://Applications/img";//脱敏之后存放位置
        //String source = "E://Applications/Demo_Contract_Travel_img/jujian201810188.png";    //源图片路径_居间
        String source = "E://Applications/Demo_Contract_Travel_img/zhaizhuan201810180.png";    //源图片路径_债转
        String icon = "E://Applications"+borrowCardNoImage;  //覆盖图片路径（脱敏）
        String imageName = "mark_image";  ////签章脱敏后图片名称
...
//        int size = 8;   //马赛克大小
        ...
        String result = null;
        //给图片添加图片水印
        result = ImageUtil.markImageByMoreIcon(icon,source,output,imageName,imageType,degree,333,670);
