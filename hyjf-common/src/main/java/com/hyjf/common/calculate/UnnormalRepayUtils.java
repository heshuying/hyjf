...
public class UnnormalRepayUtils {
	...
	public static void main(String[] args) {
		...
		BigDecimal termShouldPrincipal = new BigDecimal(10000);
		BigDecimal yearRate = new BigDecimal(8);
		
		System.out.println(aheadEndRepayInterest(termShouldPrincipal,yearRate,0));
		System.out.println(aheadLastRepayInterest(termShouldPrincipal,yearRate,6));
		
		System.out.println(aheadLastRepayInterest(termShouldPrincipal,yearRate,2));
		
//		System.out.println(GetDate.daysBetween(repayStartTime, recoverTime));
