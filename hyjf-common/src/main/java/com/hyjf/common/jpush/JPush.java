...
public class JPush {
    ...
    // 极光推送的appkey
    private static final String appKey = PropUtils.getSystem("hyjf.jpush.appkey");

    // 极光推送的master secret
    private static final String masterSecret = PropUtils.getSystem("hyjf.jpush.master.secret");
