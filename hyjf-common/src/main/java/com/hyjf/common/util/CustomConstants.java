...
public class CustomConstants implements MessageConstants, PropertiesConstants {
    ...
    /** 环境类别*/
    public static final String HYJF_ONLINE_TYPE = PropUtils.getSystem("hyjf.online.type");
    /** 18位社会信用代码 */
    public static String COM_SOCIAL_CREDIT_CODE = PropUtils.getSystem("hyjf.com.social.credit.code");

    /**是否允许修改手机号*/
    public static final String IS_ALLOWED_UPDATE_MOBILE = "hyjf.app.allowed.update.mobile";
    /** version=1.1.0 */
    ...
    public static final String TRADE_REPAY_NM = "加息收益";
    ...
    /** 计划订单状态由出借成功变为锁定中，发送此邮件提醒用户出借成功 */
    ...
    /** 标的投资风险测评等级 */
    public static final String INVEST_LEVEL = "INVEST_LEVEL";
    ...
    /**未获得缴费授权*/
    public static final String BANK_TENDER_RETURN_AUTH_PAYMENT_FAIL = "715";

    /**测评限额超额*/
    public static final String BANK_TENDER_RETURN_LIMIT_EXCESS = "719";
    ...
    /**测评标的用户类型不匹配（代收本金）*/
    //public static final String BANK_TENDER_RETURN_CUSTOMER_STANDARD_FAIL_PRINCIPAL = "718";
...
/*    public static final String FTP_HOST_NAME = "sftp.credit2go.cn";
    ...
    *//** 文件下载名称+日期 *//*
    ...
    // add 合规数据上报 共通 常量定义 liubin 20181122 start
    /** 合规数据上报 */
    ...
    // add 合规数据上报 共通 常量定义 liubin 20181122 end
