...
public class CommonUtils {
     ...
     * @return
     */
    public static HjhUserAuthConfig getAuthConfigFromCache(String key){
     ...
     * @return
     */
    public static Integer checkAuthStatus(Integer autoRepayStatus,Integer paymentAuthStatus){
        HjhUserAuthConfig paymenthCconfig = getAuthConfigFromCache(KEY_PAYMENT_AUTH);
        HjhUserAuthConfig repayCconfig = getAuthConfigFromCache(KEY_REPAYMENT_AUTH);
	 ...
	 * @return
	 */
	public static Integer checkRepayAuthStatus(Integer authStatus){
        HjhUserAuthConfig paymenthCconfig = getAuthConfigFromCache(KEY_REPAYMENT_AUTH);
        // 服务费授权
        if (paymenthCconfig != null && paymenthCconfig.getEnabledStatus() - 1 == 0) {
            if (authStatus == null || authStatus - 1 != 0) {
                // 借款人必须服务费授权
	 ...
	 * @return
	 */
	public static String getIsCheckUserRole(){
	    String is_check_user_roles=RedisUtils.getObj(KEY_IS_CHECK_USER_ROLES,String.class);
        return is_check_user_roles;
    }
