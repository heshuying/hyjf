...
public interface PropertiesConstants {
    ...
    /**角色认证是否打开 */
    String HYJF_ROLE_ISOPEN = "hyjf.role.isopen";
    ...
    /**区分还款邮件发送是否线上*/
    String HYJF_EMAIL_REPAY_ONLINE = "hyjf.email.repay.online";
    String HYJF_EMAIL_REPAY_TEST = "hyjf.email.repay.test";
    ...
    /** 微信公众号配置 */
    String WECHAT_APP_APPID = "hyjf.wechat.app.appId";
    String WECHAT_APP_SECRET = "hyjf.wechat.app.secret";
    
    /**#环境类型  0测试   1预生产  99正式*/
    String HYJF_ONLINE_TYPE = "hyjf.online.type";
}
