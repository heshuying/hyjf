...
//	$(".report-link-201706").attr('href',hyjfArr.hyjf+'://jumpH5/?{"url":"'+url+'/hyjf-app/jsp/aboutus/report_201706.jsp"}')
//	$(".report-link-201707").attr('href',hyjfArr.hyjf+'://jumpH5/?{"url":"'+url+'/hyjf-app/jsp/aboutus/report_201707.jsp"}')
//	$(".report-link-201708").attr('href',hyjfArr.hyjf+'://jumpH5/?{"url":"'+url+'/hyjf-app/jsp/aboutus/report_201708.jsp"}')
	var reportLength = 13;
	for (var i=1;i<reportLength;i++){
		 if(i<10){
			 $(".report-link-20170"+i).attr('href',hyjfArr.hyjf+'://jumpH5/?{"url":"'+url+'/hyjf-app/jsp/aboutus/report_20170'+i+'.jsp"}') 
		 }else{
			 $(".report-link-2017"+i).attr('href',hyjfArr.hyjf+'://jumpH5/?{"url":"'+url+'/hyjf-app/jsp/aboutus/report_2017'+i+'.jsp"}') 
		 }	
	}
	$(".report-link-201801").attr('href',hyjfArr.hyjf+'://jumpH5/?{"url":"'+url+'/hyjf-app/jsp/aboutus/report_201801.jsp"}')
