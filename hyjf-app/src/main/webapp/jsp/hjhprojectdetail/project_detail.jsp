			...
			<ul>
				...
				<c:if test="${projectDeatil.status ne 10}">
					...
					<c:if test="${projectDeatil.status ne 11}">
						<li><span class="left">开标时间：</span> <span class="right">${projectDeatil.sendTime }</span>
						</li>
<%-- 						<li><span class="left">满标时间：</span> <span class="right">${projectDeatil.fullTime }</span> --%>
<!-- 						</li> -->
					</c:if>
				</c:if>
				<li><span class="left">温馨提示：</span> <span class="right">市场有风险，投资需谨慎</span>
				</li>
				<li><span class="left">&nbsp;</span> <span class="right">历史回报不等于实际收益</span>
				</li>
				<li><span class="left">&nbsp;</span> <span class="right">建议投资者类型：稳健型及以上</span>
				</li>
			</ul>
			<div class="clearBoth"></div>
		</div>
