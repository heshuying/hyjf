...
<span class="intro">
<a href="javascript:void(0);" class="btn"><img src="${ctx}/jsp/act/hongbao/images/home_btn.png"></a>
<h4>您本时段剩余<em>3</em>次抢红包机会</h4>
</span>
</div>
<div class="rule_tit"><em>活动规则</em><a href="javascript:void(0);" class="js_wallet">我的红包</a></div>
<div class="rule_box">
<em>活动时间</em>
...
<p><a href="javascript:void(0);" class="js_back">返 回</a></p>       
</div>
</div>
<!--中奖 end-->
...
<h3>这枚红包将被释放，你确定吗？</h3>
<p><a href="javascript:void(0);" class="release_ok">确定</a><a href="javascript:void(0);" class="release_no">取消</a></p> 
</div>
</div>
<!--中奖后 end-->
...
<p><a href="javascript:void(0);" class="js_back">好 吧</a></p>  
</div>
</div>
<!--未中奖 end-->
