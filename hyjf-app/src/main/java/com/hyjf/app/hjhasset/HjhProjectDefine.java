...
public class HjhProjectDefine extends BaseDefine {

	/** 指定类型的项目 @RequestMapping值 */
	public static final String REQUEST_MAPPING = "/hjhproject";
	...
	/** 项目详情 @Path值 */
	public static final String PROJECT_DETAIL_PTAH = "hjhprojectdetail/project_detail";
	
	/** 项目详情 @Path值 */
	public static final String ERROR_PTAH = "hjhprojectdetail/hjhNonExistent";
	...
	/** 类名 */
	public static final String THIS_CLASS = HjhProjectController.class.getName();
