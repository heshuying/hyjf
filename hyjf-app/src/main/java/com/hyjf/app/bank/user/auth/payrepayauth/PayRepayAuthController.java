...
public class PayRepayAuthController {
    ...
    public ModelAndView auth(HttpServletRequest request) {
        ...
        String retUrl = PropUtils.getSystem(CustomConstants.HYJF_WEB_URL)
                ...
                + PayRepayAuthDefine.RETURL_SYN_ACTION
                + ".do?authType="+ AuthBean.AUTH_TYPE_PAY_REPAY_AUTH
                + "&sign="+ sign
                + "&platform="+ platform;
        // 异步调用路
    ...
    private ModelAndView getErrorMV(String msg, BaseMapBean baseMapBean,String sign,String platform) {
        ...
        baseMapBean.set("authType", AuthBean.AUTH_TYPE_PAY_REPAY_AUTH);
        ...
        LogUtil.endLog(PayRepayAuthDefine.THIS_CLASS, PayRepayAuthDefine.PAYREPAY_AUTH_ACTION);
        return modelAndView;
    }
    ...
    private ModelAndView getSuccessMV(String msg, BaseMapBean baseMapBean) {
        ...
        modelAndView.addObject("callBackForm", baseMapBean);
        LogUtil.endLog(PayRepayAuthDefine.THIS_CLASS, PayRepayAuthDefine.RETURL_SYN_ACTION);
        return modelAndView;
    }
}
