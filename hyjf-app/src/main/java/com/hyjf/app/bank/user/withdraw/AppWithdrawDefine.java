...
public class AppWithdrawDefine extends BaseDefine {

	public static final String HYJF_CHINAPNR_URL = "hyjf.chinapnr.url";

	/** 提现规则 路径 */
	public static final String WITHDRAW_RULE_PATH = "/withdraw/withdraw-jx-bank";
	/** 提现成功页面 路径 */
	...
	// ----------------------- @RequestMapping值 -------------------------------
	/** @RequestMapping值 */
	public static final String REQUEST_MAPPING = "/bank/user/withdraw";
	/** 获取我的银行卡 */
	...
	/** 提现成功页面 */
    public static final String WITHDRAW_SUCCESS_HTML = "/user/withdraw/result/success";
    /** 提现处理中页面 */
    public static final String WITHDRAW_HANDING_HTML = "/user/withdraw/result/handing";
    /** 提现失败页面 */
    public static final String WITHDRAW_FAIL_HTML = "/user/withdraw/result/failed";
}
