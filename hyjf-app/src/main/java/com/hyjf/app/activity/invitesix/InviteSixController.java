package com.hyjf.app.activity.invitesix;
...
@Controller
@RequestMapping(value = InviteSixDefine.REQUEST_MAPPING)
public class InviteSixController extends BaseController {
     ...
     * @return
     */
    @RequestMapping(value = InviteSixDefine.INIT_REQUEST_MAPPING)
    public ModelAndView init(HttpServletRequest request, HttpServletResponse response) {
        LogUtil.startLog(InviteSixController.class.toString(), InviteSixDefine.INIT_REQUEST_MAPPING);
        ModelAndView modelAndView = new ModelAndView(InviteSixDefine.ACTIVITY_INVITESIX_PATH);
     ...
     * @param form
     */
    @RequestMapping(value = InviteSixDefine.DOWNLOAD_ACTION, method = RequestMethod.GET)
    public void download(HttpServletRequest request, HttpServletResponse response){
            LogUtil.startLog(this.getClass().getName(), InviteSixDefine.DOWNLOAD_ACTION);
