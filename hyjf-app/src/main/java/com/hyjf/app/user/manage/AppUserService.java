...
public interface AppUserService extends BaseService {
	...
	/** 注册 */
	public int insertUserAction(String mobile, String password, String verificationCode, String loginIp, String reffer, HttpServletRequest request,Users user, Integer userType);
