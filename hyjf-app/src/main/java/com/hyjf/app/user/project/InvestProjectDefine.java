...
import com.hyjf.app.project.BorrowProjectDefine;
import com.hyjf.app.user.credit.AppTenderCreditBorrowDefine;
...
public class InvestProjectDefine extends BaseDefine {
	...
	/** 我的散标详情  */
	public static final String MY_BORROW_PAGE_URL =  CustomConstants.HOST  + AppTenderCreditBorrowDefine.REQUEST_MAPPING ;
	/** 我的债转详情  */
	public static final String MY_CREDIT_PAGE_URL =  CustomConstants.HOST  + AppTenderCreditDefine.TRANSFER_MAPPING ;
	/** 转让  */
	public static final String TO_CREDIT_PAGE_URL =  CustomConstants.HOST  + AppTenderCreditBorrowDefine.REQUEST_MAPPING + AppTenderCreditBorrowDefine.TENDER_TO_CREDIT_DETAIL;
}
