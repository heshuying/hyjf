...
package com.hyjf.bank.service.user.unbindcard;
...
@Service
public class UnBindCardServiceImpl extends BaseServiceImpl implements UnBindCardService {
							...
							if (array.size() != 0) {
								...
								for (int j = 0; j < array.size(); j++) {
									...
									if (StringUtils.isNotEmpty(obj.getString("UpdDateTime"))) {
										...
										bank.setAddtime(GetDate.strYYYYMMDDHHMMSS2Timestamp2(GetDate
												.dateToString(new Date())) + "");
										bank.setUpdateTime(GetDate.strYYYYMMDDHHMMSS2Timestamp2(GetDate
												.dateToString(new Date())) + "");
									}
								...
								}
								{
									...
									if (l != null && l.size() == 1) {
										...
										if (Validator.isNotNull(CertId)
												&& (usersInfo.getIdcard() == null || usersInfo.getIdcard().equals("0") || usersInfo
														.getIdcard().length() < 18)) {
											if (CertId.length() == 18) {
