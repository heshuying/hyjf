...
public class TradeListBankBean extends WebUserTradeListCustomize implements Serializable {
    ...
    // 是否开通汇付天下 
    public String isChinapnrOpen;
    
    // 画面状态(0:交易明细 1：充值记录 2：提现记录)
    ...
    public String getIsChinapnrOpen() {
        return isChinapnrOpen;
    }

    public void setIsChinapnrOpen(String isChinapnrOpen) {
        this.isChinapnrOpen = isChinapnrOpen;
    }
