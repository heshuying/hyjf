...
public class RepayByTermBean extends BorrowRepay implements Serializable {
	...
	private String validatorStatusDesc;
	...
	public String getValidatorStatusDesc() {
		return validatorStatusDesc;
	}

	public void setValidatorStatusDesc(String validatorStatusDesc) {
		this.validatorStatusDesc = validatorStatusDesc;
	}
