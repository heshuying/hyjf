 ...
 */
@Service
public class AemsTradeListServiceImpl extends BaseServiceImpl implements AemsTradeListService {
	/**
	 ...
	 */
	@Override
	public List<AccountDetailCustomize> searchTradeList(AemsTradeListBean trade) {
