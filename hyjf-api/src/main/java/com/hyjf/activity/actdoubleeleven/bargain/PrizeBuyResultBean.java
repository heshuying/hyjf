...
public class PrizeBuyResultBean extends BaseResultBean {
	...
	public String toString() {
		return super.toString() + "PrizeBuyResultBean [idBargain=" + idBargain + ", prizeId=" + prizeId + ", prizeName=" + prizeName
