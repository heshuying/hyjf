package com.hyjf.wrb.invest.response;
...
public class WrbInvestRecordResponse extends WrbResponse {
    ...
    /** 出借记录 */
    private List<WrbInvestRecordCustomize> invest_records = new ArrayList<>();
    ...
    public List<WrbInvestRecordCustomize> getInvest_records() {
        return invest_records;
    }

    public void setInvest_records(List<WrbInvestRecordCustomize> invest_records) {
