...
public class BaseDefine {
    ...
    // Aems服务接口设置交易密码
    public static final String METHOD_AEMS_SET_PASSWORD = "/aems/transpassword/setPassword";
    // 第三方服务接口修改交易密码
    ...
    //Aems用户测评结果记录
    public static final String METHOD_AEMS_EVALUATION_RESULTS = "/aems/evaluation/saveUserEvaluationResults";
    // 第三方服务接口 缴费授权
    public static final String METHOD_PAYMENT_AUTH_PAGE = "/server/user/paymentAuthPage/page";
    // 第三方服务接口 缴费授权（合规）
    public static final String METHOD_PAYMENT_AUTH_PAGE_PLUS = "/server/user/paymentAuthPagePlus/page";
    // 第三方服务接口多合一授权合规（合规）
    ...
    // 还款授权(合规)
    public static final String METHOD_REPAY_AUTH_PLUS = "/server/repayAuth/repayAuthPlus";

    //查询用户信息
    public static final String METHOD_SERVER_SYNCUSERINFO = "/server/user/syncUserInfo";

    //查询用户信息
    public static final String METHOD_AEMS_SYNCUSERINFO = "/aems/syncUserInfo";
    
    // 绑卡
    public static final String METHOD_SERVER_BIND_CARD_PAGE = "/server/user/bindcardpage/bind";

    // Aems绑卡
    public static final String METHOD_AEMS_BIND_CARD_PAGE = "/aems/bindcardpage/bind";
}
