...
$.extend(Page, {
	...
	doLayout: function() {
		...
		// 日历范围限制
		$('#timesStartSrch').on("show", function(evnet, d) {
			d = $('#timesEndSrch').datepicker("getDate"),
			d && $('#timesStartSrch').datepicker("settimesEndSrch", d)
		}),
		$('#timesEndSrch').on("show", function(evnet, d) {
			d = $('#timesStartSrch').datepicker("getDate"),
			d && $('#timesEndSrch').datepicker("settimesStartSrch", d)
		});
	},
	// 初始化画面事件处理
	initEvents : function() {
