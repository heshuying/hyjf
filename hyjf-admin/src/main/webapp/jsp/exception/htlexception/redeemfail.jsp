...
<shiro:hasPermission name="productredeem:VIEW">
	<tiles:insertTemplate template="/jsp/layout/listLayout.jsp" flush="true">
					...
					<div class="col-md-12">
						<div class="search-classic">
													...
													<td class="center">
														<div class="visible-md visible-lg hidden-sm hidden-xs">
															<a class="btn btn-transparent btn-xs fn-Modify" 
																	data-toggle="tooltip" tooltip-placement="top" href= "${webRoot}/htl/fail/redeemDetail?listId=${record.orderId }" data-original-title="明细"><i class="fa fa-list"></i></a>
															
															<shiro:hasPermission name="producterror:CHULI">
																<a class="btn btn-transparent btn-xs fn-Handle" data-id="${record.id }" 
																		data-toggle="tooltip" tooltip-placement="top" data-original-title="处理"><i class="fa fa-gavel"></i></a>
															</shiro:hasPermission>
														</div>
														<div class="visible-xs visible-sm hidden-md hidden-lg">
															<div class="btn-group" dropdown="">
																...
																<ul class="dropdown-menu pull-right dropdown-light" role="menu">
																	<li>
																		<a href= "${webRoot}/htl/fail/redeemDetail?listId=${record.orderId }" class="fn-Modify" >明细</a>
																		<shiro:hasPermission name="producterror:CHULI">
																			<a class="fn-Handle" data-id="${record.id }" >处理</a>
																		</shiro:hasPermission>
																	</li>
																</ul>
															</div>
							...
							<shiro:hasPermission name="producterror:VIEW">
								<hyjf:paginator id="equiPaginator" hidden="paginator-page" action="redeem" paginator="${productredeemcustomizeForm.paginator}"></hyjf:paginator>
							</shiro:hasPermission>
							<br/><br/>
						</div>
					</div>
		...
		<tiles:putAttribute name="pageJavaScript" type="string">
			<script type='text/javascript' src="${webRoot}/jsp/exception/htlexception/redeemfail.js"></script>
		</tiles:putAttribute>
