...
<shiro:hasPermission name="debtexceptionlog:VIEW">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="search-classic">
							<shiro:hasPermission name="debtexceptionlog:SEARCH">
								<%-- 功能栏 --%>
								<div class="well">
										...
										<th class="center">
											<c:choose>
												<c:when test="${ !empty borrowexceptiondeleteForm.sort and borrowexceptiondeleteForm.col eq 'hbdl.operater_time' }">
													<a href="#" class="fn-Sort" data-col="hbdl.operater_time" data-sort="<c:if test="${ borrowexceptiondeleteForm.sort eq 'asc' }">desc</c:if><c:if test="${ borrowexceptiondeleteForm.sort eq 'desc' }">asc</c:if>">删除时间</a>&nbsp;<i class="fa fa-sort-${borrowexceptiondeleteForm.sort}"></i>
												</c:when>
												<c:otherwise>
													<a href="#" class="fn-Sort" data-col="hbdl.operater_time" data-sort="desc">删除时间</a>&nbsp;<i class="fa fa-sort"></i>
												</c:otherwise>
											</c:choose>
										</th>
									</tr>
