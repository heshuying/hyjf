...
<c:set var="searchAction" value="#" scope="request"></c:set>
	...
	<tiles:insertTemplate template="/jsp/layout/listLayout.jsp" flush="true">
		<%-- 画面的标题 --%>
		<tiles:putAttribute name="pageTitle" value="银行卡修改" />

		<%-- 画面主面板标题块 --%>
		<tiles:putAttribute name="pageFunCaption" type="string">
			<h1 class="mainTitle">银行卡修改</h1>
			<span class="mainDescription">银行卡修改。</span>
		</tiles:putAttribute>
			...
			<div class="container-fluid container-fullw bg-white">
				<div class="tabbable">
					...
					<ul class="nav nav-tabs" id="myTab">
							<li><a href="${webRoot}/exception/accountmobilesynch/mobilelist">手机号修改</a> </li>
						<li  class="active"><a href="javascript:void(0);">银行卡修改</a></li>
					</ul>
									...
									<div class="search-classic">
										...
										<table id="equiList" class="table table-striped table-bordered table-hover">
											...
											<tr>
												...
												<th class="center">原银行卡号</th>
												<th class="center">新银行卡号</th>
												...
												<c:otherwise>
													<c:forEach items="${mobilesynchronizeForm.recordList }" var="record" begin="0" step="1" varStatus="status">
														<tr>
															...
															<td><c:out value="${record.newAccount }"></c:out></td>
											...
											<%-- 分页栏 --%>
										<hyjf:paginator id="equiPaginator" hidden="paginator-page" action="searchAccountAction"
														paginator="${mobilesynchronizeForm.paginator}"></hyjf:paginator>										<br/><br/>
									</div>
								</div>
							</div>
						</div>
		...
		<tiles:putAttribute name="searchPanels" type="string">
			...
			<div class="form-group">
				<label>新银行卡号:</label>
				<input type="text" name="newAccount" id="newAccount" class="form-control input-sm underline" value="${mobilesynchronizeForm.newAccount}" />
			</div>
			<div class="form-group">
				<label>状态</label>
		...
		<tiles:putAttribute name="pageJavaScript" type="string">
			<script type='text/javascript' src="${webRoot}/jsp/exception/accountMobileException/accountList.js"></script>
		</tiles:putAttribute>
