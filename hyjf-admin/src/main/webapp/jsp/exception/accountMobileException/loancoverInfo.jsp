			...
			<div class="panel-body" style="margin: 0 auto">
				<div class="panel-scroll height-430">
					<form id="mainForm"
						...
						<input type="hidden" name="flag" id="flag" value= "${mobilesynchronizeForm.flag}"/>

						<div class="form-group">
							<label  class="col-xs-3 control-label padding-top-5" for="name">
								<span class="symbol required"></span><font id="name">用户名</font>
							</label>
							<div class="col-xs-9">
								<input type="text" placeholder="请输入用户名" id="username"
									name="username" value="${mobilesynchronizeForm.username }" maxlength="50" class="form-control" datatype="*1-50"
									errormsg="请输入用户名！">
...
.purMargin input {
	...
	<tiles:putAttribute name="pageJavaScript" type="string">
		...
		<script type='text/javascript'
			src="${webRoot}/jsp/exception/accountMobileException/loancoverInfo.js"></script>
		<script type="text/javascript"
