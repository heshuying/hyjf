...
<shiro:hasPermission name="singletradeinfo:VIEW">
	<tiles:insertTemplate template="/jsp/layout/mainLayout.jsp" flush="true">
		...
		<tiles:putAttribute name="pageFunCaption" type="string">
			<h1 class="mainTitle">单笔交易查询</h1>
			<span class="mainDescription">单笔交易查询</span>
		</tiles:putAttribute>
				...
				<div class="panel-scroll height-430">
					<form id="mainForm" action="searchAction" method="post"  role="form" class="form-horizontal">
						...
						<div class="form-group">
							<label class="col-sm-2 control-label"> <span class="symbol required"></span>电子账号：</label>
							<div class="col-sm-4">
							<input type="text" name="accountId" id="accountId" class="form-control input-sm" value="${singletradeinfoForm.accountId}" datatype="n" nullmsg="未填写电子账号" />
						...
						<div class="form-group">
							<label class="col-sm-2 control-label"> <span class="symbol required"></span>交易流水号：</label>
							<div class="col-sm-4">
							<input type="text" name="orgSeqNo" id="orgSeqNo" class="form-control input-sm" value="${singletradeinfoForm.orgSeqNo}" datatype="n" nullmsg="未填写交易流水号"/>
							</div>
						</div>
						<!-- 检索结果 -->
						<div class="form-group">
							<label class="col-sm-2 control-label"> <span class="symbol required"></span>结果：</label>
							<div class="col-sm-4" id="result" data-res=${singletradeinfoForm.result}>
							</div>
						</div>
						
						<div class="col-xs-offset-2 col-xs-10">
							<shiro:hasPermission name="singletradeinfo:SEARCH">
		...
		<tiles:putAttribute name="pageJavaScript" type="string">
			...
			<script type='text/javascript' src="${webRoot}/jsp/exception/singletradeinfo/singletradeinfo.js"></script>
		</tiles:putAttribute>
