...
<shiro:hasPermission name="lockUserPermission:VIEW">
	<tiles:insertTemplate template="/jsp/layout/listLayout.jsp" flush="true">
		<%-- 画面的标题 --%>
		<tiles:putAttribute name="pageTitle" value="前台登录失败配置" />
		
		<%-- 画面主面板标题块 --%>
		<tiles:putAttribute name="pageFunCaption" type="string">
			<h1 class="mainTitle">前台登录失败配置</h1>
			<span class="mainDescription">前台登录失败配置。</span>
		</tiles:putAttribute>
			...
			<div class="container-fluid container-fullw bg-white">
				<div class="tabbable">
					<ul class="nav nav-tabs" id="myTab"> 
						<shiro:hasPermission name="lockUserPermission:VIEW">
				      		<li  class="active"><a href="${webRoot}/loginerrorlockuser/frontinit">前台登录失败配置</a></li>
				      	</shiro:hasPermission>
				      	<shiro:hasPermission name="lockUserPermission:VIEW">
				      		<li><a href="${webRoot}/loginerrorlockuser/backinit">后台登录失败配置</a></li>
				      	</shiro:hasPermission>
				    </ul>
							...
							<div class="row">
								<div class="col-md-12">
									<div class="search-classic">
										...
										<%-- 分页栏 --%>
										<hyjf:paginator id="equiPaginator" hidden="paginator-page" action="frontinit" paginator="${lockUserForm.paginator}"></hyjf:paginator>
										<br/><br/>
									</div>
								</div>
							</div>
		...
		<tiles:putAttribute name="pageJavaScript" type="string">
			<script type='text/javascript' src="${webRoot}/jsp/loginerror/frontlockuserlist.js"></script>
		</tiles:putAttribute>
