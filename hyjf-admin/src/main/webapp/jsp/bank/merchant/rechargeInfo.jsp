...
<tiles:insertTemplate template="/jsp/layout/dialogLayout.jsp"
	flush="true">
	<%-- 画面的标题 --%>
	<tiles:putAttribute name="pageTitle" value="红包/手续费账户充值" />
	<%-- 画面的CSS (ignore) --%>
		...
		<div class="panel panel-white" style="margin: 0">
			<div class="panel-body" style="margin: 0 auto">
				<div class="panel-scroll">
					<form id="mainForm" action="toRecharge" method="post" role="form"  target="_parent"
						...
						<div id="chargeTimeDiv" class="form-group">
							<label class="col-xs-3 control-label  padding-top-5" for="amount">
								<span class="symbol required"></span>圈存金额：
							</label>
							<div class="col-xs-9">
	...
	<tiles:putAttribute name="pageJavaScript" type="string">
		...
		<script type='text/javascript'
			src="${webRoot}/jsp/bank/merchant/rechargeInfo.js"></script>
	</tiles:putAttribute>
