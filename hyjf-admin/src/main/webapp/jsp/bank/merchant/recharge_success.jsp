...
<%-- 画面功能路径 (ignore) --%>
	...
	<tiles:insertTemplate template="/jsp/layout/listLayout.jsp" flush="true">
		...
		<tiles:putAttribute name="pageFunCaption" type="string">
			...
			<span class="mainDescription">圈存成功</span>
		</tiles:putAttribute>
		...
		<div class="panel panel-white" style="margin: 0">
					<div class="panel-body" style="margin: 0 auto">
						...
						<div class="panel-scroll height-430" style="text-align: center;">
							<div class="col-sm-10" style="font-size: 30px;"> 圈存成功 </div>
							<br><br><br>
								<div class="col-sm-10" style="/*! float: left; */">
									<a class="btn btn-o btn-primary"  href="${webRoot}/bank/merchant/account/init.do" ><i class="fa fa-check"></i>确认</a>
								</div>
						</div>
					</div>
				</div>
