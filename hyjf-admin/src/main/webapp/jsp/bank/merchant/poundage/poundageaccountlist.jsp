...
<shiro:hasPermission name="bankpoundageaccount:VIEW">
	<tiles:insertTemplate template="/jsp/layout/listLayout.jsp" flush="true">
		<%-- 画面的标题 --%>
		<tiles:putAttribute name="pageTitle" value="手续费账户明细" />

		<%-- 画面主面板标题块 --%>
		<tiles:putAttribute name="pageFunCaption" type="string">
			<h1 class="mainTitle">手续费账户明细</h1>
			<span class="mainDescription">手续费账户明细</span>
		</tiles:putAttribute>
				...
				<ul class="nav nav-tabs" id="myTab"> 
					<shiro:hasPermission name="bankpoundageaccount:VIEW">
			      	...
			      	<shiro:hasPermission name="web:VIEW">
			      		<li  class="active"><a href="${webRoot}/bank/merchant/poundage/init">手续费账户明细</a></li>
			      	</shiro:hasPermission>
			    </ul>
				<div class="tab-content">
					<div class="tab-pane fade in active">
							<shiro:hasPermission name="bankpoundageaccount:SEARCH">
								<%-- 功能栏 --%>
								<div class="well">
									...
									<%-- <shiro:hasPermission name="bankpoundageaccount:EXPORT">
