...
<shiro:hasPermission name="DATACENTERCOUPON:VIEW">
	<tiles:insertTemplate template="/jsp/layout/listLayout.jsp" flush="true">
		<%-- 画面的标题 --%>
		<tiles:putAttribute name="pageTitle" value="优惠券-加息券" />

		<%-- 画面主面板的标题块 --%>
		<tiles:putAttribute name="pageFunCaption" type="string">
			<h1 class="mainTitle">优惠券-加息券</h1>
		...
		<div class="container-fluid container-fullw bg-white">
			...
			<ul class="nav nav-tabs" id="myTab"> 
				<%-- <shiro:hasPermission name="DATACENTERCOUPON:VIEW">
		      		<li><a href="${webRoot}/datacenter/couponTY/init">体验金</a></li>
		      	</shiro:hasPermission> --%>
		      	<shiro:hasPermission name="DATACENTERCOUPON:VIEW">
		      		<li  class="active"><a href="${webRoot}/datacenter/couponJX/init">加息券</a></li>
		      	</shiro:hasPermission>
		      	<shiro:hasPermission name="DATACENTERCOUPON:VIEW">
		      		<li><a href="${webRoot}/datacenter/couponDJ/init">代金券</a></li>
		      	</shiro:hasPermission>
		    </ul>
					...
					<table id="equiList" class="table table-striped table-bordered table-hover">
						...
						<thead>
							<tr>
								...
								<th class="center">已发放收益</th>
								<th class="center">待发放收益</th>
		...
		<tiles:putAttribute name="pageJavaScript" type="string">
			<script type='text/javascript' src="${webRoot}/jsp/datacenter/coupon/couponjx.js"></script>
		</tiles:putAttribute>
