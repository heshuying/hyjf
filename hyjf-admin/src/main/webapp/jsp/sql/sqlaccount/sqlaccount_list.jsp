...
<%-- 画面功能路径 (ignore) --%>
<c:set value="${fn:split('汇盈金服,数据,沉淀资金', ',')}" var="functionPaths" scope="request"></c:set>

<%-- <shiro:hasPermission name="employeeinfo:VIEW">		--%>
	<tiles:insertTemplate template="/jsp/layout/listLayout.jsp" flush="true">
		<%-- 画面的标题 --%>
		<tiles:putAttribute name="pageTitle" value="沉淀详情" />
		<%-- 画面的CSS (ignore) --%>
		...
		<tiles:putAttribute name="pageFunCaption" type="string">
			<h1 class="mainTitle">沉淀详情</h1>
			<span class="mainDescription">沉淀详情信息。</span>
		</tiles:putAttribute>
		<%-- 画面主面板 --%>
		...
		<tiles:putAttribute name="pageJavaScript" type="string">
			...
			<script type='text/javascript' src="${webRoot}/jsp/sql/sqlaccount/sqlaccount_list.js"></script>
