...
<shiro:hasPermission name="appchannelrecon:VIEW">
	<tiles:insertTemplate template="/jsp/layout/listLayout.jsp" flush="true">
			...
			<div class="container-fluid container-fullw bg-white">
				<div class="tabbable">
					...
					<ul class="nav nav-tabs" id="myTab">
						<shiro:hasPermission name="appchannelrecon:VIEW">
							<li class="active"><a href="${webRoot}/promotion/app/channelreconciliation/hjhInit">智投服务</a></li>
						</shiro:hasPermission>
						<shiro:hasPermission name="appchannelrecon:VIEW">
							<li><a href="${webRoot}/promotion/app/channelreconciliation/init">散标</a></li>
						</shiro:hasPermission>
					</ul>
								...
								<div class="col-md-12">
									<div class="search-classic">
										...
										<table id="equiList" class="table table-striped table-bordered table-hover">
													...
													<c:forEach items="${recordList }" var="record" begin="0" step="1" varStatus="status">
														<tr>
															...
															<td align="center">
																...
																<c:if test="${record.isFirst ==null }">否</c:if>
															</td>
											...
											<%-- 分页栏 --%>
										<shiro:hasPermission name="appchannelrecon:SEARCH">
											<hyjf:paginator id="equiPaginator" hidden="paginator-page" action="searchHjhAction" paginator="${channelreconciliationHjhForm.paginator}"></hyjf:paginator>
										</shiro:hasPermission>
										<br/><br/>
									</div>
								</div>
		...
		<tiles:putAttribute name="pageJavaScript" type="string">
			<script type='text/javascript' src="${webRoot}/jsp/promotion/app/reconciliation/channelreconciliationhjh.js"></script>
		</tiles:putAttribute>
