...
<shiro:hasPermission name="channelcount:VIEW">
	<tiles:insertTemplate template="/jsp/layout/listLayout.jsp" flush="true">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="search-classic">
							<shiro:hasPermission name="channelcount:SEARCH">
								<%-- 功能栏 --%>
								<div class="well">
									...
									<shiro:hasPermission name="channelcount:EXPORT">
									...
									<c:choose>
										...
										<c:otherwise>
											<c:forEach items="${recordList }" var="record" begin="0" step="1" varStatus="status">
												<tr>
													<td class="center">${(channelcountForm.paginatorPage - 1 ) * channelcountForm.paginator.limit + status.index + 1 }</td>
													...
													<td align="right"><c:out value="${record.rechargePrice }"></c:out></td>
													<td align="right"><c:out value="${record.tenderPrice }"></c:out></td>
							...
							<%-- 分页栏 --%>
							<shiro:hasPermission name="channelcount:SEARCH">
								<hyjf:paginator id="equiPaginator" hidden="paginator-page" action="init" paginator="${channelcountForm.paginator}"></hyjf:paginator>
							</shiro:hasPermission>
							<br/><br/>
						</div>
					</div>
		...
		<tiles:putAttribute name="searchPanels" type="string">
			<shiro:hasPermission name="channelcount:SEARCH">
				<input type="hidden" name="utmIds" id="utmIds" value="${channelcountForm.utmIds}" />
				<input type="hidden" name="paginatorPage" id="paginator-page" value="${channelcountForm.paginatorPage}" />
				<div class="form-group">
					<label>时间</label>
					<div class="input-group input-daterange datepicker">
						<span class="input-icon">
							<input type="text" name="timeStartSrch" id="start-date-time" class="form-control underline" value="${channelcountForm.timeStartSrch}" />
							<i class="ti-calendar"></i> </span>
						<span class="input-group-addon no-border bg-light-orange">~</span>
						<input type="text" name="timeEndSrch" id="end-date-time" class="form-control underline" value="${channelcountForm.timeEndSrch}" />
					</div>
				</div>
			</shiro:hasPermission>
		</tiles:putAttribute>			
		...
		<tiles:putAttribute name="pageJavaScript" type="string">
			<script type='text/javascript' src="${webRoot}/jsp/promotion/channelcount/channelcount.js"></script>
		</tiles:putAttribute>
