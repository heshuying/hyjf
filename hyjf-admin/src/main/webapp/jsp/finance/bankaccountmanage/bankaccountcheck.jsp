...
<tiles:insertTemplate template="/jsp/layout/dialogLayout.jsp" flush="true">
	...
	<tiles:putAttribute name="mainContentinner" type="string">
		...
		<div class="panel panel-white" style="margin:0">
			<div class="panel-body">
				...
				<form id="mainForm" action="startAccountCheckAction"
						method="post"  role="form" class="form-horizontal" >
					<input type="hidden" id="userId" name="userId" value="${accountmanageForm.userId}" />	
					...
					<div class="form-group">
							...
							<div class="col-xs-3">	
								<div class="input-group">																														
									...
									class="form-control input-sm datepicker" value="${accountmanageForm.startTime}"
									maxlength="50">																													
							...
							<div class="col-xs-3">
								<div class="input-group">
									...
									class="form-control input-sm datepicker" value="${accountmanageForm.endTime}"
									 maxlength="50">																													
									<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
								</div>
	...
	<tiles:putAttribute name="pageJavaScript" type="string">
		...
		<script type='text/javascript'
			src="${webRoot}/jsp/finance/bankaccountmanage/bankaccountcheck.js"></script>
		<script type="text/javascript">
		//日历选择器																						
