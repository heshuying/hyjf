...
<shiro:hasPermission name="refeestatistic:VIEW">
	<tiles:insertTemplate template="/jsp/layout/listLayout.jsp" flush="true">
										...
										<div class="col-xs-12 col-md-12">
											<div class="panel panel-white" >
												<div class="panel-heading border-light">
													<h4 class="panel-title text-primary"><i class="ti-arrow-circle-right"></i> 加息券还款统计</h4>
													<ul class="panel-heading-tabs border-light">
													
													<li class="panel-tools">
														更新时间：${latestUpdateTime }
														</li>
														<li class="panel-tools">
															<a class="btn btn-success fn-listView" href="${webRoot}/finance/couponrepaymonitor/init" data-original-title="查看明细" data-toggle="tooltip" data-placement="top"><i class="fa fa-list"></i></a>
														</li>
													</ul>
												</div>
		...
		<tiles:putAttribute name="pageJavaScript" type="string">
			<script type='text/javascript' src="${webRoot}/jsp/finance/couponrepay/repaymonitorchart.js"></script>
		</tiles:putAttribute>
