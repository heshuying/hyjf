...
Action = {
	// 导出execlAction
	exportExcelAction : "exportAccountDetailsExcel",
	// 查询的Action
	searchAction : "searhAction",
	// 详细画面的Action
	...
	// 20170120还款后,交易明细修改Action
	accountdetailDataRepairAction : "accountdetailDataRepair",
...
Events = {
	...
	accountdetailDataRepairClkAct : function(){
		Page.confirm("", "本操作是修复20170120还款后交易明细异常的数据,确定要执行本次操作吗？", function(isConfirm) {
			isConfirm && Page.submit(Action.accountdetailDataRepairAction);
		})
	},
};
...
$.extend(Page, {
	...
	initEvents : function() {
		...
		// 20170120还款后交易明细修改
		$(".fn-Repay-Data-Repair").click(Events.accountdetailDataRepairClkAct);
	}
});
