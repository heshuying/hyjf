...
<shiro:hasPermission name="pushMoneyDetail:VIEW">
				...
				<div class="col-md-12">
					<div class="search-classic">
						...
						<div class="well">
							...
							<shiro:hasPermission name="pushMoneyDetail:EXPORT">
									...
									<c:otherwise>
										<c:forEach items="${pushMoneyForm.recordList }" var="record" begin="0" step="1" varStatus="status">
											<tr>
												...
												<td><c:out value="${record.referername }"></c:out></td>
<%-- 												<td class="center">
													<c:choose>
												...
												<td class="center"><c:out value="${record.touziTime }"></c:out></td>
												<td class="center">
													<shiro:hasPermission name="pushMoneyDetail:CONFIRM">
						...
						<%-- 分页栏 --%>
						<hyjf:paginator id="equiPaginator" hidden="paginator-page" action="searchDetailAction" paginator="${pushMoneyForm.paginator}"></hyjf:paginator>
						<br />
						<br />
					</div>
				</div>
	...
	<tiles:putAttribute name="pageJavaScript" type="string">
		...
		<script type='text/javascript' src="${webRoot}/jsp/finance/pushMoney/pushMoney_detail.js"></script>
	</tiles:putAttribute>
