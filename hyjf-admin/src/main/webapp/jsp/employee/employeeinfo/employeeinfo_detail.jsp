...
<%-- 画面功能路径 (ignore) --%>
<c:set value="${fn:split('汇盈金服,员工信息,员工列表', ',')}" var="functionPaths" scope="request"></c:set>

<%-- <shiro:hasPermission name="accountdetail:VIEW"> --%>
	<tiles:insertTemplate template="/jsp/layout/mainLayout.jsp" flush="true">
		<%-- 画面的标题 --%>
		<tiles:putAttribute name="pageTitle" value="员工信息" />
		<%-- 画面的CSS (ignore) --%>
			...
			<div class="container-fluid container-fullw bg-white">
					...
					<div class="col-md-12">
						<div class="search-classic">
							...
							<table id="equiList" class="table table-striped table-hover">
								...
								<c:forEach items="${employeedetail}" var="list">
				<tr>
					<td> 入职部门 </td>
					<td> ${list.firstdepart}
						 ${list.seconddepart}
				...
				<tr>
					...
					<td> ${list.hyd_id} </td>
							...
							<h1> 
								<a href="employeeinfo_list"> 返回列表 </a>
							</h1>
							<br/><br/>
						</div>
					</div>
		...
		<tiles:putAttribute name="pageJavaScript" type="string">
			...
			<script type='text/javascript' src="${webRoot}/jsp/employee/employeeinfo/employeeinfo_detail.js"></script>
		</tiles:putAttribute>
