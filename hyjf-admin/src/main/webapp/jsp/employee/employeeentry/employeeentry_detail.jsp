...
<%-- <shiro:hasPermission name="accountdetail:VIEW"> --%>
	<tiles:insertTemplate template="/jsp/layout/mainLayout.jsp" flush="true">
		...
		<tiles:putAttribute name="mainContentinner" type="string">
			...
			<c:forEach items="${employeeentry}" var="list">
				<tr>
					<td> 入职部门 </td>
					<td> ${list.firstdepart}
						 ${list.seconddepart}
				...
				<tr>
					...
					<td> ${list.hyd_id} </td>
							...
							<h1> 
								<a href="employeeentry_list"> 返回列表 </a>
							</h1>
							<br/><br/>
						</div>
					</div>
		...
		<tiles:putAttribute name="pageJavaScript" type="string">
			...
			<script type='text/javascript' src="${webRoot}/jsp/employee/employeeentry/employeeentry_detail.js"></script>
		</tiles:putAttribute>
