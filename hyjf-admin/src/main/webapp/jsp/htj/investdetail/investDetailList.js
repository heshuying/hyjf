...
$.extend(Page, {
	...
	doLayout: function() {
		...
		// 日历范围限制
		$('#investTimeStart').on("change", function(evnet, d) {
			d = $('#investTimeEnd').datepicker("getDate"),
			d && $('#investTimeStart').datepicker("setEndDate", d)
		}),
		$('#investTimeEnd').on("change", function(evnet, d) {
			d = $('#investTimeStart').datepicker("getDate"),
			d && $('#investTimeEnd').datepicker("setStartDate", d)
		});
	},
	// 初始化画面事件处理
	initEvents : function() {
