...
<shiro:hasPermission name="borrow:VIEW">
	<tiles:insertTemplate template="/jsp/layout/listLayout.jsp" flush="true">
						...
						<div class="tab-pane fade in active" id="tab_jbxx_1">
							...
							<div class="col-md-12">
								<div class="search-classic">
									...
									<table id="equiList" class="table table-striped table-bordered table-hover">
											...
											<c:otherwise>
												<c:forEach items="${recordList }" var="record" begin="0" step="1" varStatus="status">
													<tr>
														...
														<td align="right"><c:out value="${record.borrowAccountWait}"></c:out></td>
										...
										<%-- 分页栏 --%>
									<shiro:hasPermission name="borrow:SEARCH">
										<hyjf:paginator id="equiPaginator" hidden="paginator-page" action="optAction" paginator="${borrowForm.paginator}"></hyjf:paginator>
									</shiro:hasPermission>
									<br/><br/>
								</div>
							</div>
							</div>
							<input type="hidden" id="planNidTemp" name ="planNidTemp" value="${borrowForm.planNidTemp}">
								<%-- 原始标的检索面板 (ignore) --%>
							<tiles:putAttribute name="searchPanels" type="string">
								<shiro:hasPermission name="borrow:SEARCH">
									...
									<input type="hidden" name="assignPlanNid" id="assignPlanNid" value="${borrowForm.planNidSrch}">
									<input type="hidden" name="planNidNew" id="planNidNew" value="${borrowForm.planNidSrch}"/>
									<input type="hidden" id="myPlanNid" name="planNidTemp" value="${borrowForm.planNidTemp}" readonly>
									<!-- 检索条件 -->
									...
									<%--隐藏域方便向后台进行传值--%>
									<input type="hidden" name="planNid" id="planNid" value="${borrowForm.planNidSrch}">
									<%-- DEL BY LIUSHOUYI 合规检查 START
                                    <div class="form-group">
                                        <label>项目名称</label>
		...
		<tiles:putAttribute name="pageJavaScript" type="string">
			<script type='text/javascript' src="${webRoot}/jsp/manager/hjhplan/optrecordloan.js"></script>
		</tiles:putAttribute>
