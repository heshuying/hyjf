...
<shiro:hasPermission name="planrepay:VIEW">
	<tiles:insertTemplate template="/jsp/layout/listLayout.jsp" flush="true">
			...
			<!-- 新增tab区分 -->
				<ul class="nav nav-tabs" id="myTab">
					...
					<shiro:hasPermission name="planrepay:VIEW">
			    	 ...
			    	 <!-- 还款-承接明细  -->	
					<shiro:hasPermission name="planrepay:VIEW">
						<li class="active"><a href="${webRoot}/manager/hjhplan/planrepay/creditRepayAction?accedeOrderIdSrch=${orderId}">还款-承接明细</a></li>
					</shiro:hasPermission>	
				</ul>
								...
								<c:otherwise>
									<c:forEach items="${recordList }" var="record" begin="0" step="1" varStatus="status">
										<tr>
											...
											<td class="center"><c:out value="第 ${record.countPeriod } 期"></c:out></td>
		...
		<tiles:putAttribute name="pageJavaScript" type="string">
			<script type='text/javascript' src="${webRoot}/jsp/manager/planrepay/repaycreditdetailList.js"></script>
		</tiles:putAttribute>
