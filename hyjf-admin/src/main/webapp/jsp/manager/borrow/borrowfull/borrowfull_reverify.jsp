							...
							<div class="panel panel-white">
								<div class="panel-body">
									<form id="mainForm" method="post" role="form" class="form-horizontal">
										...
										<input type="hidden" name=borrowNid id="borrowNid" value="${borrowFullForm.borrowNid}" /> 
										...
										<input type="hidden" name="borrowNidSrch"
											value="${borrowFullForm.borrowNidSrch}" />
										<!-- 项目名称 -->
										<input type="hidden" name="borrowNameSrch"
											value="${borrowFullForm.borrowNameSrch}" />
										<!-- 借  款 人 -->
										<input type="hidden" name="usernameSrch"
											value="${borrowFullForm.usernameSrch}" />
										<!-- 满标时间 -->
										<input type="hidden" name="timeStartSrch" value="${borrowFullForm.timeStartSrch}" /> 
										<input type="hidden" name="timeEndSrch" value="${borrowFullForm.timeEndSrch}" />
										<input type="hidden" id="errMessage" value="${errMsg}"/>
	...
	height: 30px;
		...
		<tiles:putAttribute name="pageJavaScript" type="string">
			<script type='text/javascript'
				src="${webRoot}/jsp/manager/borrow/borrowfull/borrowfull_reverify.js"></script>
		</tiles:putAttribute>
