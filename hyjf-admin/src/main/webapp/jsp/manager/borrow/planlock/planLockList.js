...
Events = {
	...
	resetFromClkAct: function() {
		...
		$("#fullExpireTimeEnd").val("");
		$("#liquidateShouldTimeEnd").val("");
	},
...
$.extend(Page, {
	...
	doLayout: function() {
		...
		// 日历范围限制
		$('#fullExpireTime').on("change", function(evnet, d) {
			d = $('#fullExpireTimeEnd').datepicker("getDate"),
			d && $('#fullExpireTime').datepicker("setEndDate", d)
		}),
		$('#fullExpireTimeEnd').on("change", function(evnet, d) {
			d = $('#fullExpireTime').datepicker("getDate"),
			d && $('#fullExpireTimeEnd').datepicker("setStartDate", d)
		}),
		// 日历范围限制
		$('#liquidateShouldTime').on("change", function(evnet, d) {
			d = $('#liquidateShouldTimeEnd').datepicker("getDate"),
			d && $('#liquidateShouldTime').datepicker("setEndDate", d)
		}),
		$('#liquidateShouldTimeEnd').on("change", function(evnet, d) {
			d = $('#liquidateShouldTime').datepicker("getDate"),
			d && $('#liquidateShouldTimeEnd').datepicker("setStartDate", d)
		});
	},
	// 初始化画面事件处理
	initEvents : function() {
