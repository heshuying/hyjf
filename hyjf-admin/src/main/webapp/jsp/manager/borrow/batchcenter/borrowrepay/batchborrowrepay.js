...
Events = {
	...
	//查询批次交易明细
	queryBatchDetailClkAct : function(event) {
		var batchNo = $(this).context.dataset.borrownid;
		var status = $(this).context.dataset.status;
		$("#deatilBatchNo").val(batchNo);
...
$.extend(Page, {
	...
	initEvents : function() {
		...
		//查询批次交易明细
		$(".queryBatchDetails").click(Events.queryBatchDetailClkAct),
		// 重置表单
