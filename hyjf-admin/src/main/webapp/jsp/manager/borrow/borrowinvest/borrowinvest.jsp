...
<shiro:hasPermission name="borrowinvest:VIEW">
	<tiles:insertTemplate template="/jsp/layout/listLayout.jsp" flush="true">
						...
						<div class="search-classic">
							...
							<div class="well">
								...
								<shiro:hasPermission name="borrowinvest:EXPORT">
									<shiro:hasPermission name="borrowinvest:ORGANIZATION_VIEW">
										<a class="btn btn-o btn-primary btn-sm hidden-xs fn-EnhanceExport" data-toggle="tooltip" data-placement="bottom" data-original-title="导出列表">导出列表 <i class="fa fa-plus"></i></a>
									</shiro:hasPermission>
									<shiro:lacksPermission name="borrowinvest:ORGANIZATION_VIEW">
		...
		<tiles:putAttribute name="searchPanels" type="string">
			<shiro:hasPermission name="borrowinvest:SEARCH">
				...
				<div class="form-group">
					<label>出借人用户名</label> <input type="text" name="usernameSrch" id="usernameSrch" class="form-control input-sm underline" value="${borrowInvestForm.usernameSrch}" />
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<label>项目期限</label> <input type="text" name="borrowPeriod" id="borrowPeriod" class="form-control input-sm underline" value="${borrowInvestForm.borrowPeriod}" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')" maxlength="2" size="2" />
				</div>
				<!-- 				<div class="form-group"> -->
				<!-- 					<label>渠道</label> -->
		...
		<tiles:putAttribute name="pageJavaScript" type="string">
			...
			<script type='text/javascript' src="${webRoot}/jsp/manager/borrow/borrowinvest/borrowinvest.js"></script>
		</tiles:putAttribute>
