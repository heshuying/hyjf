...
<tiles:insertTemplate template="/jsp/layout/dialogLayout.jsp" flush="true">
					...
					<fieldset>
						...
						<div class="row">
							...
							<div class="col-md-12">
								<div class="col-xs-6">
									<div class="form-group">
										<label> <strong>提前天数：</strong><fmt:formatNumber value="${repayInfo.chargeDays }" pattern="#,##0" /><c:if test="${!empty repayInfo.chargeDays}">天</c:if>
										</label>
									</div>
								</div>
								<div class="col-xs-6">
									<div class="form-group">
										<label> <strong>少还利息：</strong><fmt:formatNumber value="${repayInfo.chargeInterest }" pattern="#,##0.0#" />元
										</label>
									</div>
								</div>
							</div>
	...
	<tiles:putAttribute name="pageJavaScript" type="string">
		<script type='text/javascript' src="${webRoot}/jsp/manager/borrow/borrowrepayment/repay/borrowrepay.js"></script>
	</tiles:putAttribute>
