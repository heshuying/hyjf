...
Events = {
	...
	// 跳转到详情画面
	infoListClkAct :function(){
		$("#borrowNid").val($(this).data("id"));
		$("#userName").val($(this).data("username"));
		$("#investId").val($(this).data("investid"));
		Page.submit(Action.infoListAction);
	},
};
...
$.extend(Page, {
	...
	initEvents : function() {
		...
		// 跳转融通宝加息还款明细详情
		$(".fn-toRepayPlan").click(Events.infoListClkAct)
	}
});
