 ...
 <shiro:hasPermission name="appoint:VIEW"> 
	<tiles:insertTemplate template="/jsp/layout/listLayout.jsp"
									...
									<c:forEach items="${recordList}" var="record"
										...
										<td>${vs.count }</td>
												...
												<td>
													...
													<a href="${webRoot}/manager/users/appoint/authList.do?username=${record.username}">明细</a>
													</c:if>
												</td>
										</tr>
										</c:forEach>
		...
		<tiles:putAttribute name="pageJavaScript" type="string">
			<script type='text/javascript' src="${webRoot}/jsp/manager/users/appoint/appoint_list.js"></script>
		</tiles:putAttribute>
