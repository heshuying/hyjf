...
<shiro:hasPermission name="bankcardlist:VIEW">
	<tiles:insertTemplate template="/jsp/layout/listLayout.jsp" flush="true">
				...
				<div class="tabbable">
					<ul class="nav nav-tabs" id="myTab"> 
						<shiro:hasPermission name="accountlist:SEARCH">
				      		<li><a href="${webRoot}/manager/bankcard/bankcardlist">汇付银行卡管理</a></li>
				      	</shiro:hasPermission>
				      	<shiro:hasPermission name="accountlist:SEARCH">
				      		<li  class="active"><a href="${webRoot}/manager/newbankcard/bankcardlist">江西银行卡管理</a></li>
				      	</shiro:hasPermission>
				    </ul>
										...
										<table id="equiList" class="table table-striped table-bordered table-hover">
											...
											<thead>
												<tr>
													...
													<th class="center">银行卡预留手机号</th>
													<th class="center">所属银行</th>
													<th class="center">绑卡时间</th>
												</tr>
											</thead>
													...
													<c:otherwise>
														<c:forEach items="${bankcardListForm.recordList }" var="record" begin="0" step="1" varStatus="status">
															<tr>
																...
																<td class="center"><c:out value="${record.bankMobile }"></c:out></td>
																<td class="center"><c:out value="${record.bank }"></c:out></td>
		...
		<tiles:putAttribute name="searchPanels" type="string">
			...
			<div class="form-group">
				<label>手机号</label> 
				<input type="text" name="mobile" class="form-control input-sm underline"  maxlength="20" value="${bankcardListForm.mobile}" />
			</div>
			<div class="form-group">
				<label>姓名</label> 
				<input type="text" name="realName" class="form-control input-sm underline"  maxlength="20" value="${bankcardListForm.realName}" />
			</div>
		...
		<script type="text/javascript"> var webRoot = "${webRoot}";</script>
			<script type='text/javascript' src="${webRoot}/jsp/manager/users/bankcardlist/newbankcardList.js"></script>
		</tiles:putAttribute>
