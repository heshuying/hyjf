...
<shiro:hasPermission name="accountlist:VIEW">
	<tiles:insertTemplate template="/jsp/layout/listLayout.jsp" flush="true">
				...
				<div class="tabbable">
					<ul class="nav nav-tabs" id="myTab"> 
						<shiro:hasPermission name="accountlist:SEARCH">
				      		<li><a href="${webRoot}/manager/account/accountlist">汇付银行开户记录</a></li>
				      	</shiro:hasPermission>
				      	<shiro:hasPermission name="accountlist:SEARCH">
				      		<li  class="active"><a href="${webRoot}/manager/bankaccount/accountlist">江西银行开户记录</a></li>
				      	</shiro:hasPermission>
				    </ul>
													...
													<c:otherwise>
														<c:forEach items="${accountListForm.recordList }" var="record" begin="0" step="1" varStatus="status">
															<tr>
																...
																<td class="center"><c:out value="${record.openAccountPlat }"></c:out></td>
		...
		<tiles:putAttribute name="searchPanels" type="string">
			...
			<div class="form-group">
				<label>手机号</label> 
				<input type="text" name="mobile" class="form-control input-sm underline"  maxlength="20" value="${accountListForm.mobile}" />
			</div>
			<div class="form-group">
				<label>姓名</label> 
			...
			<div class="form-group">
				<label>电子账号</label> 
				<input type="text" name="customerAccount" class="form-control input-sm underline" maxlength="20" value="${accountListForm.customerAccount}"/>
			</div>
			<%-- <div class="form-group">
				<label>身份证号码</label> 
		...
		<tiles:putAttribute name="pageJavaScript" type="string">
			<script type='text/javascript' src="${webRoot}/jsp/manager/users/accountlist/bankAccountList.js"></script>
		</tiles:putAttribute>
