...
<shiro:hasPermission name="help:VIEW">
	<tiles:insertTemplate template="/jsp/layout/listLayout.jsp" flush="true">
		...
		<div class="container-fluid container-fullw bg-white">
			<div class="tabbable">
				<ul class="nav nav-tabs" id="myTab">
					...
					<shiro:hasPermission name="help:VIEW">
						<li class="active"><a href="javascript:void(0);">智齿客服常见问题</a></li>
					</shiro:hasPermission>
				</ul>
				<div class="tab-content">
					<div class="tab-pane fade in active">
													...
													<shiro:hasPermission name="help:MODIFY">
														<div class="visible-md visible-lg hidden-sm hidden-xs">
															<a class="btn btn-transparent btn-xs tooltips fn-Move"
																data-id="${record.id }" data-toggle="tooltip" tooltip-placement="top" data-original-title="移出智齿客服常见列表">移出智齿客服常见列表</a>
														</div>
						...
						<%-- 分页栏 --%>
						<hyjf:paginator id="equiPaginator" hidden="paginator-page" action="zhiChiInit" paginator="${oftenForm.paginator}"></hyjf:paginator>
						<br /> <br />
					</div>
				</div>
			</div>
		...
		<tiles:putAttribute name="pageJavaScript" type="string">
			<script type='text/javascript' src="${webRoot}/jsp/manager/content/help/zhichilist.js"></script>
		</tiles:putAttribute>
