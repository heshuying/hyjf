...
<title>汇盈金服 - 公司纪事 - 真诚透明自律的互联网金融服务平台</title>
      ...
      <div class="userHelp"><a href="http://www.hyjf.com/help.html">帮助中心</a><i class="iconfont">&#xe617;</i></div>
			...
			<div class="about-container fr">
				...
				<div class="about-info">
					<img
						src="http://www.huiyingdai.com/themes/default/images/itime.jpg">
				</div>
				<!-- 修改部分 -->
				<div class="events-info">
					...
					<div class="list">
						<label>11月27日<em></em></label> <i></i>
						<h4>汇盈金服与中国中小企业协会战略合作正式签约</h4>
					</div>
					<div class="year">
						<span>2014</span>
					</div>
					<div class="list">
						<label>11月06日<em></em></label> <i></i>
						<h4>汇小贷上线</h4>
					</div>
					<div class="year">
						<span>2013</span>
