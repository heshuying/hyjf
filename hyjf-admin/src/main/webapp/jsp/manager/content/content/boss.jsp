...
<title>汇盈金服 - 创始人 - 真诚透明自律的互联网金融服务平台</title>
...
<section class="new-warp clf">
		<div class="inner">
			...
			<div class="about-container fr">
				...
				<div class="team-info">
					<ul class="team">
						<li><img alt="刘伯党" class="lazyload"
							data-original="/data/upfiles/image/20150531/1433074867724.jpg">
							<div class="record">
								<h4>
									刘伯党 <span> 董事长 </span>
								</h4>
								<p>
									惠众商务顾问（北京）有限公司、宁圣金融信息服务（上海）有限公司董事长<br />
									多年从事金融类行业、股权出借、资产管理、不良资产收购、基金、融资性担保、典当、对外出借、酒店管理等多个行业，积累了丰富的的企业客户和金融机构资源。<br />
									有感于金融市场的新形势，2013年创办了汇盈金服。<br />
									自创办企业以来，坚持以诚信经营为理念，拥有强烈的责任感和使命感，大胆开拓，勇于创新，使企业成为行业高速发展的领头人。<br />
								</p>
							</div></li>
					</ul>
				</div>
