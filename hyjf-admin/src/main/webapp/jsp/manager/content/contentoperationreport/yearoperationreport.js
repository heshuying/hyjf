$(function(){
    ...
    var validatError= $("#yearForm").Validform({
        tiptype:3,
        postonce:true,
        showAllError:true
    });
...
//添加活动
    ...
    $("#publishSubmit").click(function(){
        $("#isRelease").val(1);
        $("#yearForm").action="yearOperationReportSaveAction";
    ...
    $("#addPreview").click(function(){
        ...
        if(yearInput == ""){
            ...
            $.ajax({
                url : webPath+"/manager/content/operationreport/yearPreviewAction" ,//url
                type : "POST",
                ...
                success : function(data) {
                    if (data!=null||data!="") {
                        ...
                        var yearOperationReportId=res.yearlyOperationReportId;
                        ...
                        if($("#operationReportId").val() != null||$("#operationReportId").val() != ""){
                            ...
                            $("#yearOperationReportId").val(yearOperationReportId);
