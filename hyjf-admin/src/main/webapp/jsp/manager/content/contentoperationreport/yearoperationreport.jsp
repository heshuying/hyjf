...
<script type='text/javascript' src="${webRoot}/jsp/manager/content/contentoperationreport/yearoperationreport.js"></script>
<script src="http://libs.baidu.com/jquery/2.0.0/jquery.js"></script>
...
<form id="yearForm" action="yearOperationReportSaveAction" method="post" class="form-horizontal" target="_top">
	<%-- 运营报告 --%>
	...
	<%--<input type="hidden" name="operationReportActivity.id" id="yearId" value="${operationreportCommonForm.operationReportActivity.id }" />--%>
	...
	<input type="hidden" name="yearOperationReport.id" id="yearlyOperationReportId" value="${operationreportCommonForm.yearOperationReport.id }" />
		<!-- 中、英文标题 -->
	...
	<div class="form-group">
		<div class="text col-xs-10">
			<h5><font size="4px" style="margin:0px 0px 0px 0px"><b>年度业绩</b></font></h5>
		</div>
		<div class="col-xs-10">
			<div  style="width:33.3%; float:left;">
				<div style="float:left;width: 30%">
				...
				<div style="float:left;width: 70%" >
					<input type="text" id="firstMonthAmount" name="yearOperationReport.firstMonthAmount" class="moneyStyle" datatype="/^(?:0|[1-9][0-9]{0,12}|[0-9]{1,13}[\.][0-9]+)$/" errormsg="请输入整数位在13位以内的数" placeholder="" value="${operationreportCommonForm.yearOperationReport.firstMonthAmount}" />&nbsp;&nbsp;元
				</div>
			</div>
			...
			<div  style="width:33.3%; float:left;">
				...
				<div style="float:left;width: 70%" >
					<input type="text" id="secondMonthAmount" name="yearOperationReport.secondMonthAmount" class="moneyStyle" datatype="/^(?:0|[1-9][0-9]{0,12}|[0-9]{1,13}[\.][0-9]+)$/" errormsg="请输入整数位在13位以内的数" placeholder="" value="${operationreportCommonForm.yearOperationReport.secondMonthAmount}"  />&nbsp;&nbsp;元
				</div>
			</div>
			...
			<div  style="width:33.3%; float:left;">
				...
				<div style="float:left;width: 70%" >
					<input type="text" id="thirdMonthAmount" name="yearOperationReport.thirdMonthAmount" class="moneyStyle" datatype="/^(?:0|[1-9][0-9]{0,12}|[0-9]{1,13}[\.][0-9]+)$/" errormsg="请输入整数位在13位以内的数" placeholder="" value="${operationreportCommonForm.yearOperationReport.thirdMonthAmount}" />&nbsp;&nbsp;元
				</div>
			</div>
		</div>
		<div class="col-xs-10">
			<div  style="width:33.3%; float:left;">
				...
				<div style="float:left;width: 70%" >
					<input type="text" id="fourthMonthAmount" name="yearOperationReport.fourthMonthAmount" class="moneyStyle" datatype="/^(?:0|[1-9][0-9]{0,12}|[0-9]{1,13}[\.][0-9]+)$/" errormsg="请输入整数位在13位以内的数" placeholder="" value="${operationreportCommonForm.yearOperationReport.fourthMonthAmount}"  />&nbsp;&nbsp;元
				</div>
			</div>
			<div  style="width:33.3%; float:left;">
				<div style="float:left;width: 30%">
				...
				<div style="float:left;width: 70%" >
					<input type="text" id="fifthMonthAmount" name="yearOperationReport.fifthMonthAmount" class="moneyStyle" datatype="/^(?:0|[1-9][0-9]{0,12}|[0-9]{1,13}[\.][0-9]+)$/" errormsg="请输入整数位在13位以内的数" value="${operationreportCommonForm.yearOperationReport.fifthMonthAmount}"  />&nbsp;&nbsp;元
				</div>
			</div>
			...
			<div  style="width:33.3%; float:left;">
				...
				<div style="float:left;width: 70%" >
					<input type="text" id="sixthMonthAmount" name="yearOperationReport.sixthMonthAmount" class="moneyStyle" datatype="/^(?:0|[1-9][0-9]{0,12}|[0-9]{1,13}[\.][0-9]+)$/" errormsg="请输入整数位在13位以内的数" placeholder="" value="${operationreportCommonForm.yearOperationReport.sixthMonthAmount}" />&nbsp;&nbsp;元
				</div>
			</div>
		</div>
		...
		<div class="col-xs-10">
			<div  style="width:33.3%; float:left;">
				...
				<div style="float:left;width: 70%" >
					<input type="text" id="seventhMonthAmount" name="yearOperationReport.seventhMonthAmoun" class="moneyStyle" datatype="/^(?:0|[1-9][0-9]{0,12}|[0-9]{1,13}[\.][0-9]+)$/" errormsg="请输入整数位在13位以内的数" placeholder="" value="${operationreportCommonForm.yearOperationReport.seventhMonthAmoun}"  />&nbsp;&nbsp;元
				</div>
			</div>
			<div  style="width:33.3%; float:left;">
				<div style="float:left;width: 30%">
				...
				<div style="float:left;width: 70%" >
					<input type="text" id="eighteenMonthAmount" name="yearOperationReport.eighteenMonthAmount" class="moneyStyle" datatype="/^(?:0|[1-9][0-9]{0,12}|[0-9]{1,13}[\.][0-9]+)$/" errormsg="请输入整数位在13位以内的数" placeholder="" value="${operationreportCommonForm.yearOperationReport.eighteenMonthAmount}" />&nbsp;&nbsp;元
				</div>
			</div>
			<div  style="width:33.3%; float:left;">
				<div style="float:left;width: 30%">
				...
				<div style="float:left;width: 70%" >
					<input type="text" id="ninthMonthAmount" name="yearOperationReport.ninthMonthAmount" class="moneyStyle" placeholder="" datatype="/^(?:0|[1-9][0-9]{0,12}|[0-9]{1,13}[\.][0-9]+)$/" errormsg="请输入整数位在13位以内的数" value="${operationreportCommonForm.yearOperationReport.ninthMonthAmount}"  />&nbsp;&nbsp;元
				</div>
			</div>
		</div>
		<div class="col-xs-10">
			<div  style="width:33.3%; float:left;">
				...
				<div style="float:left;width: 70%" >
					<input type="text" id="tenthMonthAmount" name="yearOperationReport.tenthMonthAmount" class="moneyStyle" placeholder="" datatype="/^(?:0|[1-9][0-9]{0,12}|[0-9]{1,13}[\.][0-9]+)$/" errormsg="请输入整数位在13位以内的数" value="${operationreportCommonForm.yearOperationReport.tenthMonthAmount}"  />&nbsp;&nbsp;元
				</div>
			</div>
			<div  style="width:33.3%; float:left;">
				<div style="float:left;width: 30%">
				...
				<div style="float:left;width: 70%" >
					<input type="text" id="eleventhMonthAmount" name="yearOperationReport.eleventhMonthAmount" class="moneyStyle" placeholder="" datatype="/^(?:0|[1-9][0-9]{0,12}|[0-9]{1,13}[\.][0-9]+)$/" errormsg="请输入整数位在13位以内的数" value="${operationreportCommonForm.yearOperationReport.eleventhMonthAmount}"  />&nbsp;&nbsp;元
				</div>
			</div>
			<div  style="width:33.3%; float:left;">
				<div style="float:left;width: 30%">
				...
				<div style="float:left;width: 70%" >
					<input type="text" id="twelveMonthAmount" name="yearOperationReport.twelveMonthAmount" class="moneyStyle" placeholder="" datatype="/^(?:0|[1-9][0-9]{0,12}|[0-9]{1,13}[\.][0-9]+)$/" errormsg="请输入整数位在13位以内的数" value="${operationreportCommonForm.yearOperationReport.twelveMonthAmount}"  />&nbsp;&nbsp;元
				</div>
			</div>
		</div>
		<div class="col-xs-10">
			<div  style="width:33.3%; float:left;">
				...
				<div style="float:left;width: 70%" >
					<input type="text" id="yearAmount" name="operationReport.operationAmount" class="moneyStyle" placeholder="" datatype="/^(?:0|[1-9][0-9]{0,12}|[0-9]{1,13}[\.][0-9]+)$/" errormsg="请输入整数位在13位以内的数" value="${operationreportCommonForm.operationReport.operationAmount}" />&nbsp;&nbsp;元
				</div>
			</div>
			<div  style="width:33.3%; float:left;">
				<div style="float:left;width: 30%">
				...
				<div style="float:left;width: 70%" >
					<input type="text" id="yearProfit" name="operationReport.operationProfit" class="moneyStyle" placeholder="" datatype="/^(?:0|[1-9][0-9]{0,12}|[0-9]{1,13}[\.][0-9]+)$/" errormsg="请输入整数位在13位以内的数" value="${operationreportCommonForm.operationReport.operationProfit}"  />&nbsp;&nbsp;元
				</div>
			</div>
			<div  style="width:33.3%; float:left;">
				<div style="float:left;width: 30%">
				...
				<div style="float:left;width: 70%" >
					<input type="text" id="yearSuccessDeal" name="operationReport.successDealNum" datatype="n1-9" errormsg="请输入9位以内的整数" class="positiveNumber" placeholder="" value="${operationreportCommonForm.operationReport.successDealNum}" />&nbsp;&nbsp;笔
				</div>
			</div>
		</div>
		<div class="col-xs-10">
			<div  style="width:33.3%; float:left;">
				...
				<div style="float:left;width: 70%" >
					<input type="text" id="yearOperationReport" name="yearOperationReport.yearSuccessMonth" datatype="/^(0?[[0-9]|1[0-2])$/" errormsg="请输入正确月份" nullmsg="请输入数量" class="twelveMonth" placeholder="" value="${operationreportCommonForm.yearOperationReport.yearSuccessMonth}" />&nbsp;&nbsp;月
				</div>
			</div>
			<div  style="width:33.3%; float:left;">
				<div style="float:left;width: 30%">
				...
				<div style="float:left;width: 70%" >
					<input type="text" id="yearSuccessMonthAmount" name="yearOperationReport.yearSuccessMonthAmount" class="moneyStyle" datatype="/^(?:0|[1-9][0-9]{0,12}|[0-9]{1,13}[\.][0-9]+)$/" errormsg="请输入整数位在13位以内的数" placeholder="" value="${operationreportCommonForm.yearOperationReport.yearSuccessMonthAmount}" />&nbsp;&nbsp;元
				</div>
			</div>
			<div  style="width:33.3%; float:left;">
				<div style="float:left;width: 30%">
				...
				<div style="float:left;width: 70%" >
					<input type="text" id="yearAvgProfit" name="yearOperationReport.yearAvgProfit" datatype="/^(?:0|[1-9][0-9]{0,2}|[0-9]{1,3}[\.][0-9]+)$/"errormsg="请输入整数位在3位以内的数" class="moneyStyle" placeholder="" value="${operationreportCommonForm.yearOperationReport.yearAvgProfit}" />&nbsp;&nbsp;%
				</div>
			</div>
		</div>
	</div>
	<div class="col-xs-10">
		...
		<div class="col-xs-10">
			<div  style="width:33.3%; float:left;">
				...
				<div style="float:left;width: 70%" >
					<input type="text" id="lessThirtyDayNum" name="yearOperationReport.lessThirtyDayNum" datatype="n1-9" nullmsg="请输入9位以内的整数" class="positiveNumber" placeholder="" value="${operationreportCommonForm.yearOperationReport.lessThirtyDayNum}"/>&nbsp;&nbsp;个
				</div>
			...
			<div  style="width:66.6%; float:left;">
				...
				<div style="float:left;width: 85%" >
					<input type="text" id="lessThirtyDayProportion"  name="yearOperationReport.lessThirtyDayProportion" datatype="/^(?:0|[1-9][0-9]{0,1}|[0-9]{1,2}[\.][0-9]+|100)$/"errormsg="请输入不大于100的数" class="moneyStyle" placeholder="" value="${operationreportCommonForm.yearOperationReport.lessThirtyDayProportion}"/>&nbsp;&nbsp;%
				</div>
			</div>
		</div>
		<div class="col-xs-10">
			<div  style="width:33.3%; float:left;">
				...
				<div style="float:left;width: 70%" >
					<input type="text" id="thirtyDayNum" name="yearOperationReport.thirtyDayNum" datatype="n1-9" nullmsg="请输入9位以内的整数"  class="positiveNumber" placeholder="" value="${operationreportCommonForm.yearOperationReport.thirtyDayNum}"/>&nbsp;&nbsp;个
				</div>
			...
			<div  style="width:66.6%; float:left;">
				...
				<div style="float:left;width: 85%" >
					<input type="text" id="thirtyDayProportion" name="yearOperationReport.thirtyDayProportion" class="moneyStyle" placeholder="" datatype="/^(?:0|[1-9][0-9]{0,1}|[0-9]{1,2}[\.][0-9]+|100)$/"errormsg="请输入不大于100的数" value="${operationreportCommonForm.yearOperationReport.thirtyDayProportion}"/>&nbsp;&nbsp;%
				</div>
			</div>
		</div>
		<div class="col-xs-10">
			<div  style="width:33.3%; float:left;">
				...
				<div style="float:left;width: 70%" >
					<input type="text"  name="yearOperationReport.oneMonthNum" class="positiveNumber" datatype="n1-9" errormsg="请输入9位以内的数" placeholder="" value="${operationreportCommonForm.yearOperationReport.oneMonthNum}" />&nbsp;&nbsp;个
				</div>
			...
			<div  style="width:66.6%; float:left;">
				...
				<div style="float:left;width: 85%" >
					<input type="text" id="oneMonthProportion" name="yearOperationReport.oneMonthProportion" class="moneyStyle" placeholder="" datatype="/^(?:0|[1-9][0-9]{0,1}|[0-9]{1,2}[\.][0-9]+|100)$/"errormsg="请输入不大于100的数" value="${operationreportCommonForm.yearOperationReport.oneMonthProportion}" />&nbsp;&nbsp;%
				</div>
			</div>
		</div>
		<div class="col-xs-10">
			<div  style="width:33.3%; float:left;">
				...
				<div style="float:left;width: 70%" >
					<input type="text"  name="yearOperationReport.twoMonthNum" class="positiveNumber" datatype="n1-9" errormsg="请输入9位以内的数" placeholder="" value="${operationreportCommonForm.yearOperationReport.twoMonthNum}"/>&nbsp;&nbsp;个
				</div>
			...
			<div  style="width:66.6%; float:left;">
				...
				<div style="float:left;width: 85%" >
					<input type="text" id="twoMonthProportion" name="yearOperationReport.twoMonthProportion" class="moneyStyle" placeholder="" datatype="/^(?:0|[1-9][0-9]{0,1}|[0-9]{1,2}[\.][0-9]+|100)$/"errormsg="请输入不大于100的数" value="${operationreportCommonForm.yearOperationReport.twoMonthProportion}" />&nbsp;&nbsp;%
				</div>
			</div>
		</div>
		<div class="col-xs-10">
			<div  style="width:33.3%; float:left;">
				...
				<div style="float:left;width: 70%" >
					<input type="text"  name="yearOperationReport.threeMonthNum" class="positiveNumber" datatype="n1-9" errormsg="请输入9位以内的数" placeholder="" value="${operationreportCommonForm.yearOperationReport.threeMonthNum}" />&nbsp;&nbsp;个
				</div>
			...
			<div  style="width:66.6%; float:left;">
				...
				<div style="float:left;width: 85%" >
					<input type="text" id="threeMonthProportion" name="yearOperationReport.threeMonthProportion" class="moneyStyle" placeholder="" datatype="/^(?:0|[1-9][0-9]{0,1}|[0-9]{1,2}[\.][0-9]+|100)$/"errormsg="请输入不大于100的数" value="${operationreportCommonForm.yearOperationReport.threeMonthProportion}"  />&nbsp;&nbsp;%
				</div>
			</div>
		</div>
		<div class="col-xs-10">
			<div  style="width:33.3%; float:left;">
				...
				<div style="float:left;width: 70%" >
					<input type="text"  name="yearOperationReport.fourMonthNum" class="positiveNumber" datatype="n1-9" errormsg="请输入9位以内的数" placeholder="" value="${operationreportCommonForm.yearOperationReport.fourMonthNum}" />&nbsp;&nbsp;个
				</div>
			...
			<div  style="width:66.6%; float:left;">
				...
				<div style="float:left;width: 85%" >
					<input type="text"  id="fourMonthProportion" name="yearOperationReport.fourMonthProportion" class="moneyStyle" placeholder="" datatype="/^(?:0|[1-9][0-9]{0,1}|[0-9]{1,2}[\.][0-9]+|100)$/"errormsg="请输入不大于100的数" value="${operationreportCommonForm.yearOperationReport.fourMonthProportion}" />&nbsp;&nbsp;%
				</div>
			</div>
		</div>
		<div class="col-xs-10">
			<div  style="width:33.3%; float:left;">
				...
				<div style="float:left;width: 70%" >
					<input type="text"  name="yearOperationReport.fiveMonthNum" class="positiveNumber" datatype="n1-9" errormsg="请输入9位以内的数"  placeholder="" value="${operationreportCommonForm.yearOperationReport.fiveMonthNum}" />&nbsp;&nbsp;个
				</div>
			...
			<div  style="width:66.6%; float:left;">
				...
				<div style="float:left;width: 85%" >
					<input type="text" id="fiveMonthProportion" name="yearOperationReport.fiveMonthProportion" class="moneyStyle" placeholder="" datatype="/^(?:0|[1-9][0-9]{0,1}|[0-9]{1,2}[\.][0-9]+|100)$/"errormsg="请输入不大于100的数" value="${operationreportCommonForm.yearOperationReport.fiveMonthProportion}" />&nbsp;&nbsp;%
				</div>
			</div>
		</div>
		<div class="col-xs-10">
			<div  style="width:33.3%; float:left;">
				...
				<div style="float:left;width: 70%" >
					<input type="text"  name="yearOperationReport.sixMonthNum" class="positiveNumber" datatype="n1-9" errormsg="请输入9位以内的数"   placeholder="" value="${operationreportCommonForm.yearOperationReport.sixMonthNum}"/>&nbsp;&nbsp;个
				</div>
			...
			<div  style="width:66.6%; float:left;">
				...
				<div style="float:left;width: 85%" >
					<input type="text" id="sixMonthProportion" name="yearOperationReport.sixMonthProportion" class="moneyStyle" placeholder="" datatype="/^(?:0|[1-9][0-9]{0,1}|[0-9]{1,2}[\.][0-9]+|100)$/"errormsg="请输入不大于100的数" value="${operationreportCommonForm.yearOperationReport.sixMonthProportion}"/>&nbsp;&nbsp;%
				</div>
			</div>
		</div>
		...
		<div class="col-xs-10">
			<div  style="width:33.3%; float:left;">
				...
				<div style="float:left;width: 70%" >
					<input type="text" name="yearOperationReport.nineMonthNum" class="positiveNumber" datatype="n1-9" errormsg="请输入9位以内的数"  placeholder="" value="${operationreportCommonForm.yearOperationReport.nineMonthNum}"/>&nbsp;&nbsp;个
				</div>
			...
			<div  style="width:66.6%; float:left;">
				...
				<div style="float:left;width: 85%" >
					<input type="text" id="nineMonthProportion" name="yearOperationReport.nineMonthProportion" class="moneyStyle" placeholder="" datatype="/^(?:0|[1-9][0-9]{0,1}|[0-9]{1,2}[\.][0-9]+|100)$/"errormsg="请输入不大于100的数" value="${operationreportCommonForm.yearOperationReport.nineMonthProportion}" />&nbsp;&nbsp;%
				</div>
			</div>
		</div>
		<div class="col-xs-10">
			<div  style="width:33.3%; float:left;">
				...
				<div style="float:left;width: 70%" >
					<input type="text" id="tenMonthNum" name="yearOperationReport.tenMonthNum" datatype="n1-9" errormsg="请输入9位以内的数" class="positiveNumber" placeholder="" value="${operationreportCommonForm.yearOperationReport.tenMonthNum}"/>&nbsp;&nbsp;个
				</div>
			...
			<div  style="width:66.6%; float:left;">
				...
				<div style="float:left;width: 85%" >
					<input type="text" id="tenMonthProportion" name="yearOperationReport.tenMonthProportion" class="moneyStyle" placeholder="" datatype="/^(?:0|[1-9][0-9]{0,1}|[0-9]{1,2}[\.][0-9]+|100)$/"errormsg="请输入不大于100的数" value="${operationreportCommonForm.yearOperationReport.tenMonthProportion}" />&nbsp;&nbsp;%
				</div>
			</div>
		</div>
		...
		<div class="col-xs-10">
			...
			<div  style="width:33.3%; float:left;">
				...
				<div style="float:left;width: 70%" >
					<input type="text"  name="yearOperationReport.twelveMonthNum" class="positiveNumber" datatype="n1-9" errormsg="请输入9位以内的数" placeholder="" value="${operationreportCommonForm.yearOperationReport.twelveMonthNum}" />&nbsp;&nbsp;个
				</div>
			...
			<div  style="width:66.6%; float:left;">
				...
				<div style="float:left;width: 85%" >
					<input type="text" id="twelveMonthProportion" name="yearOperationReport.twelveMonthProportion" class="moneyStyle" placeholder="" datatype="/^(?:0|[1-9][0-9]{0,1}|[0-9]{1,2}[\.][0-9]+|100)$/"errormsg="请输入不大于100的数" value="${operationreportCommonForm.yearOperationReport.twelveMonthProportion}"/>&nbsp;&nbsp;%
				</div>
			</div>
		</div>
		<div class="col-xs-10">
			...
			<div  style="width:33.3%; float:left;">
				...
				<div style="float:left;width: 70%" >
					<input type="text" id="fifteenMonthNum" name="yearOperationReport.fifteenMonthNum" datatype="n1-9" errormsg="请输入9位以内的数"  class="positiveNumber" placeholder="" value="${operationreportCommonForm.yearOperationReport.fifteenMonthNum}" />&nbsp;&nbsp;个
				</div>
			...
			<div  style="width:66.6%; float:left;">
				...
				<div style="float:left;width: 85%" >
					<input type="text" id="fifteenMonthProportion" name="yearOperationReport.fifteenMonthProportion" class="moneyStyle" placeholder="" datatype="/^(?:0|[1-9][0-9]{0,1}|[0-9]{1,2}[\.][0-9]+|100)$/"errormsg="请输入不大于100的数" value="${operationreportCommonForm.yearOperationReport.fifteenMonthProportion}" />&nbsp;&nbsp;%
				</div>
			</div>
		</div>
		<div class="col-xs-10">
			<div  style="width:33.3%; float:left;">
				...
				<div style="float:left;width: 70%" >
					<input type="text"  name="yearOperationReport.eighteenMonthNum" class="moneyStyle" datatype="n1-9" errormsg="请输入9位以内的数" placeholder="" value="${operationreportCommonForm.yearOperationReport.eighteenMonthNum}"/>&nbsp;&nbsp;个
				</div>
			...
			<div  style="width:66.6%; float:left;">
				...
				<div style="float:left;width: 85%" >
					<input type="text" id="eighteenMonthProportion" name="yearOperationReport.eighteenMonthProportion" class="moneyStyle" placeholder="" datatype="/^(?:0|[1-9][0-9]{0,1}|[0-9]{1,2}[\.][0-9]+|100)$/"errormsg="请输入不大于100的数" value="${operationreportCommonForm.yearOperationReport.eighteenMonthProportion}"/>&nbsp;&nbsp;%
				</div>
			</div>
		</div>
		<div class="col-xs-10">
			...
			<div  style="width:33.3%; float:left;">
				...
				<div style="float:left;width: 70%" >
					<input type="text"  name="yearOperationReport.twentyFourMonthNum" class="moneyStyle" datatype="n1-9" errormsg="请输入9位以内的数" placeholder="" value="${operationreportCommonForm.yearOperationReport.twentyFourMonthNum}"/>&nbsp;&nbsp;个
				</div>
			...
			<div  style="width:66.6%; float:left;">
				...
				<div style="float:left;width: 85%" >
					<input type="text" id="twentyFourMonthProportion" name="yearOperationReport.twentyFourMonthProportion" class="moneyStyle" placeholder="" datatype="/^(?:0|[1-9][0-9]{0,1}|[0-9]{1,2}[\.][0-9]+|100)$/"errormsg="请输入不大于100的数" value="${operationreportCommonForm.yearOperationReport.twentyFourMonthProportion}" />&nbsp;&nbsp;%
				</div>
			</div>
		</div>
	...
	<div class="form-group">
		...
		<div class="col-xs-10">
			<div  style="width:33.3%; float:left;">
				...
				<div style="float:left;width: 70%" >
					<input type="text" name="yearOperationReport.yearAppDealNum" class="positiveNumber" placeholder="" datatype="n1-9" errormsg="请输入9位以内的数"  value="${operationreportCommonForm.yearOperationReport.yearAppDealNum}" />&nbsp;&nbsp;笔
				</div>
			...
			<div  style="width:66.6%; float:left;">
				...
				<div style="float:left;width: 85%" >
					<input type="text" id="yearAppDealProportion" name="yearOperationReport.yearAppDealProportion" datatype="/^(?:0|[1-9][0-9]{0,1}|[0-9]{1,2}[\.][0-9]+|100)$/"errormsg="请输入不大于100的数" class="moneyStyle" placeholder="" value="${operationreportCommonForm.yearOperationReport.yearAppDealProportion}" />&nbsp;&nbsp;%
				</div>
			</div>
		</div>
		<div class="col-xs-10">
			<div  style="width:33.3%; float:left;">
				...
				<div style="float:left;width: 70%" >
					<input type="text" name="yearOperationReport.yearWechatDealNum"  class="positiveNumber" placeholder="" datatype="n1-9" errormsg="请输入9位以内的数"
						   value="${operationreportCommonForm.yearOperationReport.yearWechatDealNum}"/>&nbsp;&nbsp;笔
				</div>
			...
			<div  style="width:66.6%; float:left;">
				...
				<div style="float:left;width: 85%" >
					<input type="text" id="yearWechatDealProportion" name="yearOperationReport.yearWechatDealProportion" class="moneyStyle" datatype="/^(?:0|[1-9][0-9]{0,1}|[0-9]{1,2}[\.][0-9]+|100)$/"errormsg="请输入不大于100的数" placeholder="" value="${operationreportCommonForm.yearOperationReport.yearWechatDealProportion}"/>&nbsp;&nbsp;%
				</div>
			</div>
		</div>
		<div class="col-xs-10">
			<div  style="width:33.3%; float:left;">
				...
				<div style="float:left;width: 70%" >
					<input type="text" id="quarterOperationReport" name="yearOperationReport.yearPcDealNum"  datatype="n1-9" errormsg="请输入9位以内的数" class="positiveNumber" placeholder="" value="${operationreportCommonForm.yearOperationReport.yearPcDealNum}" />&nbsp;&nbsp;笔
				</div>
			...
			<div  style="width:66.6%; float:left;">
				...
				<div style="float:left;width: 85%" >
					<input type="text" id="yearPcDealProportion" name="yearOperationReport.yearPcDealProportion" datatype="/^(?:0|[1-9][0-9]{0,1}|[0-9]{1,2}[\.][0-9]+|100)$/"errormsg="请输入不大于100的数" class="moneyStyle" placeholder="" value="${operationreportCommonForm.yearOperationReport.yearPcDealProportion}"  />&nbsp;&nbsp;%
				</div>
			</div>
		</div>
		<div class="col-xs-10">
			<div  style="width:33.3%; float:left;">
				...
				<div style="float:left;width: 70%" >
					<input type="text" id="yearAppDealAmount" name="yearOperationReport.yearAppDealAmount"  class="moneyStyle" datatype="/^(?:0|[1-9][0-9]{0,12}|[0-9]{1,13}[\.][0-9]+)$/" errormsg="请输入整数位在13位以内的数" placeholder="" value="${operationreportCommonForm.yearOperationReport.yearAppDealAmount}" />&nbsp;&nbsp;元
				</div>
			...
			<div  style="width:66.6%; float:left;">
				...
				<div style="float:left;width: 85%" >
					<input type="text" id="yearAppAmountProportion" name="yearOperationReport.yearAppAmountProportion" datatype="/^(?:0|[1-9][0-9]{0,1}|[0-9]{1,2}[\.][0-9]+|100)$/"errormsg="请输入不大于100的数" class="moneyStyle" placeholder="" value="${operationreportCommonForm.yearOperationReport.yearAppAmountProportion}"  />&nbsp;&nbsp;%
				</div>
			</div>
		</div>
		<div class="col-xs-10">
			<div  style="width:33.3%; float:left;">
				...
				<div style="float:left;width: 70%" >
					<input type="text" id="yearWechatDealAmount" name="yearOperationReport.yearWechatDealAmount"  class="moneyStyle" datatype="/^(?:0|[1-9][0-9]{0,12}|[0-9]{1,13}[\.][0-9]+)$/"  errormsg="请输入整数位在13位以内的数" placeholder="" value="${operationreportCommonForm.yearOperationReport.yearWechatDealAmount}" />&nbsp;&nbsp;元
				</div>
			...
			<div  style="width:66.6%; float:left;">
				...
				<div style="float:left;width: 85%" >
					<input type="text" id="yearWechatAmountProportion" name="yearOperationReport.yearWechatAmountProportion" datatype="/^(?:0|[1-9][0-9]{0,1}|[0-9]{1,2}[\.][0-9]+|100)$/"errormsg="请输入不大于100的数" class="moneyStyle" placeholder="" value="${operationreportCommonForm.yearOperationReport.yearWechatAmountProportion}"  />&nbsp;&nbsp;%
				</div>
			</div>
		</div>
		<div class="col-xs-10">
			<div  style="width:33.3%; float:left;">
				...
				<div style="float:left;width: 70%" >
					<input type="text" id="yearPcDealAmount" name="yearOperationReport.yearPcDealAmount"  class="moneyStyle" datatype="/^(?:0|[1-9][0-9]{0,12}|[0-9]{1,13}[\.][0-9]+)$/" errormsg="请输入整数位在13位以内的数" placeholder="" value="${operationreportCommonForm.yearOperationReport.yearPcDealAmount}" />&nbsp;&nbsp;元
				</div>
			...
			<div  style="width:66.6%; float:left;">
				...
				<div style="float:left;width: 85%" >
					<input type="text" id="yearPcAmountProportion" name="yearOperationReport.yearPcAmountProportion" datatype="/^(?:0|[1-9][0-9]{0,1}|[0-9]{1,2}[\.][0-9]+|100)$/"errormsg="请输入不大于100的数" class="moneyStyle" placeholder="" value="${operationreportCommonForm.yearOperationReport.yearPcAmountProportion}"  />&nbsp;&nbsp;%
				</div>
			</div>
		</div>
	</div>
		...
		<div  class="text col-xs-10">
			...
			<div class="col-xs-10">
				<div  style="width:33.3%; float:left;">
					...
					<div style="float:left;width: 70%" >
						<input type="text" id="manTenderNum" name="userOperationReport.manTenderNum"  datatype="n1-9" errormsg="请输入9位以内的数" class="positiveNumber" placeholder="" value="${operationreportCommonForm.userOperationReport.manTenderNum}" />&nbsp;&nbsp;人
					</div>
			...
			<div class="col-xs-10">
				<div  style="width:33.3%; float:left;">
					...
					<div style="float:left;width: 70%" >
						<input type="text" id="womanTenderNum" name="userOperationReport.womanTenderNum"  datatype="n1-9" errormsg="请输入9位以内的数" class="positiveNumber" placeholder="" value="${operationreportCommonForm.userOperationReport.womanTenderNum}" />&nbsp;&nbsp;人
					</div>
			...
			<div class="col-xs-10">
				<div  style="width:33.3%; float:left;">
					...
					<div style="float:left;width: 70%" >
						<input type="text" id="ageFirstStageTenderNum" name="userOperationReport.ageFirstStageTenderNum"  datatype="n1-9" errormsg="请输入9位以内的数" class="positiveNumber" placeholder="" value="${operationreportCommonForm.userOperationReport.ageFirstStageTenderNum}"/>&nbsp;&nbsp;人
					</div>
				</div>
				<div  style="width:66.6%; float:left;">
					<div style="float:left;width: 15%">
			...
			<div class="col-xs-10">
				...
				<div  style="width:33.3%; float:left;">
					...
					<div style="float:left;width: 70%" >
						<input type="text" id="ageSecondStageTenderNum" name="userOperationReport.ageSecondStageTenderNum"  datatype="n1-9" errormsg="请输入9位以内的数" class="positiveNumber" placeholder="" value="${operationreportCommonForm.userOperationReport.ageSecondStageTenderNum}" />&nbsp;&nbsp;人
					</div>
				</div>
				<div  style="width:66.6%; float:left;">
					<div style="float:left;width: 15%">
			...
			<div class="col-xs-10">
				<div  style="width:33.3%; float:left;">
					...
					<div style="float:left;width: 70%" >
						<input type="text" id="ageThirdStageTenderNum" name="userOperationReport.ageThirdStageTenderNum"  datatype="n1-9" errormsg="请输入9位以内的数"  class="positiveNumber" placeholder="" value="${operationreportCommonForm.userOperationReport.ageThirdStageTenderNum}"/>&nbsp;&nbsp;人
					</div>
				</div>
				<div  style="width:66.6%; float:left;">
					<div style="float:left;width: 15%">
			...
			<div class="col-xs-10">
				<div  style="width:33.3%; float:left;">
					...
					<div style="float:left;width: 70%" >
						<input type="text" id="ageFourthStageTenderNum" name="userOperationReport.ageFourthStageTenderNum"  datatype="n1-9" errormsg="请输入9位以内的数"  class="positiveNumber" placeholder="" value="${operationreportCommonForm.userOperationReport.ageFourthStageTenderNum}" />&nbsp;&nbsp;人
					</div>
				</div>
				<div  style="width:66.6%; float:left;">
					<div style="float:left;width: 15%">
			...
			<div class="col-xs-10">
				<div  style="width:33.3%; float:left;">
					...
					<div style="float:left;width: 70%" >
						<input type="text" id="ageFirveStageTenderNum" name="userOperationReport.ageFirveStageTenderNum"  datatype="n1-9" errormsg="请输入9位以内的数"  class="positiveNumber" placeholder="" value="${operationreportCommonForm.userOperationReport.ageFirveStageTenderNum}"/>&nbsp;&nbsp;人
					</div>
				</div>
				<div  style="width:66.6%; float:left;">
					<div style="float:left;width: 15%">
			...
			<div class="col-xs-10">
				<div  style="width:33.3%; float:left;">
					...
					<div style="float:left;width: 70%" >
						<input type="text" id="amountFirstStageTenderNum" name="userOperationReport.amountFirstStageTenderNum"  datatype="n1-9" errormsg="请输入9位以内的数" class="positiveNumber" placeholder="" value="${operationreportCommonForm.userOperationReport.amountFirstStageTenderNum}"/>&nbsp;&nbsp;人
					</div>
				</div>
				<div  style="width:66.6%; float:left;">
					<div style="float:left;width: 15%">
			...
			<div class="col-xs-10">
				<div  style="width:33.3%; float:left;">
					...
					<div style="float:left;width: 70%" >
						<input type="text" id="amountSecondStageTenderNum" name="userOperationReport.amountSecondStageTenderNum"  datatype="n1-9" errormsg="请输入9位以内的数" class="positiveNumber" placeholder="" value="${operationreportCommonForm.userOperationReport.amountSecondStageTenderNum}" />&nbsp;&nbsp;人
					</div>
				</div>
				<div  style="width:66.6%; float:left;">
					<div style="float:left;width: 15%">
			...
			<div class="col-xs-10">
				<div  style="width:33.3%; float:left;">
					...
					<div style="float:left;width: 70%" >
						<input type="text" id="amountThirdStageTenderNum" name="userOperationReport.amountThirdStageTenderNum" datatype="n1-9" errormsg="请输入9位以内的数" class="positiveNumber" placeholder="" value="${operationreportCommonForm.userOperationReport.amountThirdStageTenderNum}" />&nbsp;&nbsp;人
					</div>
				</div>
				<div  style="width:66.6%; float:left;">
					<div style="float:left;width: 15%">
			...
			<div class="col-xs-10">
				<div  style="width:33.3%; float:left;">
					...
					<div style="float:left;width: 70%" >
						<input type="text" id="amountFourthStageTenderNum" name="userOperationReport.amountFourthStageTenderNum"  datatype="n1-9" errormsg="请输入9位以内的数" class="positiveNumber" placeholder="" value="${operationreportCommonForm.userOperationReport.amountFourthStageTenderNum}" />&nbsp;&nbsp;人
					</div>
				</div>
				<div  style="width:66.6%; float:left;">
					<div style="float:left;width: 15%">
			...
			<div class="col-xs-10">
				<div  style="width:33.3%; float:left;">
					...
					<div style="float:left;width: 70%" >
						<input type="text" id="amountFirveStageTenderNum" name="userOperationReport.amountFirveStageTenderNum"  datatype="n1-9" errormsg="请输入9位以内的数" class="positiveNumber" placeholder="" value="${operationreportCommonForm.userOperationReport.amountFirveStageTenderNum}" />&nbsp;&nbsp;人
					</div>
				</div>
				<div  style="width:66.6%; float:left;">
					<div style="float:left;width: 15%">
	...
	<div class="form-group">
		<div  class="text col-xs-10">
			<h5><font size="4px" style="margin:0px 0px 0px 0px"><b>年度之最</b></font></h5>
			<div  class="text">
			...
			<div class="col-xs-10">
				...
				<div  style="width:66.6%; float:left;">
					...
					<div style="float:left;width: 85%" >
						<input type="text" id="activeTenderNum" name="tenthOperationReport.activeTenderNum" class="positiveNumber" datatype="n1-15" errormsg="请输入15位以内的数"  placeholder="" value="${operationreportCommonForm.tenthOperationReport.activeTenderNum}" />&nbsp;&nbsp;次
					</div>
				</div>
	...
	<div class="form-group">
		...
		<div class="col-xs-10">
			...
			<div  style="width:33.3%; float:left;">
				...
				<div style="float:left;width: 70%" >
					<input type="text"  name="yearOperationReport.phoneNum" class="positiveNumber" datatype="n1-15" errormsg="请输入15位以内的数"  value="${operationreportCommonForm.yearOperationReport.phoneNum}" />&nbsp;&nbsp;个
				</div>
			...
			<div  style="width:66.6%; float:left;">
				...
				<div style="float:left;width: 85%" >
					<input  type="text" name="yearOperationReport.qqCustomerServiceNum" class="positiveNumber" datatype="n1-15" errormsg="请输入15位以内的数" value="${operationreportCommonForm.yearOperationReport.qqCustomerServiceNum}"  />&nbsp;&nbsp;人
				</div>
			</div>
		...
		<div class="col-xs-10">
			<div  style="width:33.3%; float:left;">
				...
				<div style="float:left;width: 70%" >
					<input  type="text" name="yearOperationReport.wechatCustomerServiceNum" class="positiveNumber" datatype="n1-15" errormsg="请输入15位以内的数"  value="${operationreportCommonForm.yearOperationReport.wechatCustomerServiceNum}" />&nbsp;&nbsp;人
				</div>
			...
			<div  style="width:66.6%; float:left;">
				...
				<div style="float:left;width: 85%" >
					<input type="text"  name="yearOperationReport.dealQuestionNum" class="positiveNumber" datatype="n1-9" errormsg="请输入9位以内的数"  value="${operationreportCommonForm.yearOperationReport.dealQuestionNum}"  />&nbsp;&nbsp;个
				</div>
			</div>
		</div>
	</div>
				...
				<div class="col-xs-10">
					<div style="min-width: 1400px;min-height: 50px;">
						...
						<div style="float: left;margin:30px 0px 0px 20px;">
							<input type="text"  name="wonderfulActivities[0].activtyName"  class="form-control wonderfulActivitiesActivtyName"/>
						</div>
