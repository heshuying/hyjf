$(function(){
    var validatError=$("#myQuarterform").Validform({
        tiptype:3,
        postonce:true,
        showAllError:true
    });
    ...
    $(".addActiveActive").click(function(){
        ...
        var str ='<div style="margin: 10px 0px 20px 20px;" class="row wondActivity col-xs-10">'
            ...
            +'</div>'
            +'<div  style="float:right;margin:-40px 280px 0px 800px" class="deleteWonderfulActivity">'
...
//添加活动
    ...
    $("#publishSubmit").click(function(){
        $("#isRelease").val(1);
        $("#myQuarterform").action="quarterOperationReportSaveAction";
    ...
    $("#addPreview").click(function(){
        ...
        if(yearInput == ""){
            ...
            $.ajax({
                url : webPath+"/manager/content/operationreport/previewQuarterAction" ,//url
                type : "POST",
                dataType: "json",//预期服务器返回的数据类型
                data :  $('#myQuarterform').serialize(),
                success : function(data) {
                    if (data!=null||data!="") {
                        var res=eval(data);
                        var operationReportId= res.operationId;
                        var quarterOperationReportId=res.quarterOperationReportId;
                        ...
                        if($("#operationReportId").val() != null||$("#operationReportId").val() != ""){
                            ...
                            $("#quarterOperationReportId").val(quarterOperationReportId);
