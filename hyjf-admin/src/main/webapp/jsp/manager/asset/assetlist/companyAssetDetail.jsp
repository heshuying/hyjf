								...
								<div class="row clearfix">
									<div class="col-md-6 column">
										...
										<div class = "title"><span>基础信息 </span></div>
											<ul>
												<li><span>企业名称</span><span class = "fontContent">${detailForm.borrowCompanyName}</span></li>
												<li><span>注册地区</span><span class = "fontContent">${detailForm.registrationArea}</span></li>
												<li><span>注册资本</span><span class = "fontContent">${detailForm.registeredCapital}</span></li>
												<li><span>所属行业</span><span class = "fontContent">${detailForm.industryInvolved}</span></li>
												<li><span>注册时间</span><span class = "fontContent">${detailForm.registrationDate}</span></li>
												<li><span>法人代表</span><span class = "fontContent">${detailForm.legalPerson}</span></li>
												<li><span>统一社会信用代码</span><span class = "fontContent">${detailForm.unifiedSocialCreditCode}</span></li>
												<li><span>主营业务</span><span class = "fontContent">${detailForm.mainBusiness}</span></li>
											</ul>
										<div class = "clearFloat"></div>
										<div class = "ulStyle width100">
										<div class = "title"><span>项目介绍 </span></div>
											<ul>
												...
												<%-- <li><span>营业收入</span><span class = "fontContent">${detailForm.financialSituation}</span></li> --%>
												...
												<li><span>财务状况</span><br/>
													<span class = "fontContent">${detailForm.financialSituation}</span></li>
											</ul>
											<div class = "clearFloat"></div>
										<div class = "ulStyle width100">
										<div class = "title"><span>信用状况</span></div>
											<ul>
												...
												<li><span>信用评级</span><span class = "fontContent">AA</span></li>
											</ul>
										<div class = "clearFloat"></div>
										<div class = "ulStyle width100">
