...
Action = {
	// 查找的Action
	searchOpportunityAction : "searchOpportunityAction",
	// 导出的Action
	exportOpportunityAction : "exportOpportunityAction"
},
/* 事件动作处理 */
Events = {
	// 查找按钮的单击事件绑定
	searchClkAct : function(selection, cds) {
		...
		Page.submit(Action.searchOpportunityAction);
	},
	// 重置表单
	...
	exportClkAct: function(event) {
		...
		$("#paginator-page").val(1);
		Page.submit(Action.exportOpportunityAction);
	},
	// 刷新按钮的单击动作事件
