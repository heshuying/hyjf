...
<tiles:insertTemplate template="/jsp/layout/dialogLayout.jsp"
			...
			<div class="panel-body" style="margin: 0 auto">
				<form id="mainForm" method="post" role="form" action="updateAction" target="_parent">
					<div class="row center">
						<input type="hidden" name="id" id="id" value="${qixiactivityListForm.id }" />
						<div class="form-group">
							<div class="center">
								<input type="radio" value="0" name="rewardStatus" <c:if test="${ qixiactivityListForm.rewardStatus == '0'}">checked="checked"</c:if>>待发放&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<input type="radio" value="1" name="rewardStatus" <c:if test="${ qixiactivityListForm.rewardStatus == '1' }">checked="checked"</c:if>>已发放
							</div>
							<br/>
						</div>
					</div>
	...
	<tiles:putAttribute name="pageJavaScript" type="string">
		<script type='text/javascript'
				src="${webRoot}/jsp/manager/activity/qixiactivity2018/qixiactivityawardinfo.js"></script>
	</tiles:putAttribute>
