...
<shiro:hasPermission name="activitylist:VIEW">
    <tiles:insertTemplate template="/jsp/layout/listLayout.jsp" flush="true">
            ...
            <div class="container-fluid container-fullw bg-white">
                <div class="tabbable">
                    <ul class="nav nav-tabs" id="myTab">
                        <shiro:hasPermission name="activitylist:VIEW">
                            <li class="active"><a href="${webRoot}/manager/activity/twoeleven2018/init">秒杀明细</a></li>
                        </shiro:hasPermission>
                        <shiro:hasPermission name="activitylist:VIEW">
                            <li><a href="${webRoot}/manager/activity/twoeleven2018/investInit">累计年化出借金额</a></li>
                        </shiro:hasPermission>
                        <shiro:hasPermission name="activitylist:VIEW">
                            <li><a href="${webRoot}/manager/activity/twoeleven2018/rewardInit">奖励(新款iphone)明细</a></li>
                        </shiro:hasPermission>
                    </ul>
                        ...
                        <div class="tab-pane fade in active">
                            ...
                            <table id="equiList" class="table table-striped table-bordered table-hover">
                                ...
                                <tr>
                                    ...
                                    <th class="center">
                                        <c:choose>
                                            <c:when test="${ !empty twoelevenForm.sort and twoelevenForm.col eq 'tr.seconds_time' }">
                                                <a href="#" class="fn-Sort" data-col="tr.seconds_time" data-sort="${twoelevenForm.sort}" style="color:black;">秒杀时间</a>&nbsp;<i class="fa fa-sort"></i>
                                            </c:when>
                                            <c:otherwise>
                                                <a href="#" class="fn-Sort" data-col="tr.seconds_time" data-sort="DESC" style="color:black;">秒杀时间</a>&nbsp;<i class="fa fa-sort"></i>
                                            </c:otherwise>
                                        </c:choose>
                                            <%--出借时间--%>
                                    </th>
                                    ...
                                    <c:otherwise>
                                        <c:forEach items="${twoelevenForm.recordList }" var="record" begin="0" step="1" varStatus="status">
                                            <tr>
                                                ...
                                                <td class="center">
                                                    <c:out value="${record.rewardType}"></c:out>
                                                </td>
                                                ...
                                                <td class="center">
                                                     <c:out value="${record.secondsTime }"></c:out>
                                                </td>
                                                <td class="center">
                                ...
                                <%-- 分页栏 --%>
                            <hyjf:paginator id="equiPaginator" hidden="paginator-page" action="init" paginator="${twoelevenForm.paginator}"></hyjf:paginator>
                            <br/><br/>
                        </div>
                    </div>
                </div>
        ...
        <tiles:putAttribute name="searchPanels" type="string">
            ...
            <div class="form-group">
                ...
                <select name="rewardType" class="form-control underline form-select2">
                    ...
                    <option value="加息券" <c:if test="${twoelevenForm.rewardType == '加息券'}">selected="selected"</c:if>>加息券</option>
                    <option value="代金券" <c:if test="${twoelevenForm.rewardType == '代金券'}">selected="selected"</c:if>>代金券</option>
                </select>
            </div>
            <div class="form-group">
                <label>奖励批号:</label>
                <input type="text" name="rewardId" id="rewardId" class="form-control underline" value="${twoelevenForm.rewardId}" />
            </div>
            <div class="form-group">
                <label>状态：</label>
        ...
        <tiles:putAttribute name="pageJavaScript" type="string">
            <script type='text/javascript' src="${webRoot}/jsp/manager/activity/twoeleven2018/seckill.js"></script>
        </tiles:putAttribute>
