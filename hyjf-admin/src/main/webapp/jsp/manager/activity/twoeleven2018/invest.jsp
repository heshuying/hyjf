...
<shiro:hasPermission name="activitylist:VIEW">
    <tiles:insertTemplate template="/jsp/layout/listLayout.jsp" flush="true">
        ...
        <tiles:putAttribute name="pageFunCaption" type="string">
            <h1 class="mainTitle">累计额年化出借金额</h1>
            ...
            <div class="container-fluid container-fullw bg-white">
                <div class="tabbable">
                    <ul class="nav nav-tabs" id="myTab">
                        ...
                        <shiro:hasPermission name="activitylist:VIEW">
                            <li class="active"><a href="${webRoot}/manager/activity/twoeleven2018/investInit">累计年化出借金额</a></li>
                        </shiro:hasPermission>
                        <shiro:hasPermission name="activitylist:VIEW">
                        ...
                        <div class="tab-pane fade in active">
                            ...
                            <table id="equiList" class="table table-striped table-bordered table-hover">
                                ...
                                <tr>
                                    ...
                                    <th class="center">
                                        <c:choose>
                                            <c:when test="${ !empty twoelevenForm.sort and twoelevenForm.col eq 'year_amount_all' }">
                                                <a href="#" class="fn-Sort" data-col="year_amount_all" data-sort="${twoelevenForm.sort}" style="color:black;">累计年化出借金额(元)</a>&nbsp;<i class="fa fa-sort"></i>
                                            </c:when>
                                            <c:otherwise>
                                                <a href="#" class="fn-Sort" data-col="year_amount_all" data-sort="DESC" style="color:black;">累计年化出借金额(元)</a>&nbsp;<i class="fa fa-sort"></i>
                                            </c:otherwise>
                                        </c:choose>
                                    </th>
                                    <th class="center">
                                    ...
                                    <c:otherwise>
                                        <c:forEach items="${twoelevenForm.recordList }" var="record" begin="0" step="1" varStatus="status">
                                            <tr>
                                                ...
                                                <td class="center"><c:out value="${record.yearAmountAll }"></c:out></td>
                                                <td class="center">
                                ...
                                <%-- 分页栏 --%>
                            <hyjf:paginator id="equiPaginator" hidden="paginator-page" action="investInit" paginator="${twoelevenForm.paginator}"></hyjf:paginator>
                            <br/><br/>
                        </div>
                    </div>
                </div>
        ...
        <tiles:putAttribute name="pageJavaScript" type="string">
            <script type='text/javascript' src="${webRoot}/jsp/manager/activity/twoeleven2018/invest.js"></script>
        </tiles:putAttribute>
