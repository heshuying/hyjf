...
<tiles:insertTemplate template="/jsp/layout/listLayout.jsp" flush="true">
	...
	<div class="container-fluid container-fullw bg-white">
		<div class="tabbable">
			<ul class="nav nav-tabs" id="myTab">
				<li class="active"><a href="javascript:void(0);">未返现列表</a></li>
				<shiro:hasPermission name="returnedcashlist:VIEW">
				<li><a href="${webRoot}/activity/returncash/returnedcash">已返现列表</a></li>
				</shiro:hasPermission>
			</ul>
			<div class="tab-content">
				<div class="tab-pane fade in active">
					...
					<div class="well">
						...
						<span style="font-weight:bold;"> &nbsp;&nbsp;&nbsp;累计待奖励金额：${rewardTotal }</span>
						</shiro:hasPermission>
								...
								<c:otherwise>
									<c:forEach items="${returncashForm.recordList }" var="record" begin="0" step="1" varStatus="status">
										<tr>
											...
											<td class="text-right"><fmt:formatNumber value="${record.investTotalActivity}" type="number" pattern="#" /></td>
											<td class="text-right"><c:out value="${record.hasLostreward==1?'是':'否' }"></c:out></td>
											<td class="text-right"><c:out value="${record.orderId }" /></td>
											<td class="text-right"><fmt:formatNumber value="${record.rewardTotal}" type="number" pattern="#" /></td>
											<td class="center">
											    <c:if test="${showButton}">
											    <c:if test="${record.rewardTotal > 0}">
												<shiro:hasPermission name="returncashlist:RETURNCASH">
												<div class="visible-md visible-lg hidden-sm hidden-xs">
													<a class="btn btn-transparent btn-xs fn-Returncash" data-toggle="tooltip" data-id="${record.userId }" data-rewardTotal="${record.rewardTotal }" tooltip-placement="top" data-original-title="返现"><i class="fa fa-mail-reply "></i></a>
												</div>
												<div class="visible-xs visible-sm hidden-md hidden-lg">
													<div class="btn-group" dropdown="">
														...
														<ul class="dropdown-menu pull-right dropdown-light" role="menu">
															<li><a class="fn-Returncash" data-id="" data-type="">返现</a></li>
														</ul>
													</div>
												</div>
												</shiro:hasPermission>
	...
	<tiles:putAttribute name="pageJavaScript" type="string">
		...
		<script type='text/javascript' src="${webRoot}/jsp/manager/activity/returncash/returncash.js"></script>
	</tiles:putAttribute>
