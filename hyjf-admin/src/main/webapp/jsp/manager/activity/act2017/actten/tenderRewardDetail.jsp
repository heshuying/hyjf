...
<c:set var="searchAction" value="#" scope="request"></c:set>
	...
	<tiles:insertTemplate template="/jsp/layout/listLayout.jsp" flush="true">
				...
				<div class="tab-content">
					<div class="tab-pane fade in active">
							...
							<shiro:hasPermission name="activitylist:SEARCH">
								<hyjf:paginator id="equiPaginator" hidden="paginator-page" action="searchActionDetail" paginator="${tenderRewardListForm.paginator}"></hyjf:paginator>
							</shiro:hasPermission>
							<br/><br/>
					</div>
				</div>
		...
		<tiles:putAttribute name="searchPanels" type="string">
			...
			<input type="hidden" name="userId" value="${tenderRewardListForm.userId }" /> 
			<shiro:hasPermission name="activitylist:SEARCH">
		...
		<tiles:putAttribute name="pageJavaScript" type="string">
			<script type='text/javascript' src="${webRoot}/jsp/manager/activity/act2017/actten/tenderRewardDetail.js"></script>
		</tiles:putAttribute>
