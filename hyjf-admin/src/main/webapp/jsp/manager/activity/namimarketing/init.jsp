...
<shiro:hasPermission name="activitylist:VIEW">
    <tiles:insertTemplate template="/jsp/layout/listLayout.jsp" flush="true">
            ...
            <div class="container-fluid container-fullw bg-white">
                <div class="tabbable">
                    <ul class="nav nav-tabs" id="myTab">
                        <shiro:hasPermission name="activitylist:VIEW">
                            <li class="active"><a href="${webRoot}/manager/activity/namimarketing/init">邀请明细</a></li>
                        </shiro:hasPermission>
                        <shiro:hasPermission name="activitylist:VIEW">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade in active">
                            ...
                            <table id="equiList" class="table table-striped table-bordered table-hover" style="font-size: 13px;">
                                    ...
                                    <th class="center">
                                        <c:choose>
                                            <c:when test="${ !empty naMiMarketingForm.sort }">
                                                <a href="#" class="fn-Sort" data-col="tr.seconds_time" data-sort="${naMiMarketingForm.sort}" style="color:black;">注册日期时间</a>&nbsp;<i class="fa fa-sort"></i>
                                            </c:when>
                                            <c:otherwise>
                                                <a href="#" class="fn-Sort"  data-col="tr.seconds_time" data-sort="DESC" style="color:black;">注册日期时间</a>&nbsp;<i class="fa fa-sort"></i>
                                            </c:otherwise>
                                        </c:choose>
                                            <%--投资时间--%>
                                    </th>
                                ...
                                <%-- 分页栏 --%>
                            <hyjf:paginator id="equiPaginator" hidden="paginator-page" action="init" paginator="${naMiMarketingForm.paginator}"></hyjf:paginator>
                            <br/><br/>
                        </div>
                    </div>
                </div>
        ...
        <tiles:putAttribute name="pageJavaScript" type="string">
            <script type='text/javascript' src="${webRoot}/jsp/manager/activity/namimarketing/init.js"></script>
        </tiles:putAttribute>
