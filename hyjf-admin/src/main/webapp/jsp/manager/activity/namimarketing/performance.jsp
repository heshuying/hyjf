...
<shiro:hasPermission name="activitylist:VIEW">
    <tiles:insertTemplate template="/jsp/layout/listLayout.jsp" flush="true">
        ...
        <tiles:putAttribute name="pageFunCaption" type="string">
            <h1 class="mainTitle">年化业绩返现详情</h1>
            ...
            <div class="container-fluid container-fullw bg-white">
                <div class="tabbable">
                    <ul class="nav nav-tabs" id="myTab">
                        ...
                        <shiro:hasPermission name="activitylist:VIEW">
                            <li class="active"><a href="${webRoot}/manager/activity/namimarketing/performanceInit" id="performanceInit" onclick="getPerformanceInit()">年化业绩返现详情</a></li>
                        </shiro:hasPermission>
                        <shiro:hasPermission name="activitylist:VIEW">
                        ...
                        <div class="tab-pane fade in active">
                            ...
                            <table id="equiList" class="table table-striped table-bordered table-hover" style="font-size: 13px;">
                                ...
                                <tr>
                                    ...
                                    <th class="center">单笔返现金额（元）</th>
                                    <th class="center">单笔返现详情</th>
                                    <th class="center">
                                        <c:choose>
                                            <c:when test="${ !empty naMiMarketingForm.sort }">
                                                <a href="#" class="fn-Sort" data-col="tr.seconds_time" data-sort="${naMiMarketingForm.sort}" style="color:black;">放款时间/加入时间</a>&nbsp;<i class="fa fa-sort"></i>
                                            </c:when>
                                            <c:otherwise>
                                                <a href="#" class="fn-Sort"  data-col="tr.seconds_time" data-sort="DESC" style="color:black;">放款时间/加入时间</a>&nbsp;<i class="fa fa-sort"></i>
                                            </c:otherwise>
                                        </c:choose>
                                    </th>
                                </tr>
                                    ...
                                    <c:otherwise>
                                        <c:forEach items="${recordList }" var="record" begin="0" step="1" varStatus="status">
                                            <tr>
                                                ...
                                                <td class="center">
                                                    <a class="fn-Info" data-id="${record.id }">查看</a>
                                                </td>
                                                <td class="center">
                                ...
                                <%-- 分页栏 --%>
                            <hyjf:paginator id="equiPaginator" hidden="paginator-page" action="performanceInit" paginator="${naMiMarketingForm.paginator}"></hyjf:paginator>
                            <br/><br/>
                        </div>
                    </div>
                </div>
        ...
        <tiles:putAttribute name="pageJavaScript" type="string">
            <script type='text/javascript' src="${webRoot}/jsp/manager/activity/namimarketing/performance.js"></script>
        </tiles:putAttribute>
