...
Events = {
	...
	//查询配置单机事件
	queryClkAct : function(event) {
		Page.confirm("", "确定要查询配置信息吗？", function(isConfirm) {
			isConfirm && Page.submit(Action.queryAction);
		})
	},
...
$.extend(Page, {
	...
	initEvents : function() {
		...
		$(".fn-Query").click(Events.queryClkAct),	
		// 边界面板查询按钮的单击事件绑定
