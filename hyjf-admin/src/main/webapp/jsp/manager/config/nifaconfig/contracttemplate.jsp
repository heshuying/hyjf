...
<shiro:hasPermission name="nifaconfig:VIEW">
	<tiles:insertTemplate template="/jsp/layout/listLayout.jsp" flush="true">
				...
				<div class="tabbable">
					<ul class="nav nav-tabs" id="myTab">
						<shiro:hasPermission name="nifaconfig:SEARCH">
							<li ><a href="${webRoot}/manager/config/nifaconfig/init">修改字段定义</a></li>
						</shiro:hasPermission>
						<shiro:hasPermission name="nifaconfig:SEARCH">
							<li class="active"><a href="${webRoot}/manager/config/nifaconfig/initContract">合同模板条款</a></li>
						</shiro:hasPermission>
				    </ul>
							...
							<div class="row">
								<div class="col-md-12">
									<div class="search-classic">
												...
												<c:choose>
													...
													<c:otherwise>
														<c:forEach items="${nifaconfigForm.recordList}" var="record" begin="0" step="1" varStatus="status">
															<tr>
																<td class="center">${(nifaconfigForm.paginatorPage-1)*nifaconfigForm.paginator.limit+status.index+1 }</td>
																<td class="center"><c:out value="${record.templetNid }"></c:out></td>
																<%--<td class="center"><hyjf:datetime value="${record.updateDate}"></hyjf:datetime></td>ss--%>
																...
																<td class="center">
																	<div class="visible-md visible-lg hidden-sm hidden-xs">
																		...
																		<shiro:hasPermission name="nifaconfig:DELETE">
										...
										<%-- 分页栏 --%>
										<hyjf:paginator id="equiPaginator" hidden="paginator-page" action="accountlist" paginator="${nifaconfigForm.paginator}"></hyjf:paginator>
										<br/><br/>
									</div>
								</div>
							</div>
		...
		<tiles:putAttribute name="searchPanels" type="string">
			<input type="hidden" name="ids" id="ids" value= "${nifaconfigForm.ids}"/>
		</tiles:putAttribute>
		<%-- 对话框面板 (ignore) --%>
		...
		<tiles:putAttribute name="pageJavaScript" type="string">
			<script type='text/javascript' src="${webRoot}/jsp/manager/config/nifaconfig/contracttemplate.js"></script>
		</tiles:putAttribute>
