...
<shiro:hasPermission name="hjhstatis:VIEW">
	<tiles:insertTemplate template="/jsp/layout/listLayout.jsp"
		flush="true">
		<%-- 画面的标题 --%>
		<tiles:putAttribute name="pageTitle" value="每日交易量" />
			...
			<div class="container-fluid container-fullw bg-white">
				<div class="tabbable">
					<ul class="nav nav-tabs" id="myTab">
						<shiro:hasPermission name="hjhstatis:VIEW">
							<li class="active"><a href="${webRoot}/manager/statis/init">每日交易量</a></li>
						</shiro:hasPermission>
						<shiro:hasPermission name="hjhstatis:VIEW">
							<li><a href="${webRoot}/manager/statis/init?time=month">每月交易量</a></li>
						</shiro:hasPermission>
					</ul>
		...
		<tiles:putAttribute name="pageJavaScript" type="string">
			<script type='text/javascript'
				src="${webRoot}/jsp/manager/statis/hjhAccountBalance.js"></script>
		</tiles:putAttribute>
