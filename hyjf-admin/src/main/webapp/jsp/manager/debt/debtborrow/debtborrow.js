...
Action = {
	...
	// 详细画面的Action
	infoAction : webRoot + "/manager/debt/debtborrowcommon/infoAction",
	// 详细画面的Action
	infoConsumeAction : webRoot + "/manager/borrow/consume/infoAction",
	// 出借明细画面的Action
	tenderInfoAction : webRoot + "/manager/debt/debtborrowinvest/init?fid=ea2615b5-bf23-423b-861f-af29a8ce11f9",
	// 预览的Action
