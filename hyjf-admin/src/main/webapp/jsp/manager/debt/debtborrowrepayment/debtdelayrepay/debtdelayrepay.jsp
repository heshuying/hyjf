...
<tiles:insertTemplate template="/jsp/layout/dialogLayout.jsp" flush="true">
					...
					<fieldset>
						...
						<div class="row">
							...
							<div class="col-md-12">
								...
								<div class="col-xs-6">
									<div class="form-group">
										<label> <strong>管理费：</strong> <fmt:formatNumber value="${repayInfo.manageFee }" pattern="#,##0.0#" />元
										</label>
									</div>
								</div>
							</div>
	...
	<tiles:putAttribute name="pageJavaScript" type="string">
		...
		<script type='text/javascript' src="${webRoot}/jsp/manager/debt/debtborrowrepayment/debtdelayrepay/debtdelayrepay.js"></script>
	</tiles:putAttribute>
