...
<tiles:insertTemplate template="/jsp/layout/dialogLayout.jsp" flush="true">
				...
				<form id="mainForm" action="uploadAction"
					...
					<div class="panel-scroll height-340 margin-bottom-15">
						<div class="user-edit-image-buttons">
									<span class="btn btn-azure btn-file"><span class="fileinput-new"><i class="fa fa-picture"></i> 上传csv文件</span>
	...
	<tiles:putAttribute name="pageJavaScript" type="string">
		...
		<script type='text/javascript' src="${webRoot}/jsp/coupon/user/impDistribute.js"></script>
	</tiles:putAttribute>
