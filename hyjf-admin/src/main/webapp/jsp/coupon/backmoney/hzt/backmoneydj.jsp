...
<shiro:hasPermission name="HZTBACKMONEYDJ:VIEW">
	<tiles:insertTemplate template="/jsp/layout/listLayout.jsp" flush="true">
		<%-- 画面的标题 --%>
		<tiles:putAttribute name="pageTitle" value="优惠券回款-代金券" />

		<%-- 画面主面板的标题块 --%>
		<tiles:putAttribute name="pageFunCaption" type="string">
			<h1 class="mainTitle">优惠券回款-代金券</h1>
		...
		<div class="container-fluid container-fullw bg-white">
			...
			<ul class="nav nav-tabs" id="myTab"> 
				<shiro:hasPermission name="HZTBACKMONEYTY:VIEW">
		      		<li><a href="${webRoot}/coupon/backmoneyty/hzt/init">体验金</a></li>
		      	</shiro:hasPermission>
		      	<shiro:hasPermission name="HZTBACKMONEYJX:VIEW">
		      		<li><a href="${webRoot}/coupon/backmoneyjx/hzt/init">加息券</a></li>
		      	</shiro:hasPermission>
		      	<shiro:hasPermission name="HZTBACKMONEYDJ:VIEW">
		      		<li  class="active"><a href="${webRoot}/coupon/backmoneydj/hzt/init">代金券</a></li>
		      	</shiro:hasPermission>
		    </ul>
		...
		<tiles:putAttribute name="pageJavaScript" type="string">
			<script type='text/javascript' src="${webRoot}/jsp/coupon/backmoney/hzt/backmoneydj.js"></script>
		</tiles:putAttribute>
