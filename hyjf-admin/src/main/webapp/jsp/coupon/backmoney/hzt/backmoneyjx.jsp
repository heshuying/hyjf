...
<shiro:hasPermission name="HZTBACKMONEYJX:VIEW">
	<tiles:insertTemplate template="/jsp/layout/listLayout.jsp" flush="true">
		...
		<div class="container-fluid container-fullw bg-white">
			...
			<ul class="nav nav-tabs" id="myTab"> 
				<shiro:hasPermission name="HZTBACKMONEYTY:VIEW">
		      	...
		      	<shiro:hasPermission name="HZTBACKMONEYJX:VIEW">
		      		<li  class="active"><a href="${webRoot}/coupon/backmoneyjx/hzt/init">加息券</a></li>
		      	</shiro:hasPermission>
			...
			<div class="tab-content">
				<div class="tab-pane fade in active">
					...
					<div class="well">
						...
						<shiro:hasPermission name="HZTBACKMONEYJX:EXPORT">
		...
		<tiles:putAttribute name="pageJavaScript" type="string">
			<script type='text/javascript' src="${webRoot}/jsp/coupon/backmoney/hzt/backmoneyjx.js"></script>
		</tiles:putAttribute>
