	...
	<tiles:insertTemplate template="/jsp/layout/listLayout.jsp" flush="true">
		...
		<div class="container-fluid container-fullw bg-white">
			...
			<ul class="nav nav-tabs" id="myTab"> 
				<shiro:hasPermission name="HTJBACKMONEYTY:VIEW">
		      		<li class="active"><a href="${webRoot}/coupon/backmoneyty/htj/init">体验金</a></li>
		      	</shiro:hasPermission>
		      	<shiro:hasPermission name="HTJBACKMONEYJX:VIEW">
		      		<li><a href="${webRoot}/coupon/backmoneyjx/htj/init">加息券</a></li>
		      	</shiro:hasPermission>
			...
			<div class="tab-content">
				<div class="tab-pane fade in active">
					...
					<div class="well">
						...
						<shiro:hasPermission name="HTJBACKMONEYTY:EXPORT">
		...
		<tiles:putAttribute name="pageJavaScript" type="string">
			<script type='text/javascript' src="${webRoot}/jsp/coupon/backmoney/htj/backmoneyty.js"></script>
		</tiles:putAttribute>
