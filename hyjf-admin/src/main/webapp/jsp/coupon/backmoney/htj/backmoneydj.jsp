...
<shiro:hasPermission name="HTJBACKMONEYDJ:VIEW">
	<tiles:insertTemplate template="/jsp/layout/listLayout.jsp" flush="true">
		...
		<div class="container-fluid container-fullw bg-white">
			...
			<ul class="nav nav-tabs" id="myTab"> 
				<shiro:hasPermission name="HTJBACKMONEYTY:VIEW">
		      	...
		      	<shiro:hasPermission name="HTJBACKMONEYDJ:VIEW">
		      		<li  class="active"><a href="${webRoot}/coupon/backmoneydj/htj/init">代金券</a></li>
		      	</shiro:hasPermission>
		    </ul>
			<div class="tab-content">
				<div class="tab-pane fade in active">
					...
					<div class="well">
						...
						<shiro:hasPermission name="HTJBACKMONEYDJ:EXPORT">
		...
		<tiles:putAttribute name="pageJavaScript" type="string">
			<script type='text/javascript' src="${webRoot}/jsp/coupon/backmoney/htj/backmoneydj.js"></script>
		</tiles:putAttribute>
