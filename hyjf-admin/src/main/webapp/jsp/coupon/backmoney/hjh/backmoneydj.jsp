...
<shiro:hasPermission name="HJHBACKMONEYDJ:VIEW">
	<tiles:insertTemplate template="/jsp/layout/listLayout.jsp" flush="true">
		...
		<div class="container-fluid container-fullw bg-white">
			...
			<ul class="nav nav-tabs" id="myTab"> 
				<shiro:hasPermission name="HJHBACKMONEYTY:VIEW">
		      		<li><a href="${webRoot}/coupon/backmoneyty/hjh/init">体验金</a></li>
		      	</shiro:hasPermission>
		      	<shiro:hasPermission name="HJHBACKMONEYJX:VIEW">
		      		<li><a href="${webRoot}/coupon/backmoneyjx/hjh/init">加息券</a></li>
		      	</shiro:hasPermission>
		      	<shiro:hasPermission name="HJHBACKMONEYDJ:VIEW">
		      		<li  class="active"><a href="${webRoot}/coupon/backmoneydj/hjh/init">代金券</a></li>
		      	</shiro:hasPermission>
		    </ul>
			<div class="tab-content">
				<div class="tab-pane fade in active">
					...
					<div class="well">
						...
						<shiro:hasPermission name="HJHBACKMONEYDJ:EXPORT">
		...
		<tiles:putAttribute name="pageJavaScript" type="string">
			<script type='text/javascript' src="${webRoot}/jsp/coupon/backmoney/hjh/backmoneydj.js"></script>
		</tiles:putAttribute>
