...
<shiro:hasPermission name="HJHBACKMONEYTY:VIEW">
	<tiles:insertTemplate template="/jsp/layout/listLayout.jsp" flush="true">
		...
		<div class="container-fluid container-fullw bg-white">
			...
			<ul class="nav nav-tabs" id="myTab"> 
				<shiro:hasPermission name="HJHBACKMONEYTY:VIEW">
		      		<li class="active"><a href="${webRoot}/coupon/backmoneyty/hjh/init">体验金</a></li>
		      	</shiro:hasPermission>
		      	<shiro:hasPermission name="HJHBACKMONEYJX:VIEW">
		      		<li><a href="${webRoot}/coupon/backmoneyjx/hjh/init">加息券</a></li>
		      	</shiro:hasPermission>
		      	<shiro:hasPermission name="HJHBACKMONEYDJ:VIEW">
		      		<li><a href="${webRoot}/coupon/backmoneydj/hjh/init">代金券</a></li>
		      	</shiro:hasPermission>
		    </ul>
			<div class="tab-content">
				<div class="tab-pane fade in active">
					...
					<div class="well">
						...
						<shiro:hasPermission name="HZTBACKMONEYDJ:EXPORT">
					...
					<table id="equiList" class="table table-striped table-bordered table-hover">
						...
						<thead>
							<tr>
								...
								<th class="center">体验金面值</th>
								<th class="center">收益期限</th>
								...
								<c:otherwise>
									<c:forEach items="${recordList }" var="record"
										...
										<tr>
											...
											<td align="center"><fmt:formatNumber value="${record.recoverCapital}" type="number" pattern="#,##0.00#" /> </td>
											<td class="center"><c:out value="${record.couponQuota }"></c:out></td>
											<td class="center"><c:out value="${record.couponProfitTime }"></c:out></td>
											<td align="center"><fmt:formatNumber value="${record.recoverInterest}" type="number" pattern="#,##0.00#" /> </td>
									...
									<tr>
										...
										<td class="center"></td>
										<td class="center"></td>
										<td align="center"><fmt:formatNumber value="${recoverInterest}" type="number" pattern="#,##0.00#" /> </td>
										<td class="center"></td>
										<td class="center"></td>
										<td class="center"></td>
										<td class="center"></td>
		...
		<tiles:putAttribute name="pageJavaScript" type="string">
			<script type='text/javascript' src="${webRoot}/jsp/coupon/backmoney/hjh/backmoneyty.js"></script>
		</tiles:putAttribute>
