...
<shiro:hasPermission name="HJHBACKMONEYJX:VIEW">
	<tiles:insertTemplate template="/jsp/layout/listLayout.jsp" flush="true">
		...
		<div class="container-fluid container-fullw bg-white">
			...
			<ul class="nav nav-tabs" id="myTab"> 
				<shiro:hasPermission name="HJHBACKMONEYTY:VIEW">
		      	...
		      	<shiro:hasPermission name="HJHBACKMONEYJX:VIEW">
		      		<li  class="active"><a href="${webRoot}/coupon/backmoneyjx/hjh/init">加息券</a></li>
		      	</shiro:hasPermission>
			...
			<div class="tab-content">
				<div class="tab-pane fade in active">
					...
					<div class="well">
						...
						<shiro:hasPermission name="HJHBACKMONEYJX:EXPORT">
		...
		<tiles:putAttribute name="pageJavaScript" type="string">
			<script type='text/javascript' src="${webRoot}/jsp/coupon/backmoney/hjh/backmoneyjx.js"></script>
		</tiles:putAttribute>
