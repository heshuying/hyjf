	...
	<tiles:insertTemplate template="/jsp/layout/listLayout.jsp" flush="true">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="search-classic">
							<%-- 功能栏 --%>
							<shiro:hasPermission name="COUPONTENDERHTJ:SEARCH">
							<div class="well">
									...
									<shiro:hasPermission name="COUPONTENDERHTJ:EXPORT">
										...
										<c:otherwise>
											<c:forEach items="${recordList }" var="record" begin="0" step="1" varStatus="status">
												<tr>
													...
													<td align="center"><fmt:formatNumber value="${record.recoverAccountAll}" type="number" pattern="#,##0.00#" /> </td>
													...
													<td class="center">
														<div class="visible-md visible-lg hidden-sm hidden-xs">
															<shiro:hasPermission name="COUPONTENDERHTJ:INFO">
											...
											<td class="center">总计</td>
													...
													<td class="center"></td>
													<td class="center"></td>
													<td align="center"><fmt:formatNumber value="${recoverAccountTotal}" type="number" pattern="#,##0.00#" /> </td>
													<td class="center"></td>
													<td class="center"></td>
													<td class="center"></td>
													<td class="center"></td>
		...
		<tiles:putAttribute name="searchPanels" type="string">
			...
			<div class="form-group">
				<label>智投编号：</label>
				<input type="text" name="borrowNid" class="form-control input-sm underline"  maxlength="20" value="${ couponTenderForm.borrowNid}" />
			</div>
			<div class="form-group">
				<label>智投订单号</label>
		...
		<tiles:putAttribute name="pageJavaScript" type="string">
			<script type='text/javascript' src="${webRoot}/jsp/coupon/tender/htj/tender.js"></script>
		</tiles:putAttribute>
