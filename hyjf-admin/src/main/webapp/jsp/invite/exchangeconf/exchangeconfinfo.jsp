...
<tiles:insertTemplate template="/jsp/layout/dialogLayout.jsp"
					...
					<form id="mainForm"
						...
						<div class="form-group">
							<label class="col-xs-2 control-label" for="prizeQuantity"> <span
								class="symbol required"></span>数量
							</label>
							<div class="col-xs-10">
								<input type="text" placeholder="数量" id="prizeQuantity" name="prizeQuantity"
									value="${confForm.prizeQuantity}" class="form-control"
									datatype="n1-6" errormsg="数量只能是数字，长度1-6位数字！" maxlength="6">
								<hyjf:validmessage key="prizeQuantity" label="奖品数量"></hyjf:validmessage>
							</div>
						</div>
						<div class="form-group">
							<label class="col-xs-2 control-label" for="recommendQuantity"> <span
								class="symbol required"></span>所需推荐星
							</label>
							<div class="col-xs-10">
								<input type="text" placeholder="所需推荐星" id="recommendQuantity" name="recommendQuantity"
									value="${confForm.recommendQuantity}" class="form-control"
									datatype="n1-3" errormsg="所需推荐星只能是数字，长度1-3位数字！" maxlength="3">
								<hyjf:validmessage key="recommendQuantity" label="所需推荐星"></hyjf:validmessage>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<label class="col-xs-2 control-label" for="couponCode"> </span>备注
							</label>
							<div class="col-xs-10">
	...
	<tiles:putAttribute name="pageJavaScript" type="string">
		...
		<script type='text/javascript'
			src="${webRoot}/jsp/invite/exchangeconf/exchangeconfinfo.js"></script>
	</tiles:putAttribute>
