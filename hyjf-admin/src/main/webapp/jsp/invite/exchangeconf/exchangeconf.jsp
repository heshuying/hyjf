...
<shiro:hasPermission name="activitylist:VIEW">
	<tiles:insertTemplate template="/jsp/layout/listLayout.jsp" flush="true">
		...
		<tiles:putAttribute name="mainContentinner" type="string">
			...
			<div class="tabbable">
				<ul class="nav nav-tabs" id="myTab"> 
					...
					<shiro:hasPermission name="activitylist:VIEW">
						<li class="active"><a href="javascript:void(0);">兑换配置</a></li>
					</shiro:hasPermission>
					<shiro:hasPermission name="activitylist:VIEW">
							...
							<table id="equiList" class="table table-striped table-bordered table-hover">
								...
								<thead>
									<tr>
										...
										<th class="center" style="width:10%;">奖品名称</th>
										<th class="center" style="width:5%;">所需推荐星</th>
										<th class="center" style="width:10%;">奖品类型</th>
										<th class="center" style="width:10%;">奖品图片</th>
										<th class="center" style="width:5%;">排序</th>
										<th class="center" style="width:10%;">奖品总数量</th>
										<th class="center" style="width:10%;">已兑换数量</th>
										...
										<c:otherwise>
											<c:forEach items="${recordList }" var="record"
												...
												<tr>
													...
													<td class="center"><c:out value="${record.recommendQuantity }"></c:out></td>
		...
		<tiles:putAttribute name="pageJavaScript" type="string">
			<script type='text/javascript' src="${webRoot}/jsp/invite/exchangeconf/exchangeconf.js"></script>
		</tiles:putAttribute>
