...
Events = {
	...
	msgActionChgAct : function() {
		Page.validate.ignore("#messagesActionUrl1");// 使验证无效
		Page.validate.ignore("#messagesActionUrl2");// 使验证无效
        Page.validate.ignore("#messagesActionUrl3");// 使验证无效
		if ($("#msgAction").val() == "0") {// 打开APP
			$("#actionPanel0").show();
			$("#actionPanel1").hide();
			$("#actionPanel2").hide();
            $("#actionPanel3").hide();
			$("#messagesActionUrl1").val("");
            $("#messagesActionUrl3").val("");
			$("#messagesActionUrl2 option:first").prop("selected", 'selected');
            ...
            if($("#id").val()!="") {  //增加新增和修改逻辑判断
                ...
                $("#actionPanel3").hide();
                $("#messagesActionUrl2 option:first").prop("selected", 'selected');
                Page.validate.unignore("#messagesActionUrl1");
                Page.validate.ignore("#messagesActionUrl3");
                Page.validate.ignore("#messagesActionUrl2");
            }else {
                $("#actionPanel0").hide();
                $("#actionPanel1").show();
                $("#actionPanel2").hide();
            ...
            if($("#id").val()!="") {  //增加新增和修改逻辑判断
                ...
                $("#actionPanel3").show();
                $("#messagesActionUrl2 option:first").prop("selected", 'selected');
                Page.validate.ignore("#messagesActionUrl1");
                Page.validate.unignore("#messagesActionUrl3");
                Page.validate.ignore("#messagesActionUrl2");
            }else{
                $("#actionPanel0").hide();
                $("#actionPanel1").show();
