...
<shiro:hasPermission name="productIntoRecord:VIEW">
	<tiles:insertTemplate template="/jsp/layout/listLayout.jsp" flush="true">
						...
						<div class="search-classic">
							<shiro:hasPermission name="productIntoRecord:SEARCH">
								...
								<div class="well">
									...
									<shiro:hasPermission name="productIntoRecord:EXPORT">
							...
							<%-- 分页栏 --%>
							<shiro:hasPermission name="productIntoRecord:VIEW">
								<hyjf:paginator id="equiPaginator" hidden="paginator-page" action="init" paginator="${productIntoRecordForm.paginator}"></hyjf:paginator>
							</shiro:hasPermission>
							<br/><br/>
						</div>
					</div>
		...
		<tiles:putAttribute name="pageJavaScript" type="string">
			<script type='text/javascript' src="${webRoot}/jsp/htl/productinto/productinto.js"></script>
		</tiles:putAttribute>
