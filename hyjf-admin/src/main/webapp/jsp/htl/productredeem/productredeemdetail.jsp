...
<shiro:hasPermission name="productredeem:VIEW">
	<tiles:insertTemplate template="/jsp/layout/listLayout.jsp" flush="true">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="search-classic">
							...
							<%-- 分页栏 --%>
							<shiro:hasPermission name="productredeem:VIEW">
								<hyjf:paginator id="equiPaginator" hidden="paginator-page" action="init" paginator="${productredeemdetailForm.paginator}"></hyjf:paginator>
							</shiro:hasPermission>
							<br/><br/>
						</div>
					</div>
		...
		<tiles:putAttribute name="pageJavaScript" type="string">
			<script type='text/javascript' src="${webRoot}/jsp/htl/productredeem/productredeemdetail.js"></script>
		</tiles:putAttribute>
