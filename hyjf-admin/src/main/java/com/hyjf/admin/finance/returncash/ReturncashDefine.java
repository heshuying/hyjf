...
public class ReturncashDefine extends BaseDefine {

	/** 权限 CONTROLLOR @RequestMapping值 */
	public static final String REQUEST_MAPPING = "/finance/returncash";

	/** 待返现列表画面 路径 */
	public static final String RETURNCASH_LIST_PATH = "finance/returncash/returncash";

	/** 已返现列表画面 路径 */
	public static final String RETURNEDCASH_LIST_PATH = "finance/returncash/returnedcash";
