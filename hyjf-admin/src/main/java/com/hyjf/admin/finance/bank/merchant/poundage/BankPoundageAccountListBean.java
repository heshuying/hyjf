...
public class BankPoundageAccountListBean implements Serializable {
	...
	private List<BankMerchantAccountListCustomize> recordList;
	...
	public List<BankMerchantAccountListCustomize> getRecordList() {
		return recordList;
	}

	public void setRecordList(List<BankMerchantAccountListCustomize> recordList) {
