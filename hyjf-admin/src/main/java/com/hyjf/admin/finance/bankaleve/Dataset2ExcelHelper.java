...
public class Dataset2ExcelHelper<T> {
     ...
     * @param dataset:查询结果
     */
    public void export(HSSFWorkbook workbook, String sheetName, Map<String, String> beanPropertyColumnMap, Map<String, IValueFormater> mapValueAdapter, Collection<T> dataset) {
