...
public class BankMerchantAccountListBean implements Serializable {
	...
	private List<BankMerchantAccount> recordList;
	...
	public List<BankMerchantAccount> getRecordList() {
		return recordList;
	}

	public void setRecordList(List<BankMerchantAccount> recordList) {
