...
public class WebBean extends WebCustomize implements Serializable {
	...
	private List<WebCustomize> recordList;
	...
	public List<WebCustomize> getRecordList() {
		return recordList;
	}

	public void setRecordList(List<WebCustomize> recordList) {
