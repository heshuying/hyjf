...
public class TransferListBean extends UserTransfer implements Serializable {
	...
	private List<UserTransfer> recordList;
	...
	public List<UserTransfer> getRecordList() {
		return recordList;
	}

	public void setRecordList(List<UserTransfer> recordList) {
