...
public class VIPManageCustomizeBean extends VIPManageListCustomize implements Serializable {
	...
	private List<VIPManageListCustomize> recordList;
	private String ids;
	//注册时间 开始
	...
	public List<VIPManageListCustomize> getRecordList() {
		return recordList;
	}

	public void setRecordList(List<VIPManageListCustomize> recordList) {
