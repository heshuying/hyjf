...
public class UsedRecommendDefine extends BaseDefine {

	/** 权限 CONTROLLOR @RequestMapping值 */
	public static final String REQUEST_MAPPING = "/invite/usedRecommend";
	...
	public static final String LIST_PATH = "invite/usedrecommends/usedRecommendList";
	
	/** FROM */
	public static final String INVITE_USER_FORM = "usedRecommendForm";
	/** 权限 */
    ...
    public static final String THIS_CLASS = "GetRecommendController";
