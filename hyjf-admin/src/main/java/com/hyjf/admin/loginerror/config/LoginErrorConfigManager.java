 ...
 */
package com.hyjf.admin.loginerror.config;
...
public class LoginErrorConfigManager {
     ...
     * @param config
     */
    public void setWebConfig(LoginErrorConfig.Config config) {
        ...
        loginErrorConfig.setWebConfig(config);

        RedisUtils.set(RedisConstants.LOGIN_LOCK_CONFIG, JSON.toJSONString(loginErrorConfig));
     ...
     * @param config
     */
    public void setAdminConfig(LoginErrorConfig.Config config) {
        ...
        loginErrorConfig.setAdminConfig(config);
    ...
    public LoginErrorConfig.Config getAdminConfig() {
        String configString = RedisUtils.get(RedisConstants.LOGIN_LOCK_CONFIG);
        ...
        return loginErrorConfig.getAdminConfig();
    }
