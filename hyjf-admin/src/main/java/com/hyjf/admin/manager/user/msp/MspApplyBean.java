 ...
 *
 */
public class MspApplyBean extends MspApply implements Serializable {
    ...
    private List<MspApply> recordList;
	...
	public List<MspApply> getRecordList() {
		return recordList;
	}

	public void setRecordList(List<MspApply> recordList) {
