 ...
 *
 */
public class ContentLinksBean extends Links implements Serializable {
    ...
    public List<Links> getRecordList() {
        return recordList;
    }

    public void setRecordList(List<Links> recordList) {
