...
public class BorrowRepaymentDefine extends BaseDefine {

	/** 权限 CONTROLLOR @RequestMapping值 */
	public static final String REQUEST_MAPPING = "/manager/borrow/borrowrepayment";

	/** 列表画面 路径 */
	public static final String LIST_PATH = "manager/borrow/borrowrepayment/borrowrepayment";

	/** 列表画面 路径 */
	public static final String REPAY_PATH = "manager/borrow/borrowrepayment/repay/borrowrepay";

	/** 列表画面 路径 */
	public static final String DELAY_REPAY_PATH = "manager/borrow/borrowrepayment/delayrepay/delayrepay";
	...
	public static final String EXPORT_REPAY_ACTION = "exportRepayClkAct";
	...
	/** FROM */
	public static final String REPAYMENT_FORM = "borrowRepaymentForm";
