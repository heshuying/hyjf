 ...
 * @author Michael
 */
public class BillionSecondBean extends ActivityBillionSecond implements Serializable {
	...
	private List<ActivityBillionSecond> recordList;
	...
	public List<ActivityBillionSecond> getRecordList() {
		return recordList;
	}

	public void setRecordList(List<ActivityBillionSecond> recordList) {
	...
	public String getPrizeSrch() {
		return prizeSrch;
	}

	public void setPrizeSrch(String prizeSrch) {
		this.prizeSrch = prizeSrch;
	}
