...
public class UserRePayAuthListBean extends AdminUserRePayAuthCustomize implements Serializable {
	...
	private List<AdminUserRePayAuthCustomize> recordList;
	...
	public List<AdminUserRePayAuthCustomize> getRecordList() {
		return recordList;
	}
	...
	public void setRecordList(List<AdminUserRePayAuthCustomize> recordList) {
