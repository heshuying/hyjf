 ...
 */
public class BorrowRepaymentPlanDefine {

	/** 权限 CONTROLLOR @RequestMapping值 */
	public static final String REQUEST_MAPPING = "/manager/borrow/borrowrepayment/plan";

	/** 列表画面 路径 */
	public static final String LIST_PATH = "manager/borrow/borrowrepayment/plan/repayplan";
	...
	/** FROM */
	public static final String REPAYMENTPLAN_FORM = "borrowRepaymentPlanForm";
