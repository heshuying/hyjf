...
public class PlanListBean implements Serializable {
	 ...
	 * serialVersionUID
	 */
	private static final long serialVersionUID = 4285199920531419072L;
	/**
	 * 排序
	 */
	private String sort;
	 ...
	 * 启用/隐藏 开关
	 */
	private int enableOrDisplayFlag;
	...
	public int getEnableOrDisplayFlag() {
		return enableOrDisplayFlag;
	}

	public void setEnableOrDisplayFlag(int enableOrDisplayFlag) {
		this.enableOrDisplayFlag = enableOrDisplayFlag;
	}
