 ...
 *
 */
public class BankConfigBean extends BankConfig implements Serializable {
    ...
    private List<BankConfig> recordList;
    ...
    public List<BankConfig> getRecordList() {
        return recordList;
    }

    public void setRecordList(List<BankConfig> recordList) {
