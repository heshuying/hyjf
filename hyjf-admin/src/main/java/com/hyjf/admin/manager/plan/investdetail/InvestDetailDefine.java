...
public class InvestDetailDefine extends BaseDefine {

	/** 权限 CONTROLLOR @RequestMapping值 */
	public static final String REQUEST_MAPPING = "/htj/investdetail";

	/** 列表画面 路径 */
	public static final String LIST_PATH = "htj/investdetail/investDetailList";
	...
	/** FROM */
	public static final String CREDIT_FORM = "investForm";
