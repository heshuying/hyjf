 ...
 *
 */
public class ContentJobsBean extends Jobs implements Serializable {
	...
	public List<Jobs> getRecordList() {
		return recordList;
	}

	public void setRecordList(List<Jobs> recordList) {
