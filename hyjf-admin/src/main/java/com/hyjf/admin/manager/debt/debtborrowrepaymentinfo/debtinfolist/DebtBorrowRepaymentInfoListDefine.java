 ...
 */
public class DebtBorrowRepaymentInfoListDefine {

	/** 权限 CONTROLLOR @RequestMapping值 */
	public static final String REQUEST_MAPPING = "/manager/debt/debtborrowrepaymentinfo/debtinfolist";

	/** 列表画面 路径 */
	public static final String LIST_PATH = "manager/debt/debtborrowrepaymentinfo/debtinfolist/debtborrowrepaymentinfolist";
