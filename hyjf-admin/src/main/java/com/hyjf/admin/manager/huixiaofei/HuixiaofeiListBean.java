...
public class HuixiaofeiListBean extends ConsumeList implements Serializable {
	...
	private List<Consume> recordList;
	...
	public List<Consume> getRecordList() {
		return recordList;
	}

	public void setRecordList(List<Consume> recordList) {
