 ...
 *
 */
public class ContentTeamBean extends Team implements Serializable {
	...
	public List<Team> getRecordList() {
		return recordList;
	}

	public void setRecordList(List<Team> recordList) {
