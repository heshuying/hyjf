 ...
 *
 */
public class ActSigninBean extends ActSignin implements Serializable {
    ...
    private List<ActSignin> recordList;
    ...
    public List<ActSignin> getRecordList() {
        return recordList;
    }

    public void setRecordList(List<ActSignin> recordList) {
