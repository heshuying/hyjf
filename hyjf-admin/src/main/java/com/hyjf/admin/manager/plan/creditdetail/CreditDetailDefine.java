...
public class CreditDetailDefine extends BaseDefine {

	/** 权限 CONTROLLOR @RequestMapping值 */
	public static final String REQUEST_MAPPING = "/htj/creditdetail";

	/** 列表画面 路径 */
	public static final String LIST_PATH = "htj/creditdetail/creditDetailList";
	...
	/** 查看权限 */
	public static final String PERMISSIONS = "creditdetail";
