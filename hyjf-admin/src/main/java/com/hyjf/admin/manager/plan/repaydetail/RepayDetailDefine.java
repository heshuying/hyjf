...
public class RepayDetailDefine extends BaseDefine {

	/** 权限 CONTROLLOR @RequestMapping值 */
	public static final String REQUEST_MAPPING = "/htj/repaydetail";

	/** 列表画面 路径 */
	public static final String LIST_PATH = "htj/repaydetail/repayDetailList";
	...
	/** FROM */
	public static final String CREDIT_FORM = "repayForm";
