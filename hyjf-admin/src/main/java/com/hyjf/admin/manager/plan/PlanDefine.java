...
public class PlanDefine extends BaseDefine {
	...
	public static final String REQUEST_MAPPING = "/manager/borrow/plan";

	/** 列表画面 路径 */
	public static final String LIST_PATH = "manager/borrow/plan/planList";

	/** 详细画面的路径 */
	public static final String INFO_PATH = "manager/borrow/plan/borrowInfo";
	
	/** 预览画面路径 */
	public static final String PREVIEW_PATH = "manager/borrow/plan/preview";
	
	/** 删除后 路径 */
	public static final String DELETE_AFTER_PATH = "manager/borrow/plan/borrow";
