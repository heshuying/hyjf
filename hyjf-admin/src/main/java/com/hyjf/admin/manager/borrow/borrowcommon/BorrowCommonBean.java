...
public class BorrowCommonBean implements Serializable {
	...
	private List<BorrowCommonNameAccount> borrowCommonNameAccountList = new ArrayList<BorrowCommonNameAccount>();
	/**
	 * 公司还是个人
	 */
	 ...
	 * 车辆信息 列表
	 */
	private List<BorrowCommonCar> borrowCarinfoList = new ArrayList<BorrowCommonCar>();
	 ...
	 * 房产信息 列表
	 */
	private List<BorrowHouses> borrowHousesList = new ArrayList<BorrowHouses>();
	// ----------------------房产信息------------------------
	// ----------------------认证信息------------------------
	/**
	 * 认证信息 列表
	 */
	private List<BorrowCompanyAuthen> borrowCompanyAuthenList = new ArrayList<BorrowCompanyAuthen>();
	private List<BorrowCommonCompanyAuthen> borrowCommonCompanyAuthenList = new ArrayList<BorrowCommonCompanyAuthen>();
	// ----------------------认证信息------------------------
	 ...
	 * 项目资料
	 */
	private List<BorrowCommonImage> borrowCommonImageList = new ArrayList<BorrowCommonImage>();
	// ----------------------项目资料------------------------
	...
	public List<BorrowCommonImage> getBorrowCommonImageList() {
	...
	public void setBorrowCommonImageList(List<BorrowCommonImage> borrowCommonImageList) {
	...
	public List<BorrowCommonCompanyAuthen> getBorrowCommonCompanyAuthenList() {
	...
	public void setBorrowCommonCompanyAuthenList(List<BorrowCommonCompanyAuthen> borrowCommonCompanyAuthenList) {
	...
	public List<BorrowHouses> getBorrowHousesList() {
	...
	public void setBorrowHousesList(List<BorrowHouses> borrowHousesList) {
	...
	public List<BorrowCompanyAuthen> getBorrowCompanyAuthenList() {
	...
	public void setBorrowCompanyAuthenList(List<BorrowCompanyAuthen> borrowCompanyAuthenList) {
	...
	public List<BorrowCommonCar> getBorrowCarinfoList() {
	...
	public void setBorrowCarinfoList(List<BorrowCommonCar> borrowCarinfoList) {
	...
	public List<BorrowCommonNameAccount> getBorrowCommonNameAccountList() {
	...
	public void setBorrowCommonNameAccountList(List<BorrowCommonNameAccount> borrowCommonNameAccountList) {
