 ...
 *
 */
public class GradeConfigBean extends VipInfo implements Serializable {
    ...
    private List<VipInfo> recordList;
    ...
    public List<VipInfo> getRecordList() {
        return recordList;
    }

    public void setRecordList(List<VipInfo> recordList) {
