 ...
 *
 */
public class ContentEventsBean extends Events implements Serializable {
    ...
    private List<Events> recordList;
    ...
    public List<Events> getRecordList() {
        return recordList;
    }

    public void setRecordList(List<Events> recordList) {
