...
public class UserauthDefine extends BaseDefine {
	...
	/** 用户授权明细 */
	public static final String USER_AUTH_LIST_PATH = "manager/users/userauthlist/userauthList";
	...
	/** 类名*/
	public static final String THIS_CLASS = UserauthController.class.getName();
