 ...
 * @version V1.0  
 */
public class BatchBorrowRepayBean implements Serializable {
	...
	public String getDeatilBatchNo() {
		return deatilBatchNo;
	}

	public void setDeatilBatchNo(String deatilBatchNo) {
		this.deatilBatchNo = deatilBatchNo;
	}
