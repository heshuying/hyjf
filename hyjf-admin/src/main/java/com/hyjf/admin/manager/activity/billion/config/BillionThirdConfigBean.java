 ...
 * @author Michael
 */
public class BillionThirdConfigBean extends ActivityBillionThirdConfig implements Serializable {
	...
	private List<ActivityBillionThirdConfig> recordList;
	...
	public List<ActivityBillionThirdConfig> getRecordList() {
		return recordList;
	}

	public void setRecordList(List<ActivityBillionThirdConfig> recordList) {
