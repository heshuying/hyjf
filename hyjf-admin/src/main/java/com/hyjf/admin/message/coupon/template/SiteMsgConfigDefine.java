...
public class SiteMsgConfigDefine extends BaseDefine {
	
	/** 模板列表入口 CONTROLLOR @RequestMapping值 */
	public static final String TEMPLATE="message/coupon/template";
	...
	public static final String LIST_VIEW="message/coupon/template/templatelist";
	
	/** 重定向列表页面 CONTROLLOR @RequestMapping值 */
	public static final String RE_LIST_VIEW="redirect:/message/coupon/template/templatelist";
	
	/** 迁移 路径 */
	public static final String INFO_PATH = "message/coupon/template/templateInfo";
	...
	/** 权限关键字 */
	public static final String PERMISSIONS = "coupontemplate";
