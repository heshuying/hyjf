 ...
 * @version V1.0  
 */
public class SmsMailTemplateBean extends SmsMailTemplate implements Serializable {
	...
	private List<SmsMailTemplate> recordList;
	 ...
	 */
	public List<SmsMailTemplate> getRecordList() {
		return recordList;
	}
	 ...
	 */
	public void setRecordList(List<SmsMailTemplate> recordList) {
