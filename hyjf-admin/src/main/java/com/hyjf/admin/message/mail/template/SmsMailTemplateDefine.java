...
public class SmsMailTemplateDefine extends BaseDefine {
	
	/** 模板列表入口 CONTROLLOR @RequestMapping值 */
	public static final String TEMPLATE="message/mailtemplate";
	...
	public static final String LIST_VIEW="message/mailTemplate/mailTemplatelist";
	
	/** 重定向列表页面 CONTROLLOR @RequestMapping值 */
	public static final String RE_LIST_VIEW="redirect:/message/mailTemplate/mailTemplatelist";
	
	/** 迁移 路径 */
	public static final String INFO_PATH = "message/mailTemplate/mailTemplateInfo";
