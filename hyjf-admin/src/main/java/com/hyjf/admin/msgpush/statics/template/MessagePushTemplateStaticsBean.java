 ...
 *
 */
public class MessagePushTemplateStaticsBean extends MessagePushTemplateStatics implements Serializable {
	 ...
	 * 统计列表
	 */
	private List<MessagePushTemplateStatics> recordList;
	...
	public List<MessagePushTemplateStatics> getRecordList() {
		return recordList;
	}

	public void setRecordList(List<MessagePushTemplateStatics> recordList) {
